...
namespace Psz.Api.Areas.Purchase.Models.CustomerService
{
	public class CreateReportModel
	{
		...
		public Psz.Core.Apps.Purchase.Models.CustomerService.OrderReport.CreateModel ToBusinessModel()
		{
			return new Core.Apps.Purchase.Models.CustomerService.OrderReport.CreateModel
			{
	...
	public class LogoImageModel
	{
		...
		public Psz.Core.Apps.Purchase.Models.CustomerService.OrderReport.LogoImageModel ToBusinessModel()
		{
			return new Core.Apps.Purchase.Models.CustomerService.OrderReport.LogoImageModel
			{
