...
namespace Psz.Api.Areas.CRP.Controllers
{
	...
	public class FAController: ControllerBase
	{
		...
		public FAController(IInsideSalesWerksterminUpdates insideSalesWerksterminUpdate, ICrpFaChangesHistoryService crpFaChangesHistoryService, IFAService fAService)
		{
		...
		public IActionResult GetLagersPlannung(DateTime Datum_bis, string Produktionsort)
		{
			try
			{
				...
				if(data.Body != null)
				{
					return File(data.Body, "application/xlsx", $"Plannung TN-WS-CZ-AL-{DateTime.Now.ToString("yyyyMMddTHHmmss")}-{Guid.NewGuid().ToString()}.xlsx");
				}
				else
				{
					return Ok("Empty file sent.");
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Core.Common.Models.ResponseModel<string>), 200)]
		public async Task<IActionResult> GetAuswertungEndkontrolle()
		{
			try
			{
				var response = await new Core.CRP.Handlers.FA.Purchase.GetAuswertungEndkontrolleHandler(this.GetCurrentUser())
				   .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetFAAnalyseFehlmaterial(int fa, DateTime date, int id)
		{
			try
			{
				var response = await new Core.CRP.Handlers.FA.Purchase.GetFAAnalyseFehlmaterialHandler(this.GetCurrentUser(), fa, date, id)
				   .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Core.Common.Models.ResponseModel<string>), 200)]
		public async Task<IActionResult> GetFAReport(int fa)
		{
			try
			{
				var x = this.GetCurrentUser();
				var response = await new Core.CRP.Handlers.FA.Purchase.GetFADruckHandler(this.GetCurrentUser(), fa)
				   .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Core.Common.Models.ResponseModel<string>), 200)]
		public async Task<IActionResult> GetFAFehlematerial(int fa)
		{
			try
			{
				var response = await new Core.CRP.Handlers.FA.Purchase.GetFAFehlematerialHandler(this.GetCurrentUser(), fa)
				   .HandleAsync();
		...
		public async Task<IActionResult> GetFAStappleFinalReport(Psz.Core.CRP.Reporting.Models.FAUpdateByArticleFinalModel model)
		{
			var response = await new Core.CRP.Handlers.FA.Purchase.GetFAStappleDruckFinalReportHandler(model, this.GetCurrentUser())
				   .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetUpdatedPDF(Psz.Core.CRP.Reporting.Models.FAUpdateByArticleFinalModel model)
		{
			try
			{
				var response = await new Core.CRP.Handlers.FA.Purchase.GetUpdatedFaPDFHandler(model, this.GetCurrentUser())
				   .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetWerkUpdateReport(int Idupadate)
		{
			try
			{
				var response = await new Core.CRP.Handlers.FA.Purchase.GetWerkUpdateReportHandler(this.GetCurrentUser(), Idupadate)
				   .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetWunshUpdateReport(int Idupadate)
		{
			try
			{
				var response = await new Core.CRP.Handlers.FA.Purchase.GetWunshUpdateReportHandler(this.GetCurrentUser(), Idupadate).HandleAsync();
		...
		public IActionResult ImportWunshFromXLS([FromForm] FAImportExcelModel data)
		{
			try
			{
				...
				if(file.Length > 0)
				{
					// Save file to temp dir
					var tempFilePath = System.IO.Path.GetTempPath();
					var filePath = System.IO.Path.Combine(tempFilePath, DateTime.Now.ToString("yyyyMMddTHHmmss_") + Guid.NewGuid().ToString() + "_" + file.FileName);
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetLaufkarteSchneiderei(int fa)
		{
			try
			{
				var response = await new Core.CRP.Handlers.FA.Purchase.LaufkarteSchneidereiHandler(this.GetCurrentUser(), fa)
				   .HandleAsync();
		...
		[HttpGet]
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(ResponseModel<List<Core.CRP.Models.FA.FACRPUpdateListModel>>), 200)]
		public IActionResult GetFACRPUpdateList(string artikelnummer)
		{
			try
			{
				var response = _fAService.GetCRPUpdateFaList(this.GetCurrentUser(), artikelnummer);
				return Ok(response);
			} catch(Exception e)
			{
				return this.HandleException(e);
		...
		[HttpPost]
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(ResponseModel<List<Core.CRP.Models.FA.FACRPNotRequiredROHResponseModel>>), 200)]
		public IActionResult GetNoTNeededROHForCRPFAUpdate(Psz.Core.CRP.Models.FA.FACRPNotRequiredROHRequestModel data)
		{
			try
			{
				var response = _fAService.GetNotRequiredROH(this.GetCurrentUser(), data);
				return Ok(response);
			} catch(Exception e)
			{
				return this.HandleException(e);
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(ResponseModel<List<Core.CRP.Models.FA.FACRPUpdateListModel>>), 200)]
		public IActionResult GetArticlesForCRPFAUpdate(string artikelnummer)
		{
			try
			{
				var response = _fAService.GetArticlesForCRPFAUpdate(this.GetCurrentUser(), artikelnummer);
				return Ok(response);
			} catch(Exception e)
			{
				return this.HandleException(e);
		...
		[HttpPost]
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(ResponseModel<List<Core.CRP.Models.FA.FACRPUpdateResponseModel>>), 200)]
		public IActionResult UpdateFACRP(Core.CRP.Models.FA.FACRPUpdateRequestModel data)
		{
			try
			{
				var response = _fAService.UpdateCRPFA(this.GetCurrentUser(), data);
				return Ok(response);
			} catch(Exception e)
			{
				return this.HandleException(e, data);
