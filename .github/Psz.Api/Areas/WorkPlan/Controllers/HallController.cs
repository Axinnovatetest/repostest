	...
	public class HallController: ControllerBase
	{
		...
		public IActionResult Get()
		{
			...
			try
			{
				...
				{
					var hallViewModel = new List<Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel>();
					hallDb.ForEach(h => hallViewModel.Add(new Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel(h)));

					return Ok(new { response = new Api.Models.Response<List<Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel>>() { Success = true, ResponseBody = hallViewModel, Errors = errors } });
				}
		...
		public IActionResult GetMyHalls()
		{
			...
			try
			{
				...
				else
				{
					...
					var hallViewModel = new List<Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel>();
					hallsDb.ForEach(h => hallViewModel.Add(new Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel(h)));
		...
		public IActionResult Get(int Id)
		{
			...
			try
			{
				var hallViewModel = new Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel();
				var user = this.GetCurrentUser();
				if(user == null)
				...
				else
				{
					...
					{
						hallViewModel = new Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel(hallDb);
					}
				}

				if(errors.Count == 0)
					return Ok(new { response = new Api.Models.Response<Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel>() { Success = true, ResponseBody = hallViewModel, Errors = errors } });
				else
					return Ok(new { response = new Api.Models.Response<string>() { Success = false, ResponseBody = "", Errors = errors } });
			} catch(Exception e)
			{
		...
		[HttpPost]
		[SwaggerOperation(Tags = new[] { "WorkPlan" })]
		public IActionResult Add(Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel model)
		{
			var errors = new List<string>();
			try
			{
				...
				if(errors.Count == 0)
				{
					...
					return Ok(new { response = new Api.Models.Response<string>(true, $"Add Success <{addedId}>.Log Add success") });
				}
				else
				{
					return Ok(new { response = new Api.Models.Response<string> { Success = false, ResponseBody = "", Errors = errors } });
		...
		[HttpPost]
		[SwaggerOperation(Tags = new[] { "WorkPlan" })]
		public IActionResult Edit(Psz.Core.Apps.WorkPlan.Models.Hall.HallViewModel model)
		{
			var errors = new List<string>();
			try
			{
		...
		public IActionResult Delete(int Id)
		{
			...
			try
			{
				...
				{
					return Ok(new { response = new Api.Models.Response<string> { Success = false, ResponseBody = "Delete Failed", Errors = errors } });
				}
			} catch(Exception e)
			{
				return this.HandleException(e);
		...
		public ActionResult ExportHallToExcel()
		{
			try
			{
				var data = Psz.Core.Apps.WorkPlan.Handlers.Hall.ExportToExcel();
				if(data.Body != null)
				{
