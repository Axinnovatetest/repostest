...
namespace Psz.Api.Areas.WorkPlan.Controllers
{
	...
	public class WorkScheduleDetailsController: ControllerBase
	{
		...
		public IActionResult Get(int WorkScheduleId)
		{
			...
			try
			{
				var workScheduleVM = new List<Psz.Core.Apps.WorkPlan.Models.WorkScheduleDetails.WorkScheduleDetailsViewModel>();
				...
				{
					workScheduleDetailsDb.ForEach(wsdb => workScheduleVM.Add(new Psz.Core.Apps.WorkPlan.Models.WorkScheduleDetails.WorkScheduleDetailsViewModel(wsdb)));
				}

				if(errors.Count == 0)
				{
					return Ok(new { response = new Api.Models.Response<List<Psz.Core.Apps.WorkPlan.Models.WorkScheduleDetails.WorkScheduleDetailsViewModel>>() { Success = true, ResponseBody = workScheduleVM, Errors = errors } });
				}
				else
				{
					return Ok(new { response = new Api.Models.Response<string>() { Success = false, ResponseBody = "", Errors = errors } });
		...
		[HttpPost]
		[SwaggerOperation(Tags = new[] { "WorkPlan" })]
		public IActionResult Add(Psz.Core.Apps.WorkPlan.Models.WorkScheduleDetails.WorkScheduleDetailsViewModel data)
		{
			var errors = new List<string>();
			...
			try
			{
				...
				var standardOperations = data.StandardOperationId == null ? null : Infrastructure.Data.Access.Tables.WPL.StandardOperationAccess.Get((int)data.StandardOperationId);
				...
				return Ok(new
				{
					response = new Api.Models.Response<string>(true,
		...
		[HttpPost]
		[SwaggerOperation(Tags = new[] { "WorkPlan" })]
		public IActionResult Edit(Psz.Core.Apps.WorkPlan.Models.WorkScheduleDetails.WorkScheduleDetailsViewModel data)
		{
			try
			{
				var user = this.GetCurrentUser();
		...
		public IActionResult Delete(int id)
		{
			try
			{
				...
				if(user == null)
				{
					return Ok(new { response = new Api.Models.Response<string>() { Success = false, ResponseBody = "", Errors = new List<string>() { "Can not find User.Authentification error" } } });
				}

				if(workScheduleDetailsDb == null || workScheduleDb == null)
				{
					return Ok(new { response = new Api.Models.Response<string>() { Success = false, ResponseBody = "", Errors = new List<string>() { "Can't find Work Schedule Details.DB error" } } });
				}
				...
				return Ok(new { response = new Api.Models.Response<string>(true, $"Delete Success.Log Add success", new List<string>()) });
			} catch(Exception e)
			{
				return this.HandleException(e);
			}
		...
		[HttpPost]
		[SwaggerOperation(Tags = new[] { "WorkPlan" })]
		public IActionResult UpdateDisplayOrder(Psz.Core.Apps.WorkPlan.Models.WorkScheduleDetails.WorkScheduleDetailOrder data)
		{
			try
			{
				var user = this.GetCurrentUser();
				...
				{
					return Ok(new { response = new Api.Models.Response<string>(true, "", new List<string>()) });
				}
				...
				return Ok(new { response = new Api.Models.Response<string>(true, $"Update Display Order Success. Log Add success", new List<string>()) });
			} catch(Exception e)
			{
				return this.HandleException(e);
			}
		...
		[HttpPost]
		[SwaggerOperation(Tags = new[] { "WorkPlan" })]
		public IActionResult UpdateOperationNumber(Psz.Core.Apps.WorkPlan.Models.WorkScheduleDetails.WorkScheduleDetailsOpNumbers data)
		{
			try
			{
				var user = this.GetCurrentUser();
				...
				return Ok(new { response = new Api.Models.Response<string>(true, $"Update OpNumbers Success.Log Add success", new List<string>()) });
			} catch(Exception e)
			{
				return this.HandleException(e);
			}
