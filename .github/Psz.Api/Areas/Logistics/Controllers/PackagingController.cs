...
namespace Psz.Api.Areas.Logistics.Controllers
{
	...
	public class PackagingController: Controller
	{
		...
		public IActionResult GetLSDrucken(int LS, int languageId, int orderTypeId)
		{
			//try
			//{
			//	var response = new Psz.Core.Logistics.Handlers.Verpackung.GetLSDruckHandler(this.GetCurrentUser(), LS, languageId, orderTypeId)
			//	  .Handle();
		...
		public IActionResult GetLSEtikettenDrucken(int LS)
		{
			...
			//try
			//{
			//	return Ok(new Core.Logistics.Handlers.Verpackung.GetListEtikettenVDAByLSDruckerHandler( LS, this.GetCurrentUser())
			//	   .Handle());
			//} catch(Exception e)
			//{
			//	Infrastructure.Services.Logging.Logger.Log(e);
		...
		public IActionResult GetLigneLSEtikettenDrucken(int nr)
		{
			//try
			//{
			//	var response = new Core.Logistics.Handlers.Verpackung.GetListEtikettenVDAByNrAngArtDruckerHandler(nr, this.GetCurrentUser())
			//	  .Handle();
