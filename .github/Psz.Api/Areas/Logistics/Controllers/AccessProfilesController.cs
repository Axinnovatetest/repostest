...
namespace Psz.Api.Areas.Logistics.Controllers
{
	...
	public class AccessProfilesController: Controller
	{
		...
		[SwaggerOperation(Tags = new[] { MODULE + " | " + ACCESS_PROFILE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<List<KeyValuePair<int, string>>>), 200)]
		public IActionResult GetAllInventoryWarehouse()
		{
			try
			{
				return Ok(new Core.Logistics.Handlers.Administration.AccessProfiles.GetAllInventoryWarehouseHandler(this.GetCurrentUser())
					.Handle());
			} catch(Exception e)
			{
				return this.HandleException(e);
		...
		[SwaggerOperation(Tags = new[] { MODULE + " | " + ACCESS_PROFILE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<List<KeyValuePair<int, string>>>), 200)]
		public IActionResult GetInventoryWarehouses(int accessProfileId)
		{
			try
			{
				return Ok(new Core.Logistics.Handlers.Administration.AccessProfiles.GetInventoryWarehousesHandler(this.GetCurrentUser(), accessProfileId)
					.Handle());
			} catch(Exception e)
			{
				return this.HandleException(e, accessProfileId);
			}
		}
		[HttpPost]
		[SwaggerOperation(Tags = new[] { MODULE + " | " + ACCESS_PROFILE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<int>), 200)]
		public IActionResult AddInventoryWarehouse(Core.Logistics.Models.Administration.AccessProfiles.AddInventoryWarehouseRequestModel data)
		{
			try
			{
				return Ok(new Core.Logistics.Handlers.Administration.AccessProfiles.AddInventoryWarehouseHandler(this.GetCurrentUser(), data)
				   .Handle());
			} catch(Exception e)
			{
				return this.HandleException(e, data);
		...
		[SwaggerOperation(Tags = new[] { MODULE + " | " + ACCESS_PROFILE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<int>), 200)]
		public IActionResult RemoveInventoryWarehouse(Core.Logistics.Models.Administration.AccessProfiles.AddInventoryWarehouseRequestModel data)
		{
			try
			{
				return Ok(new Core.Logistics.Handlers.Administration.AccessProfiles.RemoveInventoryWarehouseHandler(this.GetCurrentUser(), data)
				   .Handle());
			} catch(Exception e)
			{
				return this.HandleException(e, data);
