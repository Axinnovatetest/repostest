...
namespace Psz.Api.Areas.Logistics.Controllers
{
	...
	public class StatisticsController: Controller
	{
		...
		public IActionResult GetLagerOrt(bool includeInventory)
		{
			try
			{
				var response = new Core.Logistics.Handlers.Statistics.lagerorteHandler(this.GetCurrentUser(), includeInventory).Handle();
				return Ok(response);


			} catch(Exception e)
			{
				this.HandleException(e, includeInventory);
				return Ok(e.Message);
			}
		}
		[HttpGet]
