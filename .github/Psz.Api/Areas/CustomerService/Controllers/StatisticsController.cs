...
namespace Psz.Api.Areas.CustomerService.Controllers
{
	...
	public class StatisticsController: ControllerBase
	{
		...
		public async Task<IActionResult> GetKapazitatLangReport(Psz.Core.CustomerService.Reporting.Models.KapazitatLangEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetKapazitatLangHandler(model, this.GetCurrentUser())
				   .HandleAsync();
		...
		public async Task<IActionResult> GetExport(Psz.Core.CustomerService.Reporting.Models.ExportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetExportHandler(this.GetCurrentUser(), model)
				   .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetBacklogFGPDF(Psz.Core.CustomerService.CsStatistics.Models.BacklogReportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetBacklogFGPDFHandler(this.GetCurrentUser(), model)
				  .HandleAsync();
		...
		public async Task<IActionResult> GetBacklogFGPDFExtended(Psz.Core.CustomerService.CsStatistics.Models.BacklogReportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetBacklogFGPDFHandler(this.GetCurrentUser(), model)
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetBacklogHWPDF(Psz.Core.CustomerService.CsStatistics.Models.BacklogReportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetBackLogHWPDFHandler(this.GetCurrentUser(), model)
				  .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<string>), 200)]
		public async Task<IActionResult> GetBacklogHWPDFExtended(Psz.Core.CustomerService.CsStatistics.Models.BacklogReportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetBackLogHWPDFHandler(this.GetCurrentUser(), model)
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetBestandReport(Psz.Core.CustomerService.CsStatistics.Models.BestandEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetBestandReportHandler(this.GetCurrentUser(), model)
				  .HandleAsync();
				if(response.Success)
					return Ok(new Psz.Core.Common.Models.ResponseModel<string>
					{
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetFA_NPEXReport(Psz.Core.CustomerService.Reporting.Models.FA_NPEX_ReportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetFA_NPEX_reprotHandler(this.GetCurrentUser(), model)
				  .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<string>), 200)]
		public async Task<IActionResult> GetLieferPlannungReport(string kunde)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetLierferPlannungPDFHandler(this.GetCurrentUser(), kunde)
				  .HandleAsync();
				if(response.Success)
					return Ok(new Psz.Core.Common.Models.ResponseModel<string>
					{
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<string>), 200)]
		public async Task<IActionResult> GetContactsFAReport(Psz.Core.Common.Models.IDateRangeModel model)
		{
			try
			{
				//var response = new Psz.Core.Apps.Purchase.Handlers.CustomerService.CSStats.GetContactFAHandler(this.GetCurrentUser(), model)
				//  .Handle();
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetContactFAHandler(this.GetCurrentUser(), model)
				 .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<string>), 200)]
		public async Task<IActionResult> GetAuswertungSchneidereiReport(int lager)
		{
			try
			{
				...
				//  .Handle();
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.AuswertungSchneidereiHandler(this.GetCurrentUser(), lager)
				  .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetRechnungEndkontrollePDF(Psz.Core.CustomerService.Reporting.Models.RechnungEndkontrolleReportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetRechnungEndkontrollePDFHandler(this.GetCurrentUser(), model)
				  .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetNachBerechnungTNPDF(Psz.Core.CustomerService.Reporting.Models.RechnungEndkontrolleReportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetNachBerechnungTNReportHandler(this.GetCurrentUser(), model)
				  .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetRGSpritzgussPDF(Psz.Core.CustomerService.Reporting.Models.RechnungEndkontrolleReportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetRGSpritzgussReportHandler(this.GetCurrentUser(), model)
				  .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<byte[]>), 200)]
		public async Task<IActionResult> GetRGWerkzeugbauPDF(Psz.Core.CustomerService.Reporting.Models.RechnungEndkontrolleReportEntryModel model)
		{
			try
			{
				var response = await new Psz.Core.CustomerService.CsStatistics.Handlers.PDFReports.GetRGWerkzeugbauReportHandler(this.GetCurrentUser(), model)
				  .HandleAsync();
		...
		public async Task<IActionResult> GetDeliveryNotesCompilation(Core.CustomerService.Models.OrderProcessing.DeliveryNotesCompilationRequestModel data)
		{
			try
			{
				var response = await new Core.CustomerService.Handlers.OrderProcessing.GetDeliveryNotesCompilationHandler(this.GetCurrentUser(), data)
				   .HandleAsync();
		...
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Psz.Core.Common.Models.ResponseModel<string>), 200)]
		public async Task<IActionResult> GetDeliveryNotesCompilationPDF(Core.CustomerService.Models.OrderProcessing.DeliveryNotesCompilationRequestModel data)
		{
			try
			{
				var response = await new Core.CustomerService.Handlers.OrderProcessing.GetDeliveryNotesCompilationHandler(this.GetCurrentUser(), data)
		...
		public async Task<IActionResult> GetDeliveryNotesCompilationXLS(Core.CustomerService.Models.OrderProcessing.DeliveryNotesCompilationRequestModel data)
		{
			try
			{
				var response = await new Core.CustomerService.Handlers.OrderProcessing.GetDeliveryNotesCompilationHandler(this.GetCurrentUser(), data).GetXLS();
		...
		[HttpPost]
		[SwaggerOperation(Tags = new[] { MODULE })]
		[ProducesResponseType(typeof(Core.Models.ResponseModel<List<Core.CustomerService.CsStatistics.Models.CapacityFcResponseModel>>), 200)]
		public IActionResult GetCapacityStatus_FC(Core.CustomerService.CsStatistics.Models.CapacityAbFaRequestModel data)
		{
			try
			{
				return Ok(new Core.CustomerService.CsStatistics.Handlers.GetCapacityStatusFCHandler(this.GetCurrentUser(), data)
				  .Handle());
			} catch(Exception e)
			{
				return this.HandleException(e, data);
