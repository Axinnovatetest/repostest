...
namespace Psz.Api.Areas.MaterialManagement.Controllers.Orders
{
	...
	public class StatisticsController: Controller
	{
		...
		public async Task<IActionResult> PrioEinkaufPDF(PrioEinkaufPDFRequestModel data)
		{
			try
			{
				var response = await new Core.MaterialManagement.Orders.Handlers.Statistics.PrioEinkaufPDFHandler(this.GetCurrentUser(false), data)
					.HandleAsync();
