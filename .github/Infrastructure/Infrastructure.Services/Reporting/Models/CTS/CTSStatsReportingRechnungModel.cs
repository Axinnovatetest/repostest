...
namespace Infrastructure.Services.Reporting.Models.CTS
{
	...
	public class RechnungDetailsModel
	{
		...
		{
			Ausdr3 = Helpers.FormatNumber( entity.Ausdr3 ?? 0);
			...
			Originalanzahl = Helpers.FormatNumber(entity.Originalanzahl ?? 0);
			...
			Material1 = Helpers.FormatNumber(entity.Material1 ?? 0);
			Größe = entity.Größe ?? 0;
			Gesamtgewicht = entity.Gesamtgewicht ?? 0;
			Stundensatz = entity.Stundensatz ?? 0;
			MinutenKosten = Helpers.FormatNumber(entity.MinutenKosten ?? 0);
			Zusatzkosten_FA_Basis_30_Min = Helpers.FormatNumber(entity.Zusatzkosten_FA_Basis_30_Min ?? 0);
			...
			Zusatzkosten_Produktion = Helpers.FormatNumber(entity.Zusatzkosten_Produktion ?? 0);
			Zusatzkosten_Produktion_Decimal = entity.Zusatzkosten_Produktion ?? 0;
			Preis_Total_Mit_Zusatzkosten = Helpers.FormatNumber(entity.Preis_Total_Mit_Zusatzkosten ?? 0);
	...
	public class RechnungGroupedZollaTarifDecmial
	{
		public string Zolltarif_nummer { get; set; }
	...
	public class RechnungEntryModel
	{
