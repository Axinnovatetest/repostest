...
{
	public class View_PSZ_Disposition_Ab_Termin_zu_Spat_sqlEntity
	{
		...
		public View_PSZ_Disposition_Ab_Termin_zu_Spat_sqlEntity() { }

		public View_PSZ_Disposition_Ab_Termin_zu_Spat_sqlEntity(DataRow dataRow)
		{
		...
		public View_PSZ_Disposition_Ab_Termin_zu_Spat_sqlEntity ShallowClone()
		{
			return new View_PSZ_Disposition_Ab_Termin_zu_Spat_sqlEntity
			{
				Anzahl = Anzahl,
