...
namespace Infrastructure.Data.Entities.Tables.PRS
{
	public class KundenEntity
	{
		...
		public string OrderAddress { get; set; } = default;

		// 18-03-2025 ticket #43321
		public string CodeTypeInLS { get; set; }
		public int? CodeTypeInLSId { get; set; }

		// 19-03-2025
		public bool? Edi_Aktiv_Delfor { get; set; }
		public bool? Edi_Aktiv_Desadv { get; set; }
		// 2025-09-10 ticket #43321
		public bool? LsBarCodeDocumentNumber { get; set; }
		public string ZahlungsweiseCode { get; set; }
		public KundenEntity() { }
		public KundenEntity(DataRow dataRow)
		{
			...
			LsBarCodeDocumentNumber = (dataRow["LsBarCodeDocumentNumber"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["LsBarCodeDocumentNumber"]);
			...
			OrderAddress = (dataRow["OrderAddress"] == System.DBNull.Value) ? "" : Convert.ToString(dataRow["OrderAddress"]);
			...
			ZahlungsweiseCode = (dataRow["ZahlungsweiseCode"] == System.DBNull.Value) ? "" : Convert.ToString(dataRow["ZahlungsweiseCode"]);
			...
			try
			{
				DELFixiert = (dataRow["DEL-Fixiert"] == System.DBNull.Value) ? (bool?)false : Convert.ToBoolean(dataRow["DEL-Fixiert"]);
				DEL = (dataRow["DEL"] == System.DBNull.Value) ? (int?)0 : Convert.ToInt32(dataRow["DEL"]);
			} catch
			{
				DELFixiert = false;
				DEL = 0;
			...
			// 18-03-2025 ticket #43321
			CodeTypeInLS = (dataRow["CodeTypeInLS"] == System.DBNull.Value) ? "" : Convert.ToString(dataRow["CodeTypeInLS"]);
			CodeTypeInLSId = (dataRow["CodeTypeInLSId"] == System.DBNull.Value) ? (int?)null : Convert.ToInt32(dataRow["CodeTypeInLSId"]);

			//
			Edi_Aktiv_Delfor = (dataRow["Edi-Aktiv-Delfor"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["Edi-Aktiv-Delfor"]);
			Edi_Aktiv_Desadv = (dataRow["Edi-Aktiv-Desadv"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["Edi-Aktiv-Desadv"]);
			LsBarCodeDocumentNumber = (dataRow["LsBarCodeDocumentNumber"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["LsBarCodeDocumentNumber"]);
		}
	}
}