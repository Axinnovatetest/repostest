...
{
	public class ArtikelMHD_TagEntity
	{
		...
		public ArtikelMHD_TagEntity() { }

		public ArtikelMHD_TagEntity(DataRow dataRow)
		{
			...
			Tag = (dataRow["Tag"] == System.DBNull.Value) ? "" : Convert.ToString(dataRow["Tag"]);
