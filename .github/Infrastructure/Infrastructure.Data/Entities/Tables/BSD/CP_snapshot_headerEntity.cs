...
{
	public class CP_snapshot_headerEntity
	{
		...
		public CP_snapshot_headerEntity() { }

		public CP_snapshot_headerEntity(DataRow dataRow)
		{
			...
			Validee = (dataRow["Validee"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["Validee"]);
