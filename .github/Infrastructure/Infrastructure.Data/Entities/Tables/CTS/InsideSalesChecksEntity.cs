...
{
	public class InsideSalesChecksEntity
	{
		...
		public InsideSalesChecksEntity() { }

		public InsideSalesChecksEntity(DataRow dataRow)
		{
		...
		public InsideSalesChecksEntity ShallowClone()
		{
			return new InsideSalesChecksEntity
			{
				ArticleId = ArticleId,
