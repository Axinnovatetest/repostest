...
{
	public class PSZ_Eingangskontrolle_CZEntity
	{
		...
		public PSZ_Eingangskontrolle_CZEntity() { }

		public PSZ_Eingangskontrolle_CZEntity(DataRow dataRow)
		{
		...
		public PSZ_Eingangskontrolle_CZEntity(Infrastructure.Data.Entities.Tables.Logistics.PlantBookingUpdateEntity entity)
		{
			Aktiv = entity.Aktiv;
		...
		public PSZ_Eingangskontrolle_CZEntity ShallowClone()
		{
			return new PSZ_Eingangskontrolle_CZEntity
			{
				Aktiv = Aktiv,
		...
		public PSZ_Eingangskontrolle_CZEntity(Infrastructure.Data.Entities.Joins.Logistics.PSZ_Eingangskontrolle_TNEntity EntityJoin, LagerAccessEnum? choice)
		{
