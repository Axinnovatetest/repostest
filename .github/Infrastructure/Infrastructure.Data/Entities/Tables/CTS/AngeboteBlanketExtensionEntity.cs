...
{
	public class AngeboteBlanketExtensionEntity
	{
		...
		public AngeboteBlanketExtensionEntity() { }

		public AngeboteBlanketExtensionEntity(DataRow dataRow)
		{
		...
		public AngeboteBlanketExtensionEntity ShallowClone()
		{
			return new AngeboteBlanketExtensionEntity
			{
