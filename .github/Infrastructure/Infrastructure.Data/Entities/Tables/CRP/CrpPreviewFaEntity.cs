...
{
    public class CrpPreviewFaEntity
    {
        ...
        public CrpPreviewFaEntity() { }

        public CrpPreviewFaEntity(DataRow dataRow)
        {
        ...
        public CrpPreviewFaEntity ShallowClone()
        {
            return new CrpPreviewFaEntity
            {
			ArticleId = ArticleId,
			Id = Id,
			Quantity = Quantity,
