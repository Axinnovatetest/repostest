...
namespace Infrastructure.Data.Entities.Tables.MTM
{
	public class CapacityEntity
	{
		...
		public int HolidaysNumber { get; set; }
		...
		public int? WorkStationId { get; set; } /* NEW */
		public string WorkStationName { get; set; } /* NEW */
		public DateTime WeekFirstDay { get; set; } /* NEW */
		public DateTime WeekLastDay { get; set; } /* NEW */
		...
		public CapacityEntity(DataRow dataRow)
		{
			...
			HolidaysNumber = Convert.ToInt32(dataRow["HolidaysNumber"]);
