...
{
	public class KonditionszuordnungstabelleEntity2
	{
		...
		public KonditionszuordnungstabelleEntity2() { }

		public KonditionszuordnungstabelleEntity2(DataRow dataRow)
		{
		...
		public KonditionszuordnungstabelleEntity2 ShallowClone()
		{
			return new KonditionszuordnungstabelleEntity2
			{
				Bemerkung = Bemerkung,
				Nettotage = Nettotage,
				Nr = Nr,
