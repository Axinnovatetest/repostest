...
{
	public class __CTS_AngeboteBlanketExtensionAccess
	{
		#region Default Methods
		public static Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity Get(int id)
		{
			...
			{
				return new Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
			...
			if(dataTable.Rows.Count > 0)
			{
				return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity(x)).ToList();
			}
			else
			{
				return new List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity>();
			}
		}
		public static List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> Get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> results = null;
				...
				else
				{
					...
					results = new List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity>();
		...
		private static List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity item)
		{
		...
		public static int Insert(List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> items)
		{
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static int Update(Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity item)
		{
			int results = -1;
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
		...
		public static int Update(List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 22; // Nb params per query
		...
		private static int update(List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity GetWithTransaction(int id, SqlConnection connection, SqlTransaction transaction)
		{
			var dataTable = new DataTable();
		...
		public static List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> GetWithTransaction(SqlConnection connection, SqlTransaction transaction)
		{
			var dataTable = new DataTable();
		...
		public static List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> GetWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
		...
		private static List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> getWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
		...
		public static int InsertWithTransaction(Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity item, SqlConnection connection, SqlTransaction transaction)
		{
			//int response = int.MinValue;
		...
		public static int InsertWithTransaction(List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 22; // Nb params per query
		...
		private static int insertWithTransaction(List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				string query = "";
		...
		public static int UpdateWithTransaction(Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity item, SqlConnection connection, SqlTransaction transaction)
		{
			int results = -1;
		...
		public static int UpdateWithTransaction(List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 22; // Nb params per query
		...
		private static int updateWithTransaction(List<Infrastructure.Data.Entities.Tables.MTM.__CTS_AngeboteBlanketExtensionEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				//int results = -1;
