...
namespace Infrastructure.Data.Access.Tables.Logistics
	{
		public class PlantBookingArticleControlProcedureAccess
		{
			#region Default Methods
			public static Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity Get(int id)
			{
				var dataTable = new DataTable();
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
				{
					sqlConnection.Open();
					string query = "SELECT * FROM [__LGT_PlantBookingsArticleControlledProcedures] WHERE [Id]=@Id";
				...
				{
					return new Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity(dataTable.Rows[0]);
				}
				else
				{
					return null;
			...
			public static List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> Get()
			{
				var dataTable = new DataTable();
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
				{
					sqlConnection.Open();
					string query = "SELECT * FROM [__LGT_PlantBookingsArticleControlledProcedures]";
					var sqlCommand = new SqlCommand(query, sqlConnection);
				...
				if(dataTable.Rows.Count > 0)
				{
					return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity(x)).ToList();
				}
				else
				{
					return new List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity>();
				}
			}
			public static List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> Get(List<int> ids)
			{
				if(ids != null && ids.Count > 0)
				{
					int maxQueryNumber = Settings.MAX_BATCH_SIZE;
					List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> results = null;
					...
					else
					{
						...
						results = new List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity>();
			...
			private static List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> get(List<int> ids)
			{
				if(ids != null && ids.Count > 0)
				{
					var dataTable = new DataTable();
					using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
					{
						...
						sqlCommand.CommandText = $"SELECT * FROM [__LGT_PlantBookingsArticleControlledProcedures] WHERE [Id] IN ({queryIds})";
						new SqlDataAdapter(sqlCommand).Fill(dataTable);
					}
			...
			public static int Insert(Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity item)
			{
			...
			public static int Insert(List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> items)
			{
			...
			private static int insert(List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> items)
			{
				if(items != null && items.Count > 0)
				{
					int results = -1;
			...
			public static int Update(List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> items)
			{
				if(items != null && items.Count > 0)
				{
					int maxParamsNumber = Settings.MAX_BATCH_SIZE / 18; // Nb params per query
			...
			private static int update(List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> items)
			{
				if(items != null && items.Count > 0)
				{
					int results = -1;
					using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
					{
						...
						{
							i++;
							query += " UPDATE [__LGT_PlantBookingsArticleControlledProcedures] SET "
			...
			public static int Delete(int id)
			{
				...
				{
					sqlConnection.Open();
					string query = "DELETE FROM [__LGT_PlantBookingsArticleControlledProcedures] WHERE [Id]=@Id";
					var sqlCommand = new SqlCommand(query, sqlConnection);
					sqlCommand.Parameters.AddWithValue("Id", id);
			...
			private static int delete(List<int> ids)
			{
				if(ids != null && ids.Count > 0)
				{
					...
					using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
					{
						...
						string query = "DELETE FROM [__LGT_PlantBookingsArticleControlledProcedures] WHERE [Id] IN (" + queryIds + ")";
						sqlCommand.CommandText = query;
			...
			public static Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity GetWithTransaction(int id, SqlConnection connection, SqlTransaction transaction)
			{
				var dataTable = new DataTable();
			...
			public static List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> GetWithTransaction(SqlConnection connection, SqlTransaction transaction)
			{
				var dataTable = new DataTable();
			...
			public static List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> GetWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
			{
				if(ids != null && ids.Count > 0)
				{
					int maxQueryNumber = Settings.MAX_BATCH_SIZE;
			...
			private static List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> getWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
			{
				if(ids != null && ids.Count > 0)
				{
					var dataTable = new DataTable();
			...
			public static int InsertWithTransaction(Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity item, SqlConnection connection, SqlTransaction transaction)
			{
				int response = int.MinValue;
			...
			public static int InsertWithTransaction(List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> items, SqlConnection connection, SqlTransaction transaction)
			{
				if(items != null && items.Count > 0)
				{
					int maxParamsNumber = Settings.MAX_BATCH_SIZE / 18; // Nb params per query
			...
			private static int insertWithTransaction(List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> items, SqlConnection connection, SqlTransaction transaction)
			{
				if(items != null && items.Count > 0)
				{
					string query = "";
			...
			public static int UpdateWithTransaction(Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity item, SqlConnection connection, SqlTransaction transaction)
			{
				int results = -1;
			...
			public static int UpdateWithTransaction(List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> items, SqlConnection connection, SqlTransaction transaction)
			{
				if(items != null && items.Count > 0)
				{
					int maxParamsNumber = Settings.MAX_BATCH_SIZE / 18; // Nb params per query
			...
			private static int updateWithTransaction(List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> items, SqlConnection connection, SqlTransaction transaction)
			{
				if(items != null && items.Count > 0)
				{
					int results = -1;
		...
		public static List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> GetDataArtikleProcedure(string searchTerms, int articleId, int supplierId, Settings.SortingModel dataSorting, Settings.PaginModel dataPaging)
		{
			string paging = "";
			string sorting = "";
			...
			{
				sqlConnection.Open();
				string query = $"SELECT * FROM [__LGT_PlantBookingsArticleControlledProcedures] WHERE [ArticleId]={articleId} AND [SupplierId]={supplierId}";

				if(!string.IsNullOrWhiteSpace(searchTerms))
				{
					query += $" AND [ArticleNumber] LIKE '%{searchTerms.SqlEscape()}%'";
				}
				...
				//sqlCommand.Parameters.AddWithValue("articleId", supplierId);
				new SqlDataAdapter(sqlCommand).Fill(dataTable);
		...
		public static int CountArticleProcedureData(string searchTerms, int articleId, int supplierId)
		{
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{

				sqlConnection.Open();
				string query = @$"SELECT Count(*) FROM  [__LGT_PlantBookingsArticleControlledProcedures] WHERE [ArticleId]={articleId} AND [SupplierId]={supplierId}";
				if(!string.IsNullOrWhiteSpace(searchTerms))
				{
					query += $" AND [ArticleNumber] LIKE '%{searchTerms.SqlEscape()}%'";
				}
		...
		public static List<Infrastructure.Data.Entities.Tables.Logistics.PlantBookingsArticleControlledProceduresEntity> GetByNr(string artNr)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [__LGT_PlantBookingsArticleControlledProcedures]  WHERE [ArticleNumber]=@artNr";
				var sqlCommand = new SqlCommand(query, sqlConnection);
				sqlCommand.Parameters.AddWithValue("artNr", artNr);
