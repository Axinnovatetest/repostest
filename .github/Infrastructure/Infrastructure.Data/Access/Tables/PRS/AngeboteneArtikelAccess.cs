	...
	public class AngeboteneArtikelAccess
	{
		...
		public static int GetNextPositionNumberForOrder(int orderId)
		{
			...
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				...
				nextPositionNumber = int.TryParse(DbExecution.ExecuteScalar(sqlCommand).ToString(), out int nextPosition) ? nextPosition : 0;
			}
		...
		public static int GetMaxPositionNumberByOrderId(int angebotNr)
		{
			...
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				...
				response = int.TryParse(DbExecution.ExecuteScalar(sqlCommand).ToString(), out int nextPosition) ? nextPosition : 0;
			}
		...
		public static int GetMaxPositionNumberByOrderId(int angebotNr, SqlConnection sqlConnection, SqlTransaction sqlTransaction)
		{
			...
			return int.TryParse(DbExecution.ExecuteScalar(sqlCommand).ToString(), out int nextPosition) ? nextPosition : 0;
