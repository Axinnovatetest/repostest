...
namespace Infrastructure.Data.Access.Tables.PRS
{
	public class KundenAccess
	{
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.PRS.KundenEntity item)
		{
			...
			string query = "INSERT INTO [Kunden] ([Belegkreis],[Bemerkungen],[Branche],[Bruttofakturierung],[CodeTypeInLS],[CodeTypeInLSId],[Debitoren-Nr],[DEL],[DEL-Fixiert],[Edi-Aktiv-Delfor],[Edi-Aktiv-Desadv],[EG - Identifikationsnummer],[Eilzuschlag],[Factoring],[fibu_rahmen],[gesperrt für weitere Lieferungen],[Grund],[Grund für Sperre],[Karenztage],[Konditionszuordnungs-Nr],[Kreditlimit],[Kundengruppe],[Lieferantenummer (Kunden)],[Lieferscheinadresse],[LSADR],[LSADRANG],[LSADRAUF],[LSADRGUT],[LSADRPROF],[LSADRRG],[LSADRSTO],[LsBarCodeDocumentNumber],[LSRG],[Mahngebühr 1],[Mahngebühr 2],[Mahngebühr 3],[Mahnsperre],[Mindermengenzuschlag],[nummer],[OPOS],[OrderAddress],[Preisgruppe],[Preisgruppe2],[Rabattgruppe],[Regelmäßig anschreiben ?],[RG-Abteilung],[RG-Land/PLZ/ORT],[RG-Strasse-Postfach],[Sprache],[Standardversand],[Umsatzsteuer berechnen],[Versandart],[Verzugszinsen],[Verzugszinsen ab Mahnstufe],[Währung],[Zahlung erwartet nach],[Zahlungskondition],[Zahlungsmoral],[Zahlungsweise],[ZahlungsweiseCode],[Zielaufschlag],[zolltarif_nr]) OUTPUT INSERTED.[Nr] VALUES (@Belegkreis,@Bemerkungen,@Branche,@Bruttofakturierung,@CodeTypeInLS,@CodeTypeInLSId,@Debitoren_Nr,@DEL,@DEL_Fixiert,@Edi_Aktiv_Delfor,@Edi_Aktiv_Desadv,@EG___Identifikationsnummer,@Eilzuschlag,@Factoring,@fibu_rahmen,@gesperrt_fur_weitere_Lieferungen,@Grund,@Grund_fur_Sperre,@Karenztage,@Konditionszuordnungs_Nr,@Kreditlimit,@Kundengruppe,@Lieferantenummer__Kunden_,@Lieferscheinadresse,@LSADR,@LSADRANG,@LSADRAUF,@LSADRGUT,@LSADRPROF,@LSADRRG,@LSADRSTO,@LsBarCodeDocumentNumber,@LSRG,@Mahngebuhr_1,@Mahngebuhr_2,@Mahngebuhr_3,@Mahnsperre,@Mindermengenzuschlag,@nummer,@OPOS,@OrderAddress,@Preisgruppe,@Preisgruppe2,@Rabattgruppe,@Regelmassig_anschreiben__,@RG_Abteilung,@RG_Land_PLZ_ORT,@RG_Strasse_Postfach,@Sprache,@Standardversand,@Umsatzsteuer_berechnen,@Versandart,@Verzugszinsen,@Verzugszinsen_ab_Mahnstufe,@Wahrung,@Zahlung_erwartet_nach,@Zahlungskondition,@Zahlungsmoral,@Zahlungsweise,@ZahlungsweiseCode,@Zielaufschlag,@zolltarif_nr); ";
			...
			sqlCommand.Parameters.AddWithValue("Edi_Aktiv_Delfor", item.Edi_Aktiv_Delfor == null ? (object)DBNull.Value : item.Edi_Aktiv_Delfor);
			sqlCommand.Parameters.AddWithValue("Edi_Aktiv_Desadv", item.Edi_Aktiv_Desadv == null ? (object)DBNull.Value : item.Edi_Aktiv_Desadv);
			...
			sqlCommand.Parameters.AddWithValue("gesperrt_fur_weitere_Lieferungen", item.gesperrt_für_weitere_Lieferungen == null ? (object)DBNull.Value : item.gesperrt_für_weitere_Lieferungen);
			sqlCommand.Parameters.AddWithValue("Grund", item.Grund == null ? (object)DBNull.Value : item.Grund);
			sqlCommand.Parameters.AddWithValue("Grund_fur_Sperre", item.Grund_für_Sperre== null ? (object)DBNull.Value : item.Grund_für_Sperre);
			...
			sqlCommand.Parameters.AddWithValue("LsBarCodeDocumentNumber", item.LsBarCodeDocumentNumber == null ? (object)DBNull.Value : item.LsBarCodeDocumentNumber);
			sqlCommand.Parameters.AddWithValue("LSRG", item.LSRG == null ? (object)DBNull.Value : item.LSRG);
			sqlCommand.Parameters.AddWithValue("Mahngebuhr_1", item.Mahngebühr_1 == null ? (object)DBNull.Value : item.Mahngebühr_1);
			sqlCommand.Parameters.AddWithValue("Mahngebuhr_2", item.Mahngebühr_2 == null ? (object)DBNull.Value : item.Mahngebühr_2);
			sqlCommand.Parameters.AddWithValue("Mahngebuhr_3", item.Mahngebühr_3 == null ? (object)DBNull.Value : item.Mahngebühr_3);
			...
			sqlCommand.Parameters.AddWithValue("OrderAddress", item.OrderAddress == null ? (object)DBNull.Value : item.OrderAddress);
			...
			sqlCommand.Parameters.AddWithValue("Regelmassig_anschreiben__", item.Regelmäßig_anschreiben__ == null ? (object)DBNull.Value : item.Regelmäßig_anschreiben__);
			...
			sqlCommand.Parameters.AddWithValue("ZahlungsweiseCode", item.ZahlungsweiseCode == null ? (object)DBNull.Value : item.ZahlungsweiseCode);
		...
		public static List<Infrastructure.Data.Entities.Tables.PRS.KundenEntity> GetForCreate()
		{
			...
			string query = "SELECT * from kunden ";//Supprimet 18-03-2026 selon Telephone Amor Khelil : WHERE ISNULL([gesperrt für weitere Lieferungen],0)=0
		...
		public static int UpdateData(Infrastructure.Data.Entities.Tables.PRS.KundenEntity item, SqlConnection sqlConnection, SqlTransaction sqlTransaction)
		{
			string query = "UPDATE [Kunden] SET [DEL-Fixiert]=@DELFixiert,[DEL]=@DEL,[Belegkreis]=@Belegkreis, [Bemerkungen]=@Bemerkungen, [Branche]=@Branche, [Bruttofakturierung]=@Bruttofakturierung, [Debitoren-Nr]=@Debitoren_Nr, [EG - Identifikationsnummer]=@EG___Identifikationsnummer, [Eilzuschlag]=@Eilzuschlag, [Factoring]=@Factoring, [fibu_rahmen]=@fibu_rahmen, [gesperrt für weitere Lieferungen]=@gesperrt_für_weitere_Lieferungen, [Grund]=@Grund, [Grund für Sperre]=@Grund_für_Sperre, [Karenztage]=@Karenztage, [Konditionszuordnungs-Nr]=@Konditionszuordnungs_Nr, [Kreditlimit]=@Kreditlimit, [Kundengruppe]=@Kundengruppe, [Lieferantenummer (Kunden)]=@Lieferantenummer__Kunden_, [Lieferscheinadresse]=@Lieferscheinadresse, [Mahngebühr 1]=@Mahngebühr_1, [Mahngebühr 2]=@Mahngebühr_2, [Mahngebühr 3]=@Mahngebühr_3, [Mahnsperre]=@Mahnsperre, [Mindermengenzuschlag]=@Mindermengenzuschlag, [nummer]=@nummer, [OPOS]=@OPOS, [Preisgruppe]=@Preisgruppe, [Preisgruppe2]=@Preisgruppe2, [Rabattgruppe]=@Rabattgruppe, [Regelmäßig anschreiben ?]=@Regelmäßig_anschreiben__, [RG-Abteilung]=@RG_Abteilung, [RG-Land/PLZ/ORT]=@RG_Land_PLZ_ORT, [RG-Strasse-Postfach]=@RG_Strasse_Postfach, [Sprache]=@Sprache,[Umsatzsteuer berechnen]=@Umsatzsteuer_berechnen, [Versandart]=@Versandart, [Verzugszinsen]=@Verzugszinsen, [Währung]=@Währung,[Verzugszinsen ab Mahnstufe]=@Verzugszinsen_ab_Mahnstufe, [Zahlung erwartet nach]=@Zahlung_erwartet_nach, [Zahlungskondition]=@Zahlungskondition, [Zahlungsmoral]=@Zahlungsmoral, [Zahlungsweise]=@Zahlungsweise, [ZahlungsweiseCode]=@ZahlungsweiseCode, [Zielaufschlag]=@Zielaufschlag, [zolltarif_nr]=@zolltarif_nr,[CodeTypeInLS]=@CodeTypeInLS,[CodeTypeInLSId]=@CodeTypeInLSId WHERE [Nr]=@Nr";
		...
		// 21.07.2025
		public static int UpdateEdi(int Nr, bool Edi_Aktiv_Delfor, bool Edi_Aktiv_Desadv, SqlConnection sqlConnection, SqlTransaction sqlTransaction)
		{

			string query = "UPDATE [Kunden] SET [Edi-Aktiv-Delfor]=@Edi_Aktiv_Delfor, [Edi-Aktiv-Desadv]=@Edi_Aktiv_Desadv WHERE [nummer]=@Nr";

			var sqlCommand = new SqlCommand(query, sqlConnection, sqlTransaction);

			sqlCommand.Parameters.AddWithValue("@Nr",Nr);
			sqlCommand.Parameters.AddWithValue("@Edi_Aktiv_Delfor", Edi_Aktiv_Delfor);
			sqlCommand.Parameters.AddWithValue("@Edi_Aktiv_Desadv", Edi_Aktiv_Desadv);
			int response = DbExecution.ExecuteNonQuery(sqlCommand);
