...
namespace Infrastructure.Data.Access.Tables.PRS
{
	public class ArtikelAccess
	{
			...
			if(elements != null && elements.Count > 0)
			{
				...
				using(var cnn = new SqlConnection(Infrastructure.Data.Access.Settings.ConnectionString))
				{
					...
					foreach(Entities.Tables.PRS.ArtikelEntity t in elements)
					{
						...
						sqlCommand.Parameters.AddWithValue("ArtikelNr" + i, t.ArtikelNr);
						sqlCommand.Parameters.AddWithValue("Bezeichnung1" + i, t.Bezeichnung1 == null ? (object)DBNull.Value : t.Bezeichnung1);
						sqlCommand.Parameters.AddWithValue("Bezeichnung2" + i, t.Bezeichnung2 == null ? (object)DBNull.Value : t.Bezeichnung2);
						sqlCommand.Parameters.AddWithValue("Bezeichnung3" + i, t.Bezeichnung3 == null ? (object)DBNull.Value : t.Bezeichnung3);
						sqlCommand.Parameters.AddWithValue("BezeichnungAL" + i, t.BezeichnungAL == null ? (object)DBNull.Value : t.BezeichnungAL);
					}
		...
		public static List<Infrastructure.Data.Entities.Tables.PRS.ArtikelEntity> SearchByNrNumberDesignation(
			List<string> articleNummers, string nummer, string designation, string goodsGroup, bool? active, string articleFamily, string customerItemNumber, string details, bool? ediDefault, bool? eDrawing, string ArticleReference,
			Data.Access.Settings.SortingModel sorting, Data.Access.Settings.PaginModel paging,bool fromBOM=false)
		{
			nummer = nummer?.Trim();
			...
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString))
			{
				...
				{
					clause += $" ORDER BY {(fromBOM? "[Artikelnummer]" : "[Artikel-Nr] DESC")} ";
				}
		...
		public static decimal GetCuGewicht(int articleNr)
		{
			using(var sqlConnection = new SqlConnection(Infrastructure.Data.Access.Settings.ConnectionString))
			{
				...
				return decimal.TryParse(DbExecution.ExecuteScalar(sqlCommand)?.ToString(), out var _val) == true ? _val : 0m;
			}
		}
		...
		public static int EditCPRequirement(int articleId, bool cpRequired, SqlConnection connection, SqlTransaction transaction)
		{
			...
			using(var sqlCommand = new SqlCommand(query, connection, transaction))
			{
				...
				return int.TryParse(DbExecution.ExecuteNonQuery(sqlCommand).ToString(), out var i) ? i : 0;
			}
		}
		...
		public static List<Entities.Tables.PRS.ArtikelEntity> GetByCustomerNumber(int customerNumber, bool topOne = false)
		{
			...
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				...
				using(var dataReader = DbExecution.ExecuteReader(sqlCommand))
				{
		...
		private static int editWithTransaction(List<Entities.Tables.PRS.ArtikelEntity> elements, SqlConnection connection, SqlTransaction transaction)
		{
			if(elements != null && elements.Count > 0)
			{
				...
				foreach(Entities.Tables.PRS.ArtikelEntity t in elements)
				{
					...
					sqlCommand.Parameters.AddWithValue("ArtikelNr" + i, t.ArtikelNr);
					sqlCommand.Parameters.AddWithValue("Abladestelle" + i, t.Abladestelle == null ? (object)DBNull.Value : t.Abladestelle);
					sqlCommand.Parameters.AddWithValue("aktiv" + i, t.aktiv == null ? (object)DBNull.Value : t.aktiv);
					sqlCommand.Parameters.AddWithValue("aktualisiert" + i, t.aktualisiert == null ? (object)DBNull.Value : t.aktualisiert);
					sqlCommand.Parameters.AddWithValue("Anfangsbestand" + i, t.Anfangsbestand == null ? (object)DBNull.Value : t.Anfangsbestand);
					sqlCommand.Parameters.AddWithValue("ArtikelAusEigenerProduktion" + i, t.ArtikelAusEigenerProduktion == null ? (object)DBNull.Value : t.ArtikelAusEigenerProduktion);
					sqlCommand.Parameters.AddWithValue("ArtikelFürWeitereBestellungenSperren" + i, t.ArtikelFürWeitereBestellungenSperren == null ? (object)DBNull.Value : t.ArtikelFürWeitereBestellungenSperren);
					sqlCommand.Parameters.AddWithValue("Artikelfamilie_Kunde" + i, t.Artikelfamilie_Kunde == null ? (object)DBNull.Value : t.Artikelfamilie_Kunde);
					sqlCommand.Parameters.AddWithValue("Artikelfamilie_Kunde_Detail1" + i, t.Artikelfamilie_Kunde_Detail1 == null ? (object)DBNull.Value : t.Artikelfamilie_Kunde_Detail1);
					sqlCommand.Parameters.AddWithValue("Artikelfamilie_Kunde_Detail2" + i, t.Artikelfamilie_Kunde_Detail2 == null ? (object)DBNull.Value : t.Artikelfamilie_Kunde_Detail2);
					sqlCommand.Parameters.AddWithValue("Artikelkurztext" + i, t.Artikelkurztext == null ? (object)DBNull.Value : t.Artikelkurztext);
					sqlCommand.Parameters.AddWithValue("Artikelnummer" + i, t.ArtikelNummer == null ? (object)DBNull.Value : t.ArtikelNummer);
					sqlCommand.Parameters.AddWithValue("Barverkauf" + i, t.Barverkauf == null ? (object)DBNull.Value : t.Barverkauf);
					sqlCommand.Parameters.AddWithValue("Bezeichnung1" + i, t.Bezeichnung1 == null ? (object)DBNull.Value : t.Bezeichnung1);
					sqlCommand.Parameters.AddWithValue("Bezeichnung2" + i, t.Bezeichnung2 == null ? (object)DBNull.Value : t.Bezeichnung2);
					sqlCommand.Parameters.AddWithValue("Bezeichnung3" + i, t.Bezeichnung3 == null ? (object)DBNull.Value : t.Bezeichnung3);
					sqlCommand.Parameters.AddWithValue("BezeichnungAL" + i, t.BezeichnungAL == null ? (object)DBNull.Value : t.BezeichnungAL);
					sqlCommand.Parameters.AddWithValue("COF_Pflichtig" + i, t.COF_Pflichtig == null ? (object)DBNull.Value : t.COF_Pflichtig);
					sqlCommand.Parameters.AddWithValue("Crossreferenz" + i, t.Crossreferenz == null ? (object)DBNull.Value : t.Crossreferenz);
					sqlCommand.Parameters.AddWithValue("CuGewicht" + i, t.CuGewicht == null ? (object)DBNull.Value : t.CuGewicht);
					sqlCommand.Parameters.AddWithValue("DatumAnfangsbestand" + i, t.DatumAnfangsbestand == null ? (object)DBNull.Value : t.DatumAnfangsbestand);
					sqlCommand.Parameters.AddWithValue("DEL" + i, t.DEL == null ? (object)DBNull.Value : t.DEL);
					sqlCommand.Parameters.AddWithValue("DELFixiert" + i, t.DELFixiert == null ? (object)DBNull.Value : t.DELFixiert);
					sqlCommand.Parameters.AddWithValue("Dokumente" + i, t.Dokumente == null ? (object)DBNull.Value : t.Dokumente);
					sqlCommand.Parameters.AddWithValue("EAN" + i, t.EAN == null ? (object)DBNull.Value : t.EAN);
					sqlCommand.Parameters.AddWithValue("Einheit" + i, t.Einheit == null ? (object)DBNull.Value : t.Einheit);
					sqlCommand.Parameters.AddWithValue("EMPB" + i, t.EMPB == null ? (object)DBNull.Value : t.EMPB);
					sqlCommand.Parameters.AddWithValue("EMPB_Freigegeben" + i, t.EMPB_Freigegeben == null ? (object)DBNull.Value : t.EMPB_Freigegeben);
					sqlCommand.Parameters.AddWithValue("Ersatzartikel" + i, t.Ersatzartikel == null ? (object)DBNull.Value : t.Ersatzartikel);
					sqlCommand.Parameters.AddWithValue("ESD_Schutz" + i, t.ESD_Schutz == null ? (object)DBNull.Value : t.ESD_Schutz);
					sqlCommand.Parameters.AddWithValue("Exportgewicht" + i, t.Exportgewicht == null ? (object)DBNull.Value : t.Exportgewicht);
					sqlCommand.Parameters.AddWithValue("ArtikelFürWeitereBestellungenSperren" + i, t.ArtikelFürWeitereBestellungenSperren == null ? (object)DBNull.Value : t.ArtikelFürWeitereBestellungenSperren);
					sqlCommand.Parameters.AddWithValue("fakturierenStückliste" + i, t.fakturierenStückliste == null ? (object)DBNull.Value : t.fakturierenStückliste);
					sqlCommand.Parameters.AddWithValue("Farbe" + i, t.Farbe == null ? (object)DBNull.Value : t.Farbe);
					sqlCommand.Parameters.AddWithValue("fibu_rahmen" + i, t.fibu_rahmen == null ? (object)DBNull.Value : t.fibu_rahmen);
					sqlCommand.Parameters.AddWithValue("Freigabestatus" + i, t.Freigabestatus == null ? (object)DBNull.Value : t.Freigabestatus);
					sqlCommand.Parameters.AddWithValue("FreigabestatusTNIntern" + i, t.FreigabestatusTNIntern == null ? (object)DBNull.Value : t.FreigabestatusTNIntern);
					sqlCommand.Parameters.AddWithValue("Gebinde" + i, t.Gebinde == null ? (object)DBNull.Value : t.Gebinde);
					sqlCommand.Parameters.AddWithValue("Gewicht" + i, t.Gewicht == null ? (object)DBNull.Value : t.Gewicht);
					sqlCommand.Parameters.AddWithValue("Größe" + i, t.Größe == null ? (object)DBNull.Value : t.Größe);
					sqlCommand.Parameters.AddWithValue("GrundFürSperre" + i, t.GrundFürSperre == null ? (object)DBNull.Value : t.GrundFürSperre);
					sqlCommand.Parameters.AddWithValue("gültigBis" + i, t.gültigBis == null ? (object)DBNull.Value : t.gültigBis);
					sqlCommand.Parameters.AddWithValue("Halle" + i, t.Halle == null ? (object)DBNull.Value : t.Halle);
					sqlCommand.Parameters.AddWithValue("Hubmastleitungen" + i, t.Hubmastleitungen == null ? (object)DBNull.Value : t.Hubmastleitungen);
					sqlCommand.Parameters.AddWithValue("ID_Klassifizierung" + i, t.ID_Klassifizierung == null ? (object)DBNull.Value : t.ID_Klassifizierung);
					sqlCommand.Parameters.AddWithValue("Index_Kunde" + i, t.Index_Kunde == null ? (object)DBNull.Value : t.Index_Kunde);
					sqlCommand.Parameters.AddWithValue("Index_Kunde_Datum" + i, t.Index_Kunde_Datum == null ? (object)DBNull.Value : t.Index_Kunde_Datum);
					sqlCommand.Parameters.AddWithValue("Info_WE" + i, t.Info_WE == null ? (object)DBNull.Value : t.Info_WE);
					sqlCommand.Parameters.AddWithValue("Kanban" + i, t.Kanban == null ? (object)DBNull.Value : t.Kanban);
					sqlCommand.Parameters.AddWithValue("Kategorie" + i, t.Kategorie == null ? (object)DBNull.Value : t.Kategorie);
					sqlCommand.Parameters.AddWithValue("Klassifizierung" + i, t.Klassifizierung == null ? (object)DBNull.Value : t.Klassifizierung);
					sqlCommand.Parameters.AddWithValue("Kriterium1" + i, t.Kriterium1 == null ? (object)DBNull.Value : t.Kriterium1);
					sqlCommand.Parameters.AddWithValue("Kriterium2" + i, t.Kriterium2 == null ? (object)DBNull.Value : t.Kriterium2);
					sqlCommand.Parameters.AddWithValue("Kriterium3" + i, t.Kriterium3 == null ? (object)DBNull.Value : t.Kriterium3);
					sqlCommand.Parameters.AddWithValue("Kriterium4" + i, t.Kriterium4 == null ? (object)DBNull.Value : t.Kriterium4);
					sqlCommand.Parameters.AddWithValue("Kupferbasis" + i, t.Kupferbasis == null ? (object)DBNull.Value : t.Kupferbasis);
					sqlCommand.Parameters.AddWithValue("Kupferzahl" + i, t.Kupferzahl == null ? (object)DBNull.Value : t.Kupferzahl);
					sqlCommand.Parameters.AddWithValue("Lagerartikel" + i, t.Lagerartikel == null ? (object)DBNull.Value : t.Lagerartikel);
					sqlCommand.Parameters.AddWithValue("Lagerhaltungskosten" + i, t.Lagerhaltungskosten == null ? (object)DBNull.Value : t.Lagerhaltungskosten);
					sqlCommand.Parameters.AddWithValue("Langtext" + i, t.Langtext == null ? (object)DBNull.Value : t.Langtext);
					sqlCommand.Parameters.AddWithValue("Langtext_drucken_AB" + i, t.Langtext_drucken_AB == null ? (object)DBNull.Value : t.Langtext_drucken_AB);
					sqlCommand.Parameters.AddWithValue("Langtext_drucken_BW" + i, t.Langtext_drucken_BW == null ? (object)DBNull.Value : t.Langtext_drucken_BW);
					sqlCommand.Parameters.AddWithValue("Lieferzeit" + i, t.Lieferzeit == null ? (object)DBNull.Value : t.Lieferzeit);
					sqlCommand.Parameters.AddWithValue("Losgroesse" + i, t.Losgroesse == null ? (object)DBNull.Value : t.Losgroesse);
					sqlCommand.Parameters.AddWithValue("Materialkosten_Alt" + i, t.Materialkosten_Alt == null ? (object)DBNull.Value : t.Materialkosten_Alt);
					sqlCommand.Parameters.AddWithValue("MHD" + i, t.MHD == null ? (object)DBNull.Value : t.MHD);
					sqlCommand.Parameters.AddWithValue("MineralsConfirmity" + i, t.MineralsConfirmity == null ? (object)DBNull.Value : t.MineralsConfirmity);
					sqlCommand.Parameters.AddWithValue("Praeferenz_Aktuelles_jahr" + i, t.Praeferenz_Aktuelles_jahr == null ? (object)DBNull.Value : t.Praeferenz_Aktuelles_jahr);
					sqlCommand.Parameters.AddWithValue("Praeferenz_Folgejahr" + i, t.Praeferenz_Folgejahr == null ? (object)DBNull.Value : t.Praeferenz_Folgejahr);
					sqlCommand.Parameters.AddWithValue("Preiseinheit" + i, t.Preiseinheit == null ? (object)DBNull.Value : t.Preiseinheit);
					sqlCommand.Parameters.AddWithValue("proZeiteinheit" + i, t.proZeiteinheit == null ? (object)DBNull.Value : t.proZeiteinheit);
					sqlCommand.Parameters.AddWithValue("Produktionszeit" + i, t.Produktionszeit == null ? (object)DBNull.Value : t.Produktionszeit);
					sqlCommand.Parameters.AddWithValue("Provisionsartikel" + i, t.Provisionsartikel == null ? (object)DBNull.Value : t.Provisionsartikel);
					sqlCommand.Parameters.AddWithValue("PrüfstatusTNWare" + i, t.PrufstatusTNWare == null ? (object)DBNull.Value : t.PrufstatusTNWare);
					sqlCommand.Parameters.AddWithValue("Rabattierfähig" + i, t.Rabattierfähig == null ? (object)DBNull.Value : t.Rabattierfähig);
					sqlCommand.Parameters.AddWithValue("Rahmen" + i, t.Rahmen == null ? (object)DBNull.Value : t.Rahmen);
					sqlCommand.Parameters.AddWithValue("Rahmen2" + i, t.Rahmen2 == null ? (object)DBNull.Value : t.Rahmen2);
					sqlCommand.Parameters.AddWithValue("Rahmenauslauf" + i, t.Rahmenauslauf == null ? (object)DBNull.Value : t.Rahmenauslauf);
					sqlCommand.Parameters.AddWithValue("Rahmenauslauf2" + i, t.Rahmenauslauf2 == null ? (object)DBNull.Value : t.Rahmenauslauf2);
					sqlCommand.Parameters.AddWithValue("Rahmenmenge" + i, t.Rahmenmenge == null ? (object)DBNull.Value : t.Rahmenmenge);
					sqlCommand.Parameters.AddWithValue("Rahmenmenge2" + i, t.Rahmenmenge2 == null ? (object)DBNull.Value : t.Rahmenmenge2);
					sqlCommand.Parameters.AddWithValue("RahmenNr" + i, t.RahmenNr == null ? (object)DBNull.Value : t.RahmenNr);
					sqlCommand.Parameters.AddWithValue("RahmenNr2" + i, t.RahmenNr2 == null ? (object)DBNull.Value : t.RahmenNr2);
					sqlCommand.Parameters.AddWithValue("REACHSVHCConfirmity" + i, t.REACHSVHCConfirmity == null ? (object)DBNull.Value : t.REACHSVHCConfirmity);
					sqlCommand.Parameters.AddWithValue("ROHSEEEConfirmity" + i, t.ROHSEEEConfirmity == null ? (object)DBNull.Value : t.ROHSEEEConfirmity);
					sqlCommand.Parameters.AddWithValue("Seriennummer" + i, t.Seriennummer == null ? (object)DBNull.Value : t.Seriennummer);
					sqlCommand.Parameters.AddWithValue("Seriennummernverwaltung" + i, t.Seriennummernverwaltung == null ? (object)DBNull.Value : t.Seriennummernverwaltung);
					sqlCommand.Parameters.AddWithValue("Sonderrabatt" + i, t.Sonderrabatt == null ? (object)DBNull.Value : t.Sonderrabatt);
					sqlCommand.Parameters.AddWithValue("Standard_Lagerort_id" + i, t.Standard_Lagerort_id == null ? (object)DBNull.Value : t.Standard_Lagerort_id);
					sqlCommand.Parameters.AddWithValue("Stückliste" + i, t.Stuckliste == null ? (object)DBNull.Value : t.Stuckliste);
					sqlCommand.Parameters.AddWithValue("Stundensatz" + i, t.Stundensatz == null ? (object)DBNull.Value : t.Stundensatz);
					sqlCommand.Parameters.AddWithValue("Sysmonummer" + i, t.Sysmonummer == null ? (object)DBNull.Value : t.Sysmonummer);
					sqlCommand.Parameters.AddWithValue("ULEtikett" + i, t.ULEtikett == null ? (object)DBNull.Value : t.ULEtikett);
					sqlCommand.Parameters.AddWithValue("ULzertifiziert" + i, t.ULzertifiziert == null ? (object)DBNull.Value : t.ULzertifiziert);
					sqlCommand.Parameters.AddWithValue("Umsatzsteuer" + i, t.Umsatzsteuer == null ? (object)DBNull.Value : t.Umsatzsteuer);
					sqlCommand.Parameters.AddWithValue("Ursprungsland" + i, t.Ursprungsland == null ? (object)DBNull.Value : t.Ursprungsland);
					sqlCommand.Parameters.AddWithValue("Verpackung" + i, t.Verpackung == null ? (object)DBNull.Value : t.Verpackung);
					sqlCommand.Parameters.AddWithValue("Verpackungsart" + i, t.Verpackungsart == null ? (object)DBNull.Value : t.Verpackungsart);
					sqlCommand.Parameters.AddWithValue("Verpackungsmenge" + i, t.Verpackungsmenge == null ? (object)DBNull.Value : t.Verpackungsmenge);
					sqlCommand.Parameters.AddWithValue("VKFestpreis" + i, t.VKFestpreis == null ? (object)DBNull.Value : t.VKFestpreis);
					sqlCommand.Parameters.AddWithValue("Volumen" + i, t.Volumen == null ? (object)DBNull.Value : t.Volumen);
					sqlCommand.Parameters.AddWithValue("Warengruppe" + i, t.Warengruppe == null ? (object)DBNull.Value : t.Warengruppe);
					sqlCommand.Parameters.AddWithValue("Warentyp" + i, t.Warentyp == null ? (object)DBNull.Value : t.Warentyp);
					sqlCommand.Parameters.AddWithValue("Webshop" + i, t.Webshop == null ? (object)DBNull.Value : t.Webshop);
					sqlCommand.Parameters.AddWithValue("Werkzeug" + i, t.Werkzeug == null ? (object)DBNull.Value : t.Werkzeug);
					sqlCommand.Parameters.AddWithValue("Wert_Anfangsbestand" + i, t.Wert_Anfangsbestand == null ? (object)DBNull.Value : t.Wert_Anfangsbestand);
					sqlCommand.Parameters.AddWithValue("Zeichnungsnummer" + i, t.Zeichnungsnummer == null ? (object)DBNull.Value : t.Zeichnungsnummer);
					sqlCommand.Parameters.AddWithValue("Zeitraum_MHD" + i, t.Zeitraum_MHD == null ? (object)DBNull.Value : t.Zeitraum_MHD);
					sqlCommand.Parameters.AddWithValue("Zolltarif_nr" + i, t.Zolltarif_nr == null ? (object)DBNull.Value : t.Zolltarif_nr);
					sqlCommand.Parameters.AddWithValue("VDA_1" + i, t.VDA_1 == null ? (object)DBNull.Value : t.VDA_1);
					sqlCommand.Parameters.AddWithValue("VDA_2" + i, t.VDA_2 == null ? (object)DBNull.Value : t.VDA_2);
					sqlCommand.Parameters.AddWithValue("Zuschlag_VK" + i, t.Zuschlag_VK == null ? (object)DBNull.Value : t.Zuschlag_VK);
					sqlCommand.Parameters.AddWithValue("artikelklassifizierung" + i, t.artikelklassifizierung == null ? (object)DBNull.Value : t.artikelklassifizierung);
					sqlCommand.Parameters.AddWithValue("UBG" + i, t.UBG);
					sqlCommand.Parameters.AddWithValue("EdiDefault" + i, t.EdiDefault == null ? (object)DBNull.Value : t.EdiDefault);
					sqlCommand.Parameters.AddWithValue("IsEDrawing" + i, t.IsEDrawing == null ? (object)DBNull.Value : t.IsEDrawing);
				}
		...
		public static bool IsArticleReparatur(int articleNr, List<string> reparaturArticles)
		{
			...
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				...
				return (int.TryParse(DbExecution.ExecuteScalar(sqlCommand).ToString(), out var x) ? x : -1) > 0;
			}
		}
        ...
        public static List<Entities.Tables.PRS.ArtikelEntity> GetForCRPFAUpdate(string artikelnmmer)
        {
            var result = new List<Entities.Tables.PRS.ArtikelEntity>();
            ...
            using (var sqlConnection = new SqlConnection(Infrastructure.Data.Access.Settings.ConnectionString))
            {
                ...
                string query = @$"WITH Base AS
								(
									SELECT 
										ProductionPlace1_Id,
										LEFT(Artikelnummer, LEN(Artikelnummer) - CHARINDEX('-', REVERSE(Artikelnummer))) AS Prefix
									FROM Artikel a JOIN  __BSD_ArtikelProductionExtension e on e.ArticleId=a.[Artikel-Nr]
									WHERE Artikelnummer = @Artikelnummer
								)
								SELECT a.*
								FROM Artikel a
								JOIN  __BSD_ArtikelProductionExtension e on e.ArticleId=a.[Artikel-Nr]
								JOIN Base b
									ON e.ProductionPlace1_Id = b.ProductionPlace1_Id
									AND LEFT(a.Artikelnummer, LEN(a.Artikelnummer) - CHARINDEX('-', REVERSE(a.Artikelnummer))) = b.Prefix
								WHERE 
									a.[aktiv] = 1
									AND a.[Stückliste] = 1
									AND [Freigabestatus]<>'O'
									AND a.Artikelnummer <> @Artikelnummer;";
				var sqlCommand = new SqlCommand(query, sqlConnection);
				sqlCommand.Parameters.AddWithValue("Artikelnummer", artikelnmmer ?? "");
		...
		public static List<Entities.Tables.PRS.MinimalSalesArtikelEntity> GetMinimal(bool ignoreArchived = true)
		{
			var dataTable = new DataTable();
			...
			using(var sqlConnection = new SqlConnection(Infrastructure.Data.Access.Settings.ConnectionString))
			{
				...
				string query = $"SELECT * FROM [Artikel] WHERE ISNULL(Aktiv,0)={(ignoreArchived ? 1 : 0)}";
				var sqlCommand = new SqlCommand(query, sqlConnection);
				DbExecution.Fill(sqlCommand, dataTable);

				if(dataTable.Rows.Count > 0)
				{
					return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.PRS.MinimalSalesArtikelEntity(x)).ToList();
				}
				else
				{
					return new List<Infrastructure.Data.Entities.Tables.PRS.MinimalSalesArtikelEntity>();
				}
			}
		}
		public static int UpdateLotProductionData(List<(int articleNr, int? lotSize, decimal? productionTime)> items, SqlConnection connection, SqlTransaction transaction)
		{
			...
			using(var sqlCommand = new SqlCommand(query, connection, transaction))
			{
				...
				{
					query += $"UPDATE [Artikel] SET /*[Lieferzeit]=@Lieferzeit, */[Losgroesse]=@Losgroesse{i}, [Produktionszeit]=@Produktionszeit{i} WHERE [Artikel-Nr]=@Artikel_Nr{i};";

					sqlCommand.Parameters.AddWithValue($"Artikel_Nr{i}", items[i].articleNr);
					//sqlCommand.Parameters.AddWithValue($"Lieferzeit{i}", items[i].Lieferzeit == null ? (object)DBNull.Value : items[i].Lieferzeit);
					sqlCommand.Parameters.AddWithValue($"Losgroesse{i}", items[i].lotSize == null ? (object)DBNull.Value : items[i].lotSize);
					sqlCommand.Parameters.AddWithValue($"Produktionszeit{i}", items[i].productionTime == null ? (object)DBNull.Value : items[i].productionTime);
				}
				sqlCommand.CommandText = query;
				return DbExecution.ExecuteNonQuery(sqlCommand);
			}
		}
		public static List<Entities.Tables.PRS.MinimalArtikelDataEntity> GetMinimal(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Infrastructure.Data.Access.Settings.MAX_BATCH_SIZE;
				var result = new List<Entities.Tables.PRS.MinimalArtikelDataEntity>();
				if(ids.Count <= maxQueryNumber)
				{
					result = getMinimal(ids);
				}
				else
				{
					int batchNumber = ids.Count / maxQueryNumber;
					result = new List<Entities.Tables.PRS.MinimalArtikelDataEntity>();
					for(int i = 0; i < batchNumber; i++)
					{
						result.AddRange(getMinimal(ids.GetRange(i * maxQueryNumber, maxQueryNumber)));
					}
					result.AddRange(getMinimal(ids.GetRange(batchNumber * maxQueryNumber, ids.Count - batchNumber * maxQueryNumber)));
				}
				return result;
			}
			return new List<Entities.Tables.PRS.MinimalArtikelDataEntity>();
		}
		private static List<Entities.Tables.PRS.MinimalArtikelDataEntity> getMinimal(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
				...
				if(dataTable.Rows.Count > 0)
				{
					return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.PRS.MinimalArtikelDataEntity(x)).ToList();
				}
				else
				{
					return new List<Infrastructure.Data.Entities.Tables.PRS.MinimalArtikelDataEntity>();
				}
			}
			return new List<Entities.Tables.PRS.MinimalArtikelDataEntity>();
		}
