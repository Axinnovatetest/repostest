...
namespace Infrastructure.Data.Access.Tables.FNC
{
	public class KonditionsZuordnungstabelleEntity
	{
		...
		public static Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity Get(int id)
		{
			...
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
			{
				...
				string query = "SELECT * FROM [__FNC_Konditionszuordnungstabelle] WHERE [Nr]=@Id";
			...
			{
				return new Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity> Get()
		{
			var dataTable = new DataTable();
			...
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
			{
				...
				string query = "SELECT * FROM [__FNC_Konditionszuordnungstabelle]";
				var sqlCommand = new SqlCommand(query, sqlConnection);
			...
			{
				return new List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity>();
			}
		}
		public static List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity> Get(List<string> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				var result = new List<Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity>();
				...
				else
				{
					...
					result = new List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity>();
		...
		private static List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity> get(List<string> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
				...
				using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
				{
					...
					sqlCommand.CommandText = "SELECT * FROM [__FNC_Konditionszuordnungstabelle] WHERE [Nr] IN (" + queryIds + ")";
		...
		public static int Insert(Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity element)
		{
			int response = -1;
			...
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
			{
				...
				string query = "INSERT INTO [__FNC_Konditionszuordnungstabelle] "
					+ " ([Nettotage],[Nr],[Skonto],[Skontotage],[Text],[Bemerkung]) "
					+ " VALUES "
					+ " (@Nettotage,@Nr,@Skonto,@Skontotage,@Text,@Bemerkung)";
		...
		public static int Insert(List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity> elements)
		{
		...
		private static int insert(List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity> elements)
		{
			if(elements != null && elements.Count > 0)
			{
				int response = -1;
				...
				using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
				{
					...
					string query = " INSERT INTO [__FNC_Konditionszuordnungstabelle] ([Nettotage],[Nr],[Skonto],[Skontotage],[Text], [Bemerkung]) VALUES ";
		...
		public static int Update(Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity element)
		{
			int response = -1;
			...
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
			{
				...
				string query = "UPDATE [__FNC_Konditionszuordnungstabelle] "
		...
		public static int Update(List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity> elements)
		{
			if(elements != null && elements.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 7; // Nb params per query
		...
		private static int update(List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity> elements)
		{
			if(elements != null && elements.Count > 0)
			{
				int response = -1;
				...
				using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
				{
					...
					{
						i++;
						query += " UPDATE [__FNC_Konditionszuordnungstabelle] SET "
		...
		public static int Delete(string id)
		{
			...
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
			{
				...
				string query = "DELETE FROM [__FNC_Konditionszuordnungstabelle] WHERE [Nr]=@Id";
		...
		private static int delete(List<string> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				...
				using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
				{
					...
					string query = "DELETE FROM [__FNC_Konditionszuordnungstabelle] WHERE [Nr] IN (" + queryIds + ")";
					sqlCommand.CommandText = query;
		...
		#region Helpers
		private static List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity> toList(DataTable dataTable)
		{
			var result = new List<Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity>(dataTable.Rows.Count);
			foreach(DataRow dataRow in dataTable.Rows)
			{
				result.Add(new Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity(dataRow));
			}
			return result;
		}
		#endregion
