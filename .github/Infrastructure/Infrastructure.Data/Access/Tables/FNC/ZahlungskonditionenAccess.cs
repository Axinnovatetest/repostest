...
namespace Infrastructure.Data.Access.Tables.FNC
{
	...
	public class ZahlungskonditionenAccess
	{
		...
		public static Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity Get(int id)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [Zahlungskonditionen_Budget] WHERE [ID]=@Id";
			...
			{
				return new Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [Zahlungskonditionen_Budget]";
				var sqlCommand = new SqlCommand(query, sqlConnection);
			...
			{
				return new List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity>();
			}
		}
		public static List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity> Get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity> results = null;
				...
				else
				{
					...
					results = new List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity>();
		...
		private static List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity> get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
				using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
				{
					...
					sqlCommand.CommandText = "SELECT * FROM [Zahlungskonditionen_Budget] WHERE [ID] IN (" + queryIds + ")";
					new SqlDataAdapter(sqlCommand).Fill(dataTable);
				}
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity item)
		{
			int response = -1;
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
			{
				...
				string query = "INSERT INTO [Zahlungskonditionen_Budget] ([ID],[Bemerkungen],[Betrag_berechnen],[Nachlaß1],[Nachlaß2],[Nachlaß3],[Tage1],[Tage2],[Tage3],[Text11],[Text12],[Text21],[Text22],[Text31],[Text32])  VALUES (@ID,@Bemerkungen,@Betrag_berechnen,@Nachlaß1,@Nachlaß2,@Nachlaß3,@Tage1,@Tage2,@Tage3,@Text11,@Text12,@Text21,@Text22,@Text31,@Text32)";
				...
				using(var sqlCommand = new SqlCommand("SELECT [ID] FROM [Zahlungskonditionen_Budget] WHERE [ID] = @@IDENTITY", sqlConnection, sqlTransaction))
				{
		...
		public static int Insert(List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity> items)
		{
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
				using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
				{
					...
					{
						i++;
						query += " INSERT INTO [Zahlungskonditionen_Budget] ([ID],[Bemerkungen],[Betrag_berechnen],[Nachlaß1],[Nachlaß2],[Nachlaß3],[Tage1],[Tage2],[Tage3],[Text11],[Text12],[Text21],[Text22],[Text31],[Text32]) VALUES ( "
		...
		public static int Update(Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity item)
		{
			int results = -1;
			using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
			{
				sqlConnection.Open();
				string query = "UPDATE [Zahlungskonditionen_Budget] SET [Bemerkungen]=@Bemerkungen, [Betrag_berechnen]=@Betrag_berechnen, [Nachlaß1]=@Nachlaß1, [Nachlaß2]=@Nachlaß2, [Nachlaß3]=@Nachlaß3, [Tage1]=@Tage1, [Tage2]=@Tage2, [Tage3]=@Tage3, [Text11]=@Text11, [Text12]=@Text12, [Text21]=@Text21, [Text22]=@Text22, [Text31]=@Text31, [Text32]=@Text32 WHERE [ID]=@ID";
				var sqlCommand = new SqlCommand(query, sqlConnection);
		...
		public static int Update(List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 16; // Nb params per query
		...
		private static int update(List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
				using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
				{
					...
					{
						i++;
						query += " UPDATE [Zahlungskonditionen_Budget] SET "
		...
		public static int Delete(int id)
		{
			...
			{
				sqlConnection.Open();
				string query = "DELETE FROM [Zahlungskonditionen_Budget] WHERE [ID]=@ID";
				var sqlCommand = new SqlCommand(query, sqlConnection);
				sqlCommand.Parameters.AddWithValue("ID", id);
		...
		private static int delete(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				...
				using(var sqlConnection = new SqlConnection(Access.Settings.ConnectionString_FNC))
				{
					...
					string query = "DELETE FROM [Zahlungskonditionen_Budget] WHERE [ID] IN (" + queryIds + ")";
					sqlCommand.CommandText = query;
		...
		private static List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity> toList(DataTable dataTable)
		{
			var list = new List<Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity>(dataTable.Rows.Count);
			foreach(DataRow dataRow in dataTable.Rows)
			{ list.Add(new Infrastructure.Data.Entities.Tables.FNC.ZahlungskonditionenEntity(dataRow)); }
			return list;
		}
		#endregion
	}
