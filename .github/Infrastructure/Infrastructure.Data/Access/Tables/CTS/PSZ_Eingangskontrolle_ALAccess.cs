...
{
	public class PSZ_Eingangskontrolle_ALAccess
	{
		#region Default Methods
		public static Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity Get(int verpackungsnr)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			using(var sqlCommand = new SqlCommand("SELECT * FROM [PSZ_Eingangskontrolle_AL] WHERE [Verpackungsnr]=@Id", sqlConnection))
			{
				sqlConnection.Open();
			...
			{
				return new Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			using(var sqlCommand = new SqlCommand("SELECT * FROM [PSZ_Eingangskontrolle_AL]", sqlConnection))
			{
				sqlConnection.Open();
				new SqlDataAdapter(sqlCommand).Fill(dataTable);
			}
			...
			if(dataTable.Rows.Count > 0)
			{
				return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity(x)).ToList();
			}
			else
			{
				return new List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity>();
			}
		}

		public static List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> Get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> results = null;
				...
				else
				{
					...
					results = new List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity>();
		...
		private static List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
				...
				using(var sqlCommand = new SqlCommand("", sqlConnection))
				{
					...
					sqlCommand.CommandText = $"SELECT * FROM [PSZ_Eingangskontrolle_AL] WHERE [Verpackungsnr] IN ({string.Join(",", queryIds)})";
					new SqlDataAdapter(sqlCommand).Fill(dataTable);
				}
		...
		/*public static List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> GetByPage(Data.Access.Settings.SortingModel sorting, Data.Access.Settings.PaginModel paging)
        {  
            var dataTable = new DataTable();
            var query = "SELECT * FROM [PSZ_Eingangskontrolle_AL]";
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity item)
		{
		...
		public static int Insert(List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> items)
		{
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static int Update(List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 28; /* Nb params per query */
		...
		private static int update(List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
				...
				using(var sqlCommand = new SqlCommand("", sqlConnection))
				{
					...
					{
						i++;
						query += "UPDATE [PSZ_Eingangskontrolle_AL] SET "
		...
		{
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			using(var sqlCommand = new SqlCommand("DELETE FROM [PSZ_Eingangskontrolle_AL] WHERE [Verpackungsnr]=@Verpackungsnr", sqlConnection))
			{
				sqlConnection.Open();
		...
		private static int delete(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				...
				using(var sqlCommand = new SqlCommand("", sqlConnection))
				{
					...
					string query = $"DELETE FROM [PSZ_Eingangskontrolle_AL] WHERE [Verpackungsnr] IN ({string.Join(",", queryIds)})";
					sqlCommand.CommandText = query;
		...
		public static Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity GetWithTransaction(int verpackungsnr, SqlConnection connection, SqlTransaction transaction)
		{
			var dataTable = new DataTable();
			using(var sqlCommand = new SqlCommand("SELECT * FROM [PSZ_Eingangskontrolle_AL] WHERE [Verpackungsnr] = @Id", connection, transaction))
			{
				sqlCommand.Parameters.AddWithValue("Id", verpackungsnr);
				new SqlDataAdapter(sqlCommand).Fill(dataTable);
			}
		...
		public static List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> GetWithTransaction(SqlConnection connection, SqlTransaction transaction)
		{
			var dataTable = new DataTable();
			using(var sqlCommand = new SqlCommand("SELECT * FROM [PSZ_Eingangskontrolle_AL]", connection, transaction))
			{
				new SqlDataAdapter(sqlCommand).Fill(dataTable);
			}
		...
		public static List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> GetWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
		...
		private static List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> getWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
		...
		public static int InsertWithTransaction(Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity item, SqlConnection connection, SqlTransaction transaction)
		{
			string query = "INSERT INTO PSZ_Eingangskontrolle_AL ([Aktiv],[Akzeptierte_Menge],[Anzahl_Verpackungen],[Artikelnummer],[Bestellung-Nr],[Clock Number],[Datum],[Eingangslieferscheinnr],[Gedruckt],[Geprüfte_Prüfmenge],[Gesamtmenge],[Inspektor],[Kunde],[LagerortID],[Laufende Nummer],[Menge],[MHDDatum],[Prüfentscheid],[Prüfmenge],[Prüftiefe],[Reklamierte Menge],[Restmenge_Rolle_PPS],[Resultat],[Status_Rolle],[WE_Anzahl_VOH],[WE_Datum_VOH],[WE_LS_VOH]) OUTPUT INSERTED.[Verpackungsnr] VALUES (@Aktiv,@Akzeptierte_Menge,@Anzahl_Verpackungen,@Artikelnummer,@Bestellung_Nr,@Clock_Number,@Datum,@Eingangslieferscheinnr,@Gedruckt,@Geprufte_Prufmenge,@Gesamtmenge,@Inspektor,@Kunde,@LagerortID,@Laufende_Nummer,@Menge,@MHDDatum,@Prufentscheid,@Prufmenge,@Pruftiefe,@Reklamierte_Menge,@Restmenge_Rolle_PPS,@Resultat,@Status_Rolle,@WE_Anzahl_VOH,@WE_Datum_VOH,@WE_LS_VOH); ";
		...
		public static int InsertWithTransaction(List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 28; /* Nb params per query */
		...
		private static int insertWithTransaction(List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				string query = "";
		...
		public static int UpdateWithTransaction(Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity item, SqlConnection connection, SqlTransaction transaction)
		{
			string query = "UPDATE [PSZ_Eingangskontrolle_AL] SET [Aktiv]=@Aktiv, [Akzeptierte_Menge]=@Akzeptierte_Menge, [Anzahl_Verpackungen]=@Anzahl_Verpackungen, [Artikelnummer]=@Artikelnummer, [Bestellung-Nr]=@Bestellung_Nr, [Clock Number]=@Clock_Number, [Datum]=@Datum, [Eingangslieferscheinnr]=@Eingangslieferscheinnr, [Gedruckt]=@Gedruckt, [Geprüfte_Prüfmenge]=@Geprufte_Prufmenge, [Gesamtmenge]=@Gesamtmenge, [Inspektor]=@Inspektor, [Kunde]=@Kunde, [LagerortID]=@LagerortID, [Laufende Nummer]=@Laufende_Nummer, [Menge]=@Menge, [MHDDatum]=@MHDDatum, [Prüfentscheid]=@Prufentscheid, [Prüfmenge]=@Prufmenge, [Prüftiefe]=@Pruftiefe, [Reklamierte Menge]=@Reklamierte_Menge, [Restmenge_Rolle_PPS]=@Restmenge_Rolle_PPS, [Resultat]=@Resultat, [Status_Rolle]=@Status_Rolle, [WE_Anzahl_VOH]=@WE_Anzahl_VOH, [WE_Datum_VOH]=@WE_Datum_VOH, [WE_LS_VOH]=@WE_LS_VOH WHERE [Verpackungsnr]=@Verpackungsnr";
			using(var sqlCommand = new SqlCommand(query, connection, transaction))
			{ 
		...
		public static int UpdateWithTransaction(List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 28; /* Nb params per query */
		...
		private static int updateWithTransaction(List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_ALEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				string query = "";
		...
		{
			string query = "DELETE FROM [PSZ_Eingangskontrolle_AL] WHERE [Verpackungsnr]=@Verpackungsnr";
			using(var sqlCommand = new SqlCommand(query, connection, transaction))
			{
				sqlCommand.Parameters.AddWithValue("Verpackungsnr", verpackungsnr);
				return sqlCommand.ExecuteNonQuery();
		...
		{
			string query = $"UPDATE [PSZ_Eingangskontrolle_AL] SET [Aktiv]=0 WHERE [Verpackungsnr] IN ({string.Join(",", mhdIds)})";
			using(var sqlCommand = new SqlCommand(query, connection, transaction))
			{
				return sqlCommand.ExecuteNonQuery();
			}
		...
		public static List<Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_TNMinimalEntity> GetByLagerIdAl(int lagerId, string filterSearch, Settings.SortingModel dataSorting, Settings.PaginModel dataPaging)
		{
			string paging = "";
			string sorting = "";
		...
		public static int CountPlantBookingsLagerAL(int lagerId,string searchValue, Settings.SortingModel dataSorting, Settings.PaginModel dataPaging)
		{
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = @$"SELECT COUNT(*) FROM[PSZ_Eingangskontrolle_AL] 
									WHERE [LagerortID]={lagerId} 
		...
		public static Infrastructure.Data.Entities.Tables.Logistics.PrintedDataPlantBookingEntity GetPrintDataAL(int nummerVerpackung)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			using(var sqlCommand = new SqlCommand("select Top 10 Aktiv, [Verpackungsnr], Artikelnummer,LagerortID,Menge,Gesamtmenge,Inspektor,Datum,MHDDatum,Resultat, WE_LS_VOH, [Bestellung-Nr] as WE_VOH_Nr from [PSZ_Eingangskontrolle_AL] where [Verpackungsnr]=@Id", sqlConnection))
			{
				sqlConnection.Open();
			...
			if(dataTable.Rows.Count > 0)
			{
				return new Infrastructure.Data.Entities.Tables.Logistics.PrintedDataPlantBookingEntity(dataTable.Rows[0], Infrastructure.Data.Entities.Tables.Logistics.LagerAccessEnum.Albanien);
			}
			else
			{
		...
		public static Infrastructure.Data.Entities.Joins.Logistics.PSZ_Eingangskontrolle_TNEntity GetByVerpackungNrAl(int id)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			using(var sqlCommand = new SqlCommand("select * from [PSZ_Eingangskontrolle_AL]  where  [Verpackungsnr]=@Id", sqlConnection))
			...
			if(dataTable.Rows.Count > 0)
			{
				return new Infrastructure.Data.Entities.Joins.Logistics.PSZ_Eingangskontrolle_TNEntity(dataTable.Rows[0], Infrastructure.Data.Entities.Joins.Logistics.LagerAccessEnum.Albanien);
			}
			else
			{
		...
		public static Infrastructure.Data.Entities.Joins.Logistics.PSZ_Eingangskontrolle_TNEntity GetPlantBookingsSuivantPrecedentAl(int LagerId, int order, int PassedNmrVpckng)
		{
			var dataTable = new DataTable();
		...
		public static Infrastructure.Data.Entities.Joins.Logistics.PSZ_Eingangskontrolle_TNEntity GetPalntBookingsMinMaxAL(int LagerID, int order)
		{
			var dataTable = new DataTable();
		...
		// new insert Artikelnummer transaction
		public static int InsertWithTransactionUsingArtikelNummerAl(int LagerId, string? ArtikelNummer, DateTime? MHDDatum, string inspector, string remarks, SqlConnection connection, SqlTransaction transaction)
		{
			string query = @"DECLARE @NewId TABLE([Verpackungsnr] INT);
								INSERT INTO[PSZ_Eingangskontrolle_AL]
								(
								Aktiv,
								[Datum], 
								[LagerortID], 
		...
		//end
		public static int InsertWithBestellteArtikelAl(int LagerId, int? nrBestellteArtikel)
		{
		...
		public static int InsertWithTransactionBestellteArtikelAl(int LagerId, int? nrBestellteArtikel, string inspector, string remarks, SqlConnection connection, SqlTransaction transaction)
		{
			string query = @"DECLARE @NewId TABLE ([Verpackungsnr] INT);
								INSERT INTO [PSZ_Eingangskontrolle_AL]   
								(
		...
		public static int InsertWithTransactionTransferBestellteArtikelAl(int? AnzahlNach ,int LagerId, int? nrBestellteArtikel, int? LagerbewegungenId, SqlConnection connection, SqlTransaction transaction)
		{
			string query = @"DECLARE @NewId TABLE ([Verpackungsnr] INT);
								INSERT INTO [PSZ_Eingangskontrolle_AL]   
								(
		...
		public static int DeleteWithArtikelAl(int Id, int LagerId)
		{
			int results = -1;
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = " delete from [PSZ_Eingangskontrolle_AL] where [Verpackungsnr]=@Id AND [LagerortID] = @LagerId ";
				var sqlCommand = new SqlCommand(query, sqlConnection);
				sqlCommand.Parameters.AddWithValue("Id", Id);
				sqlCommand.Parameters.AddWithValue("LagerId", LagerId);
		...
		public static Infrastructure.Data.Entities.Joins.Logistics.PSZ_Eingangskontrolle_TNEntity GetPlantBookingsPrecedentByLagerIDAL(int LagerId, int PassedNmrVpckng)
		{
			var dataTable = new DataTable();
		...
		public static Infrastructure.Data.Entities.Joins.Logistics.PSZ_Eingangskontrolle_TNEntity GetPlantBookingsSuivantByLagerIDAL(int LagerId, int PassedNmrVpckng)
		{
			var dataTable = new DataTable();
		...
		public static Infrastructure.Data.Entities.Tables.CTS.PSZ_Eingangskontrolle_TNEntity GetBynummer_verpackungAl(int nummer_verpackung)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			using(var sqlCommand = new SqlCommand("SELECT * FROM [PSZ_Eingangskontrolle_AL] WHERE [Verpackungsnr]=@Id ", sqlConnection))
