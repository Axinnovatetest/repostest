...
{
	public class Fertigungs_Planung_Sicht_Gewerk_2_BETNAccess
	{
		#region Default Methods
		public static Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity Get(DateTime ack_date)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [Fertigungs Planung Sicht Gewerk 2 BETN] WHERE [Ack Date]=@Id";
			...
			{
				return new Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [Fertigungs Planung Sicht Gewerk 2 BETN]";
				var sqlCommand = new SqlCommand(query, sqlConnection);
			...
			if(dataTable.Rows.Count > 0)
			{
				return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity(x)).ToList();
			}
			else
			{
				return new List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity>();
			}
		}
		public static List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity> Get(List<DateTime> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity> results = null;
				...
				else
				{
					...
					results = new List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity>();
		...
		private static List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity> get(List<DateTime> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
				{
					...
					sqlCommand.CommandText = $"SELECT * FROM [Fertigungs Planung Sicht Gewerk 2 BETN] WHERE [Ack Date] IN ({queryIds})";
					new SqlDataAdapter(sqlCommand).Fill(dataTable);
				}
		...
		public static DateTime Insert(Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity item)
		{
		...
		public static int Insert(List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity> items)
		{
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
				{
					...
					{
						i++;
						query += " INSERT INTO [Fertigungs Planung Sicht Gewerk 2 BETN] ([Ack Date],[Anzahl],[Artikelnummer],[FA_begonnen],[Fertigungsnummer],[Freigabestatus],[Gewerk 1],[Gewerk 2],[Gewerk 3],[Halle],[ID],[Kabel_geschnitten],[Kennzeichen],[Klassifizierung],[KW Aktuel],[KW_Produktion],[Lagerort_id],[Order Time],[PSZ Artikelnummer]) VALUES ( "
		...
		public static int Update(List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 19; // Nb params per query
		...
		private static int update(List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_BETNEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
				{
					...
					{
						i++;
						query += " UPDATE [Fertigungs Planung Sicht Gewerk 2 BETN] SET "
		...
		public static int Delete(DateTime ack_date)
		{
			...
			{
				sqlConnection.Open();
				string query = "DELETE FROM [Fertigungs Planung Sicht Gewerk 2 BETN] WHERE [Ack Date]=@Ack_Date";
				var sqlCommand = new SqlCommand(query, sqlConnection);
		...
		private static int delete(List<DateTime> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				...
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
				{
					...
					string query = "DELETE FROM [Fertigungs Planung Sicht Gewerk 2 BETN] WHERE [Ack Date] IN (" + queryIds + ")";
					sqlCommand.CommandText = query;
		...
		public static List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_TNEntity> Analysegerwerk2BETN(string ack_date)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [Fertigungs Planung Sicht Gewerk 2 BETN] WHERE [Ack Date]<=@ack_date";
				var sqlCommand = new SqlCommand(query, sqlConnection);
				sqlCommand.Parameters.AddWithValue("ack_date", ack_date);
		...
		public static List<Infrastructure.Data.Entities.Tables.CTS.Fertigungs_Planung_Sicht_Gewerk_2_TNEntity> Analysegerwerk2GZTN(string ack_date)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [Fertigungs Planung Sicht Gewerk 2 GZTN] WHERE [Ack Date]<=@ack_date";
				var sqlCommand = new SqlCommand(query, sqlConnection);
				sqlCommand.Parameters.AddWithValue("ack_date", ack_date);
