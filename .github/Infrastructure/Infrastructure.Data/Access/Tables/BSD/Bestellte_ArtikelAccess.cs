...
namespace Infrastructure.Data.Access.Tables.BSD
{
	public class Bestellte_ArtikelAccess
	{
		...
		public static List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> GetByArticleAndBestellung(int artikelNr, List<int> bestellungNrs)
		{
			...
			{
				sqlConnection.Open();
				string query = $"SELECT * FROM [Bestellte Artikel] WHERE [Artikel-Nr]=@artikelNr AND [Bestellung-Nr] IN ({string.Join(",", bestellungNrs)})";
				var sqlCommand = new SqlCommand(query, sqlConnection);
