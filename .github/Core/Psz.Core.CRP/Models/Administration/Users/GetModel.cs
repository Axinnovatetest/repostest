...
namespace Psz.Core.CRP.Models.Administration.Users
{
	public class GetModel
	{
		...
		public GetModel(Infrastructure.Data.Entities.Tables.COR.UserEntity userEntity,
			...
			List<Infrastructure.Data.Entities.Tables.CRP.AccessProfileEntity> accessProfileEntities)
		{
			if(userEntity == null)
				return;
			...
			if(accessProfileEntities != null && accessProfileEntities.Count > 0)
			{
				...
				var entities = MoreLinq.MoreEnumerable.DistinctBy(accessProfileEntities, x => x.Id);
				entities?.ForEach(x =>
				{
