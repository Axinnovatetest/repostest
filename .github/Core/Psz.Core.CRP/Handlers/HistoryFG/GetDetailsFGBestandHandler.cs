...
{
	public class GetDetailsFGBestandHandler: IHandle<UserModel, ResponseModel<HistoryFGDetailsResponseModel>>
	{
		private readonly HistoryDataFGDetailsRequestModel? _request;
		private readonly UserModel? _user;
		public GetDetailsFGBestandHandler(HistoryDataFGDetailsRequestModel request, Core.Identity.Models.UserModel user)
		{
			_request = request;
			_user = user;
		}
		...
		public ResponseModel<HistoryFGDetailsResponseModel> Handle()
		{
			try
			{
				...
				int totalCount = Infrastructure.Data.Access.Tables.CRP.HistoryFG.HistoryDetailsFGBestandAccess.CountHistoryFGDetailsData(dataSorting, dataPaging);
				...
				HistoryFGHeaderList = Infrastructure.Data.Access.Tables.CRP.HistoryFG.HistoryDetailsFGBestandAccess.GetHistoryFGDetailsData(searchValue, dataSorting, dataPaging);
				...
				//var result = HistoryFGHeaderList.Select(x => new HistoryDataFGDetailsResponseModel(x)).ToList();
