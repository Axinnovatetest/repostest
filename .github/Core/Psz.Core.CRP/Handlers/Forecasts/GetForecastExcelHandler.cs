	...
	public partial class CrpForecastsService
	{
		public ResponseModel<byte[]> GetForecastsExcel(UserModel user, CRPExcelRequestModel data)
		{
			try
			{
				...
				var entities = Infrastructure.Data.Access.Joins.CRP.CRPStatisticsAccess.GetCRPDataForExcel(kundennummer, data.TypeId, data.OnlyLastVersion, data.DateFrom, data.DateTo);
