...
namespace Psz.Core.BaseData.Handlers.ObjectLog
{
	...
	public class GetFullHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.ObjectLog.ObjectLogModel>>>
	{
		...
		public GetFullHandler(Identity.Models.UserModel user, int artikelNr)
		{
			this._user = user;
		...
		public ResponseModel<List<Models.ObjectLog.ObjectLogModel>> Handle()
		{
			try
			{
				...
				var logEntities = Infrastructure.Data.Access.Tables.PRS.ObjectLogAccess.GetByObjetAndId(Enums.ObjectLogEnums.Objects.Article.GetDescription(), this._data);
