...
namespace Psz.Core.BaseData.Handlers.Settings.Currency
{
	...
	public class GeCurrenciestHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<KeyValuePair<int, string>>>>
	{
		private Identity.Models.UserModel _user { get; set; }

		public GeCurrenciestHandler(Identity.Models.UserModel user)
		{
			this._user = user;
		}
