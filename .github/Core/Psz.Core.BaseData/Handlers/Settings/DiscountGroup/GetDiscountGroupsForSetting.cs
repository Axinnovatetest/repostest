...
{
	public class GetDiscountGroupsForSetting: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.DiscountGroup.DiscountGroupModel>>>
	{
		private Identity.Models.UserModel _user { get; set; }

		public GetDiscountGroupsForSetting(Identity.Models.UserModel user)
		{
			this._user = user;
		}
