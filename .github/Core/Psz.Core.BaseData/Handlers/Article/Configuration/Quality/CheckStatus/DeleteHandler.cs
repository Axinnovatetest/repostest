	...
	public class DeleteHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var status = Infrastructure.Data.Access.Tables.BSD.ArtikelCheckStatusAccess.Get(this._data);
				var articleEntities = Infrastructure.Data.Access.Tables.PRS.ArtikelAccess.GetByCheckStatus(status.Status);
				...
				// 
				var deletedId = Infrastructure.Data.Access.Tables.BSD.ArtikelCheckStatusAccess.Delete(this._data);
				if(deletedId > 0)
				{
