	...
	public class AddHandler: IHandle<UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var insertedId = Infrastructure.Data.Access.Tables.BSD.ArticleContactAVAccess.Insert(vdEntity);
				if(insertedId > 0)
				{
					Infrastructure.Data.Access.Tables.PRS.ObjectLogAccess.Insert(
						ObjectLogHelper.getLog(this._user, insertedId, "Name", "",
						vdEntity.Name,
						Enums.ObjectLogEnums.Objects.ArticleConfig_ArticleContactAV.GetDescription(),
		...
		public ResponseModel<int> Validate()
		{
			...
			var projectTypeEntities = Infrastructure.Data.Access.Tables.BSD.ArticleContactAVAccess.GetByUser(this._data.UserId);
