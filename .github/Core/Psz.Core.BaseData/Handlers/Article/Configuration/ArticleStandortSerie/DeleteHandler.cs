	...
	public class DeleteHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				// 
				var entity = Infrastructure.Data.Access.Tables.BSD.ArticleStandortSerieAccess.Get(this._data);
				var deletedId = Infrastructure.Data.Access.Tables.BSD.ArticleStandortSerieAccess.Delete(this._data);
				if(deletedId > 0)
				{
