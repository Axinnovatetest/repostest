	...
	public class DeleteHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				// 
				var entity = Infrastructure.Data.Access.Tables.CTS.AV_Abteilung_MitarbeiterAccess.Get(this._data);
				var deletedId = Infrastructure.Data.Access.Tables.CTS.AV_Abteilung_MitarbeiterAccess.Delete(this._data);
				if(deletedId > 0)
				{
					Infrastructure.Data.Access.Tables.PRS.ObjectLogAccess.Insert(
						ObjectLogHelper.getLog(this._user, entity.ID, "Name",
						entity.AV_Mitarbeiter, "",
		...
		public ResponseModel<int> Validate()
		{
			...
			if(entity == null)
			{
				return ResponseModel<int>.FailureResponse("Employee not found");
			}
