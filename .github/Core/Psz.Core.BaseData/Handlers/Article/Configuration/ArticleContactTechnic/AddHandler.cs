...
namespace Psz.Core.BaseData.Handlers.Article.Configuration.ArticleContactTechnic
{
	...
	public class AddHandler: IHandle<UserModel, ResponseModel<int>>
	{
		...
		private Models.Article.Configuration.ArticleContactTechnicModel _data { get; set; }
		public AddHandler(UserModel user, Models.Article.Configuration.ArticleContactTechnicModel projectType)
		{
			_user = user;
			_data = projectType;
		}
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var insertedId = Infrastructure.Data.Access.Tables.BSD.ArticleContactTechnicAccess.Insert(vdEntity);
				if(insertedId > 0)
				{
		...
		public ResponseModel<int> Validate()
		{
			...
			var projectTypeEntities = Infrastructure.Data.Access.Tables.BSD.ArticleContactTechnicAccess.GetByUser(this._data.UserId);
