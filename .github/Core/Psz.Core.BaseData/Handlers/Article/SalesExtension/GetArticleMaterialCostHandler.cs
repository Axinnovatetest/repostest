...
namespace Psz.Core.BaseData.Handlers.Article.SalesExtension
{
	...
	public class GetArticleMaterialCostHandler: IHandle<UserModel, ResponseModel<decimal>>
	{
		...
		public GetArticleMaterialCostHandler(UserModel user, int articleNr)
		{
			this._user = user;
		...
		public ResponseModel<decimal> Handle()
		{
			try
			{
				...
				return ResponseModel<decimal>.SuccessResponse(Infrastructure.Data.Access.Tables.PRS.ArtikelAccess.GetMaterialCost(articleEntity.ArtikelNummer));
