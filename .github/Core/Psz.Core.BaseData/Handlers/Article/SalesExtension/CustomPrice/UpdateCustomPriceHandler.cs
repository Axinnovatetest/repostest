...
namespace Psz.Core.BaseData.Handlers.Article.SalesExtension.CustomPrice
{
	...
	public class UpdateCustomPriceHandler: IHandle<UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				lock((Locks.ArticleEditLock.GetOrAdd(this._data.ArticleId, new object())))
				{
					...
					responseBody = Infrastructure.Data.Access.Tables.PRS.Staffelpreis_KonditionzuordnungAccess_2.Update(this._data.ToStaffelEntity_2(oldKonditionzuordnungEntity, this._user, Enums.ObjectLogEnums.Objects.Article, this._data.ArticleId, staffelLogs, Enums.ObjectLogEnums.LogType.Add));
					...
					// -
					AddCustomPriceHandler.SetLastCustomPriceQuantityToInf(this._data.ArticleId);
					...
					Infrastructure.Data.Access.Tables.PRS.ObjectLogAccess.Insert(presigruppenLogs);
		...
		public ResponseModel<int> Validate()
		{
			...
			if(this._data.ProductionCost is null || this._data.ProductionCost < 0)
			{
				return ResponseModel<int>.FailureResponse("Production Cost: invalid value!");
			}
		...
		//private void HandleStaffelPreisExtension(Infrastructure.Data.Entities.Tables.PRS.StaffelpreisKonditionzuordnungEntity customerPrice)
		//{
		...
		//    {
		//        // Update
		//        var _customerPriceExt = this._data.ToEntity();
		//        _customerPriceExt.Id = customerPriceExt.Id;
		//        Infrastructure.Data.Access.Tables.BSD.StaffelpreisExtensionAccess.Update(_customerPriceExt);
		//    }
		//    else
		//    {
		...
		//internal void HandlePreisgruppen()
		//{

		//    var preisgruppenEntity = Infrastructure.Data.Access.Tables.PRS.PreisgruppenAccess.GetByArtikelNrAndType(this._data.ArticleId, (int)this._data.PricingGroup);
		...
		//            case Enums.ArticleEnums.CustomPriceType.S1:
		//            default:
		//                preisgruppenEntity.Staffelpreis1 = this._data.StandardPrice;
		//                preisgruppenEntity.ME1 = this._data.Quantity;
		//                break;
		//            case Enums.ArticleEnums.CustomPriceType.S2:
		//                preisgruppenEntity.Staffelpreis2 = this._data.StandardPrice;
		//                preisgruppenEntity.ME2 = this._data.Quantity;
		//                break;
		//            case Enums.ArticleEnums.CustomPriceType.S3:
		//                preisgruppenEntity.Staffelpreis3 = this._data.StandardPrice;
		//                preisgruppenEntity.ME3 = this._data.Quantity;
		//                break;
		//            case Enums.ArticleEnums.CustomPriceType.S4:
		//                preisgruppenEntity.Staffelpreis4 = this._data.StandardPrice;
		//                preisgruppenEntity.ME4 = this._data.Quantity;
		//                break;
		//        }
