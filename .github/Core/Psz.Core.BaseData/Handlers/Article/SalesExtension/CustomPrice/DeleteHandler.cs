	...
	public class DeleteHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var response = ResponseModel<int>.SuccessResponse(Infrastructure.Data.Access.Tables.PRS.Staffelpreis_KonditionzuordnungAccess_2.Delete(this._data));
				// -
				var newPrice = 0m;
				var priceType = 0;
				...
				// -
				AddCustomPriceHandler.SetLastCustomPriceQuantityToInf((int)customPrice.Artikel_Nr);
