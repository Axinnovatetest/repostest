...
namespace Psz.Core.BaseData.Handlers.Article.ArticlesPricesHistory
{
	...
	public class GetArtikelsPricesChangesHistoryHandler: IHandle<UserModel, ResponseModel<IPaginatedResponseModel<ArtikelsPricesChangesHistoryModel>>>
	{
		private UserModel _user { get; set; }
		private ArtikelsPricesChangesHistoryRequestModel _data { get; set; }
		public GetArtikelsPricesChangesHistoryHandler(UserModel user, ArtikelsPricesChangesHistoryRequestModel after)
		{
			this._user = user;
			this._data = after;
		...
		public ResponseModel<IPaginatedResponseModel<ArtikelsPricesChangesHistoryModel>> Handle()
		{
			try
			{
				...
				var fetchedData = Infrastructure.Data.Access.Tables.BSD.ArticlesPricesHistory.ArtikelsPricesChangesHistoryAccess.GetByDate(this._data.afterDate, dataPaging);
