...
namespace Psz.Core.BaseData.Handlers.Article
{
	...
	public partial class SearchDesignationPlusHandler: IHandle<string, ResponseModel<List<Models.Article.SearchNummerResponseModel>>>
	{
		private Models.Article.SearchNummerRequestModel _data { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public SearchDesignationPlusHandler(Identity.Models.UserModel user, Models.Article.SearchNummerRequestModel data)
		{
			this._data = data;
			this._user = user;
		}
		...
		public ResponseModel<List<Models.Article.SearchNummerResponseModel>> Handle()
		{
			try
			{
				...
				// -
				var responseBody = new List<Models.Article.SearchNummerResponseModel> { };
				var articleEntities = Infrastructure.Data.Access.Tables.PRS.ArtikelAccess.GetLikeDesignation(this._data.Terms?.Trim(), this._data.MaxItemsCount);
