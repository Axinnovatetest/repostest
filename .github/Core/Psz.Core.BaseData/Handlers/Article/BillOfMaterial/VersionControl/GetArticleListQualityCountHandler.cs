...
{
	public class GetArticleListQualityCountHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private UserModel _user { get; set; }
		public GetArticleListQualityCountHandler(UserModel user)
		{
			this._user = user;
		}
		public ResponseModel<int> Handle()
		{
			...
			//return ResponseModel<int>.SuccessResponse(Infrastructure.Data.Access.Tables.BSD.StucklistenArticle_VersionValidationAccess.GetForQualityCount());
		}
