...
namespace Psz.Core.BaseData.Handlers.Article.BillOfMaterial
{
	...
	using System.Linq;
	public class SearchArticleHandler: IHandle<Models.Article.ArticleSearchModel, ResponseModel<Models.Article.ArticleSearchResponseModel>>
	{
		private Models.Article.ArticleSearchModel _data { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public SearchArticleHandler(Identity.Models.UserModel user, Models.Article.ArticleSearchModel data)
		{
			this._data = data;
			this._user = user;
		}
			...
			try
			{
				...
				if(!string.IsNullOrWhiteSpace(this._data.SortFieldKey))
				{
					...
					dataSorting = new Infrastructure.Data.Access.Settings.SortingModel()
					{
						...
						SortDesc = false //this._data.SortDesc,
					};
				}
