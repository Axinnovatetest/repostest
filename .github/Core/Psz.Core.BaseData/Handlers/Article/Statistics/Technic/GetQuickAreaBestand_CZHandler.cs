...
namespace Psz.Core.BaseData.Handlers.Article.Statistics.Technic
{
	...
	public class GetQuickAreaBestand_CZHandler: IHandle<UserModel, ResponseModel<List<Models.Article.Statistics.Technic.QuickAreaBestandResponseModel>>>
	{
		private UserModel _user { get; set; }
		public GetQuickAreaBestand_CZHandler(UserModel user)
		{
			this._user = user;
		}
		public ResponseModel<List<Models.Article.Statistics.Technic.QuickAreaBestandResponseModel>> Handle()
		{
			try
			{
				...
				var statisticsEntities = Infrastructure.Data.Access.Joins.ArticleStatisticsAccess.Technic.GetQuickAreaBestand_CZ();
