...
namespace Psz.Core.BaseData.Handlers.Article
{
	public partial class ArticleService: IArticleService
	{
		public ResponseModel<int> ResetNextManufacturerArticle(Identity.Models.UserModel user, int data)
		{
			...
			try
			{
				var validationResponse = this.ResetNextManufacturerArticle_Validate(user, data);
				...
				Infrastructure.Data.Access.Tables.PRS.ObjectLogAccess.InsertWithTransaction(
					...
					{
						ObjectLogHelper.getLog(user, data, "Reset Next Manufacturer Article", articleEntity.ManufacturerPreviousArticle, "", Enums.ObjectLogEnums.Objects.Article.GetDescription(), Enums.ObjectLogEnums.LogType.Edit)
					},
					botransaction.connection, botransaction.transaction);
				var response = Infrastructure.Data.Access.Tables.PRS.ArtikelAccess.ResetNextManufacturerAticle(data, botransaction.connection, botransaction.transaction);
		...
		public ResponseModel<int> ResetNextManufacturerArticle_Validate(Identity.Models.UserModel user, int data)
		{
