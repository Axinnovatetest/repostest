...
namespace Psz.Core.BaseData.Handlers.Article.Overview
{
	...
	public class GetIndexSiblingsHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.Article.ArticleMinimalModel>>>
	{
		...
		public GetIndexSiblingsHandler(Identity.Models.UserModel user, int data)
		{
			this._user = user;
			this._data = data;
		}
		...
		public ResponseModel<List<Models.Article.ArticleMinimalModel>> Handle()
		{
			try
			{
				...
				// -
				var articleEntities = Infrastructure.Data.Access.Tables.PRS.ArtikelAccess.GetIndexSiblings(this._data)
