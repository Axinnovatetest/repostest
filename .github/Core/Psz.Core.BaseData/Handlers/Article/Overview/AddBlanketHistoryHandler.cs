...
{
	public class AddBlanketHistoryHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private Models.Article.ArticleOverviewModel.BlanketHistoryResponseModel _data { get; set; }
		public AddBlanketHistoryHandler(Identity.Models.UserModel user, Models.Article.ArticleOverviewModel.BlanketHistoryResponseModel data)
		{
			this._user = user;
			this._data = data;
		}
