...
namespace Psz.Core.BaseData.Handlers.Customer
{
	...
	public class SearchCustomerV2Handler: IHandle<Models.Customer.SearchCustomerModel, ResponseModel<Models.Customer.SearchCustomerResponseModel>>
	{
		private Models.Customer.SearchCustomerModel _data { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public SearchCustomerV2Handler(Models.Customer.SearchCustomerModel data,
		...
		public ResponseModel<Models.Customer.SearchCustomerResponseModel> Handle()
		{
			try
			{
				...
				var kundenEntities = (!this._data.ArchivedOnly) ? Infrastructure.Data.Access.Tables.PRS.KundenAccess.SearchByNumberNameV2(
