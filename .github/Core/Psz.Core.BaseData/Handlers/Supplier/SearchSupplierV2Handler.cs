...
namespace Psz.Core.BaseData.Handlers.Supplier
{
	...
	public class SearchSupplierV2Handler: IHandle<Models.Supplier.SearchSupplierModel, ResponseModel<Models.Supplier.SearchSupplierResponseModel>>
	{
		private Models.Supplier.SearchSupplierModel _data { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public SearchSupplierV2Handler(Models.Supplier.SearchSupplierModel data,
		...
		public ResponseModel<Models.Supplier.SearchSupplierResponseModel> Handle()
		{
			try
			{
				...
				var lieferantenEntities = (!this._data.ArchivedOnly) ? Infrastructure.Data.Access.Tables.BSD.LieferantenAccess.SearchByNumberNameV2(
