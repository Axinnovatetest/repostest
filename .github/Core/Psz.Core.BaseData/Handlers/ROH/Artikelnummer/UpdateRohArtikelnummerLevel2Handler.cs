...
namespace Psz.Core.BaseData.Handlers.ROH
{
	...
	{
		public ResponseModel<int> UpdateRohArtikelnummerLevel2(RohArtikelnummerLevel2Model data, UserModel user)
		{
			if(user == null)
			...
			var response = Infrastructure.Data.Access.Tables.BSD.Roh_Artikelnummer_Level2Access.Update(entity);
