	...
	public class AddHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				Infrastructure.Data.Access.Tables.BSD.AccessProfileAccess.Insert(accessProfileEntity);
		...
		public ResponseModel<int> Validate()
		{
			...
			if(Infrastructure.Data.Access.Tables.BSD.AccessProfileAccess.GetByName(this._data.AccessProfileName) != null)
