...
{
	public class RemoveLagerHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private Models.Administration.AccessProfiles.AddLagerModel _data { get; set; }

		public RemoveLagerHandler(Identity.Models.UserModel user, Models.Administration.AccessProfiles.AddLagerModel data)
		{
			this._user = user;
			this._data = data;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				/// 
				return ResponseModel<int>.SuccessResponse(Infrastructure.Data.Access.Tables.BSD.BSD_AccessProfileLagerAccess.DeleteLagers(this._data.ProfileId, this._data.LagerIds));
			} catch(Exception e)
			{
