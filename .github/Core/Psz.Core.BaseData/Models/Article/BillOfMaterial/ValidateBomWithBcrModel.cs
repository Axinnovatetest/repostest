...
{
	public class ValidateBomResponseWithBcrModel
	{
		...
		public ValidateBomResponseWithBcrModel(Infrastructure.Data.Entities.Tables.PRS.FertigungEntity fertigungEntity, string articleNumber)
		{
	...
	public class ValidateBomWBcrPartialDocRequestModel
	{
