...
{
	public class SupplierAdressModel
	{
		...
		public SupplierAdressModel()
		{

		}

		public SupplierAdressModel(Infrastructure.Data.Entities.Tables.PRS.AdressenEntity adressEntity)
		{
			...
			if(address != null)
			{
				...
				AdressPersonalNumber = address.PersonalNumber;
				AdressSupplierNumber = address.SupplierNumber;
			}
		}
		...
		public Infrastructure.Data.Entities.Tables.PRS.AdressenEntity ToEntity()
		{
			...
			{
				Lieferantennummer = AdressSupplierNumber,
				...
				Personalnummer = AdressPersonalNumber,
				Sperren = AdressLock,
			};
		}
	}
