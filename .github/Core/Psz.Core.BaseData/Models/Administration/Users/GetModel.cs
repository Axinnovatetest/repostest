using Psz.Core.BaseData.Models.Administration.AccessProfiles;
using System;
using System.Collections.Generic;
using System.Linq;

namespace Psz.Core.BaseData.Models.Administration.Users
{
	public class GetModel
	{
		...
		public GetModel(Infrastructure.Data.Entities.Tables.COR.UserEntity userEntity,
			...
			List<Infrastructure.Data.Entities.Tables.BSD.AccessProfileEntity> accessProfileEntities)
		{
			if(userEntity == null)
				return;
			...
			//- 
			accessProfileEntities = accessProfileEntities.DistinctBy(x => x.AccessProfileName).ToList();
