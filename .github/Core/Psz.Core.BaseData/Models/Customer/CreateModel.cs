...
namespace Psz.Core.BaseData.Models.Customer
{
	...
	public class CreateModel
	{
		...
		public Infrastructure.Data.Entities.Tables.PRS.AdressenEntity ToAddressenEntity()
		{
			var nextCustomerNummer = Infrastructure.Data.Access.Tables.PRS.KundenAccess.GetMaxNummber();
			return new Infrastructure.Data.Entities.Tables.PRS.AdressenEntity()
			{
				Nr = -1,
				Kundennummer = nextCustomerNummer,
				Adresstyp = this.AddressType, // Customer
		...
		public Infrastructure.Data.Entities.Tables.PRS.KundenEntity ToKundenEntity(int insertedAddressId)
		{
