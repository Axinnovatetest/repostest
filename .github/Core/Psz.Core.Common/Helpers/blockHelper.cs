namespace Psz.Core.Common.Helpers
{
	public class blockHelper
	{
		...
		public static int Block_UnblockCreation(BlockObject _object, bool state, Infrastructure.Services.Utils.TransactionsManager botransaction)
		{
			var blockEntity = Infrastructure.Data.Access.Tables.CTS.PSZ_Buchungen_laufen_StatusAccess.Get()?[0];
			if(blockEntity != null)
			{
			...
			return Infrastructure.Data.Access.Tables.CTS.PSZ_Buchungen_laufen_StatusAccess.UpdateWithTransaction(blockEntity, botransaction.connection, botransaction.transaction);
		}
