...
{
	public class GetFA_NPEX_reprotHandler: IHandle<Identity.Models.UserModel, ResponseModel<byte[]>>
	{
		...
		public ResponseModel<byte[]> Handle()
		{
			try
			{
				...
				response = Module.CS_ReportingService.GenerateFA_NPEXReport(Enums.ReportingEnums.ReportType.CTS_FANPEX, ReportData);
