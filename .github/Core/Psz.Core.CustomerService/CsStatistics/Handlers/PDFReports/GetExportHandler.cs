...
{
	public class GetExportHandler: IHandle<Identity.Models.UserModel, ResponseModel<byte[]>>
	{
		...
		public ResponseModel<byte[]> Handle()
		{
			try
			{
				...
				responseBody = Module.CS_ReportingService.GenerateExportReport(Enums.ReportingEnums.ReportType.CTS_EXPORT, reportData);
