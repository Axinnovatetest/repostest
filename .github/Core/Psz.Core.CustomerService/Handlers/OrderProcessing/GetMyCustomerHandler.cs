	...
	public class GetMyCustomersHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<CustomerModel>>>
	{
		...
		public ResponseModel<List<CustomerModel>> Handle()
		{
			...
			try
			{
				...
				{
					return ResponseModel<List<CustomerModel>>.SuccessResponse(Get(Infrastructure.Data.Access.Tables.PRS.KundenAccess.Get(), _data));
				}
				...
				return ResponseModel<List<CustomerModel>>.SuccessResponse(Get(Infrastructure.Data.Access.Tables.PRS.KundenAccess.GetByNummers(customersNumbers), _data));
