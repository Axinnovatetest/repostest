...
namespace Psz.Core.CustomerService.Models.Gutshrift
{
	public class CreateModel
	{
		...
		// Reporting 
		public Psz.Core.CustomerService.Reporting.Models.GutshriftReportingModel ToInvoiceFields()
		{
			return new Psz.Core.CustomerService.Reporting.Models.GutshriftReportingModel
			{
				Id = Id,
