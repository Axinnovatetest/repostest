...
{
	public class GetDashboardHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<KeyValuePair<int, string>>>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private List<int> _data { get; set; }

		public GetDashboardHandler(Identity.Models.UserModel user, List<int> ids)
		{
			this._user = user;
			this._data = ids;
		}
