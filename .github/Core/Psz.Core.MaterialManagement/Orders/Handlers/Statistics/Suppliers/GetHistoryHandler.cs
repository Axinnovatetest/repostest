...
namespace Psz.Core.MaterialManagement.Orders.Handlers.Statistics.Suppliers
{
	...
	using System.Linq;
	public class GetHistoryHandler: IHandle<Identity.Models.UserModel, ResponseModel<Models.Statistics.SupplierHistoryOrderResponseModel>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private Models.Statistics.SupplierHistoryOrderRequestModel _data { get; set; }
		public GetHistoryHandler(Identity.Models.UserModel user, Models.Statistics.SupplierHistoryOrderRequestModel data)
		{
			this._user = user;
			this._data = data;
		}
		...
		public ResponseModel<Models.Statistics.SupplierHistoryOrderResponseModel> Handle()
		{
			try
			{
				...
				var results = Infrastructure.Data.Access.Joins.ArticleStatisticsAccess.Sales.GetSupplierHistoryByYear(this._data.AddressNr.HasValue && this._data.AddressNr.Value > 0 ? this._data.AddressNr.Value : null, this._data.Year, this._data.LagerId, sortFieldName, this._data.SortDesc, this._data.RequestedPage, this._data.PageSize);
				var allCount = Infrastructure.Data.Access.Joins.ArticleStatisticsAccess.Sales.GetSupplierHistoryByYear_Count(this._data.AddressNr.HasValue && this._data.AddressNr.Value > 0 ? this._data.AddressNr.Value : null, this._data.Year, this._data.LagerId);
		...
		public byte[] GetExcelData()
		{
			try
			{
				...
				var data = Infrastructure.Data.Access.Joins.ArticleStatisticsAccess.Sales.GetSupplierHistoryByYear(this._data.AddressNr.HasValue && this._data.AddressNr.Value > 0 ? this._data.AddressNr.Value : null, this._data.Year, this._data.LagerId, sortFieldName, this._data.SortDesc, 0, allCount);
