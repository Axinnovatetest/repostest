	...
	public class GetPurchaseBlanketReportHandler: IHandleAsync<GetPurchaseBlanketReportRequestModel, ResponseModel<byte[]>>
	{
		...
		public async Task<ResponseModel<byte[]>> HandleAsync()
		{
			try
			{
				...
				var rahmenModel = new Infrastructure.Services.Reporting.Models.Itext.RahmenModel
				{
					...
					new RahmenModel.RahmenPositionsModel
					{
				...
				//Footer
				var footerData = new Infrastructure.Services.Reporting.Models.Itext.DocFooterModel(reporting);
				//{
				...
				//	footerSWIFTValue4 = "",
				//};
				var response = await Infrastructure.Services.Reporting.IText.CTS.GetRahmen(rahmenModel, footerData);
