namespace Psz.Core.MaterialManagement.Orders.Models.Orders
{
	public class GetRequestModel: IPaginatedRequestModel
	{
		...
		public bool CanCreateWereingang { get; set; }
	...
	public class GetResponseModel
	{
		...
		public bool CanCreateWereingang { get; set; }
		public bool ProjectPurchase { get; set; } = false;
		public GetResponseModel()
		{

		}
		public GetResponseModel(Infrastructure.Data.Entities.Joins.MTM.Order.BestellungenEntity bestellungenEntity)
		{
			...
			if(bestellungenEntity.Bearbeiter.HasValue)
				editorName = Infrastructure.Data.Access.Tables.COR.UserAccess.GetByNummer(bestellungenEntity.Bearbeiter.Value)?.Name;
			...
			HavePlacements = countPlacements > 0;
			TotalCount = bestellungenEntity.TotalCount;
			CanCreateWereingang = bestellungenEntity.CanCreateWereingang;
