...
namespace Psz.Core.MaterialManagement.Handlers.Administration.AccessProfiles
{
	public class EditNameHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public EditNameHandler(Identity.Models.UserModel user, Models.Administration.AccessProfiles.AccessProfileAddRequestModel model)
		{
			this._user = user;
			this._data = model;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				Infrastructure.Data.Access.Tables.MTM.AccessProfileAccess.UpdateName(accessProfileEntity);
