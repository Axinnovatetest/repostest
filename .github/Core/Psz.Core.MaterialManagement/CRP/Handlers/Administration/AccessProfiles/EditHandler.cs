...
namespace Psz.Core.MaterialManagement.Handlers.Administration.AccessProfiles
{
	public class EditHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public EditHandler(Identity.Models.UserModel user, Models.Administration.AccessProfiles.AccessProfileAddRequestModel model)
		{
			this._user = user;
			this._data = model;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				Infrastructure.Data.Access.Tables.MTM.AccessProfileAccess.UpdateWoCreationData(accessProfileEntity);
		...
		public ResponseModel<int> Validate()
		{
			...
			if(Infrastructure.Data.Access.Tables.MTM.AccessProfileAccess.Get(this._data.Id) == null)
				return ResponseModel<int>.FailureResponse(key: "1", value: $"Access profile [{this._data.AccessProfileName.Trim()}] not found.");

			var accessProfileEntity = Infrastructure.Data.Access.Tables.MTM.AccessProfileAccess.GetByName(this._data.AccessProfileName);
