namespace Psz.Core.MaterialManagement.Models.Administration.Users
{
	public class GetResponseModel
	{
		...
		// PSZ_BearbeiterAccess
		public int Nummer { get; set; }
		public string LegacyUsername { get; set; }

		// END PSZ_BearbeiterAccess
		...
		public GetResponseModel(Infrastructure.Data.Entities.Tables.COR.UserEntity userEntity,
			...
			List<Infrastructure.Data.Entities.Tables.MTM.AccessProfileEntity> accessProfileEntities)
		{
			if(userEntity == null)
				return;
