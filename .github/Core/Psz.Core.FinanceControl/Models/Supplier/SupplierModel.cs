...
namespace Psz.Core.FinanceControl.Models.Supplier
{
	public class SupplierModel
	{
		...
		{ }
		public SupplierModel(Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity supplierEntity,
			Infrastructure.Data.Entities.Tables.FNC.AdressenEntity adressEntity,
			List<Infrastructure.Data.Entities.Tables.FNC.AnsprechpartnerEntity> contactPersonsEntities,
			Infrastructure.Data.Entities.Tables.FNC.RabatthauptGruppenEntity discountGroupEntity,
			Infrastructure.Data.Entities.Tables.FNC.KonditionsZuordnungsTabelleEntity assignementConditionsEntity,
			Infrastructure.Data.Entities.Tables.FNC.IndustryEntity industryEntity,
			Infrastructure.Data.Entities.Tables.STG.WahrungenEntity currencyEntity,
			Infrastructure.Data.Entities.Tables.FNC.BelegkreiseVorgabenEntity slipCicleEntity,
			Infrastructure.Data.Entities.Tables.FNC.PszLieferantengruppenEntity suppliersGroupEntity)
		{
			// > Main Ids
			...
			var adress = adressEntity != null
				? new Address.AddressModel(adressEntity)
				: null;
			if(adress != null)
			{
				...
				this.AdressPreName = adress.PreName;
