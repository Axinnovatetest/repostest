...
{
	public class CheckDeptBDGSupplementHandler: IHandle<Identity.Models.UserModel, ResponseModel<Models.Budget.checkDeptBdgModel>>
	{
		...
		public CheckDeptBDGSupplementHandler(Identity.Models.UserModel user, string land_name, int year, string Dept_name, float current)
		{
			this._user = user;
		...
		{
			var IDLand = Infrastructure.Data.Access.Tables.FNC.Assign_budget_landAccess.GetIDbyName(this._data, this._data2);
			//var IDLand = Infrastructure.Data.Access.Tables.FNC.Assign_budget_landAccess.Get(this._data, this._data2);
			var CHKDept = Infrastructure.Data.Access.Tables.FNC.Assign_budget_departementAccess.CheckBudgetDept(this._data, this._data2, IDLand.ID, this._data4);
