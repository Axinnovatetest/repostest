	...
	public class GetPaymentHistoryHandler: IHandle<Identity.Models.UserModel, ResponseModel<Models.Budget.Order.Leasing.PaymentHistoryModel>>
	{
		...
		public ResponseModel<Models.Budget.Order.Leasing.PaymentHistoryModel> Handle()
		{
			try
			{
				...
				var leasingValidationHistory = (Infrastructure.Data.Access.Tables.FNC.OrderValidationLeasingAccess.GetFirstByOrderId(new List<int> { this._data }) ?? new List<Infrastructure.Data.Entities.Tables.FNC.OrderValidationLeasingEntity>());
