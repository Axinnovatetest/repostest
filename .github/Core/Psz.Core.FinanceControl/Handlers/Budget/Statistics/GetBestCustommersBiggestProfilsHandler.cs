...
{
	public class GetBestCustommersBiggestProfilsHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<BiggestOfferResponseModel>>>
	{
		private Identity.Models.UserModel _user { get; set; }
		public GetBestCustommersBiggestProfilsHandler(Identity.Models.UserModel user)
		{
			this._user = user;
		...
		public ResponseModel<List<BiggestOfferResponseModel>> Handle()
		{
			try
			{
				...
				return ResponseModel<List<BiggestOfferResponseModel>>.SuccessResponse(filteredBestCustomer);
