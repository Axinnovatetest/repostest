...
{
	public class BiggestCustomersHighestPSZOfferHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<BiggestOfferResponseModel>>>
	{
		private Identity.Models.UserModel _user { get; set; }
		public BiggestCustomersHighestPSZOfferHandler(Identity.Models.UserModel user)
		{
			this._user = user;
		...
		public ResponseModel<List<BiggestOfferResponseModel>> Handle()
		{
			try
			{
				...
				var transformedHighestPSZOffer = highestPSZOffer.Select(x => new BiggestOfferResponseModel
				{
					ProjectId = x.Id,
				...
				return ResponseModel<List<BiggestOfferResponseModel>>.SuccessResponse(transformedHighestPSZOffer);
