...
{
	public class GetWorstCustommersSmallestProfilsHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<BiggestOfferResponseModel>>>
	{
		private Identity.Models.UserModel _user { get; set; }
		public GetWorstCustommersSmallestProfilsHandler(Identity.Models.UserModel user)
		{
			this._user = user;
		...
		public ResponseModel<List<BiggestOfferResponseModel>> Handle()
		{
			try
			{
				...
				var Customer = bestCustommer.Select(x => new BiggestOfferResponseModel
				{
					ProjectId = x.Id,
				...
				return ResponseModel<List<BiggestOfferResponseModel>>.SuccessResponse(filteredWorstCustomer);
