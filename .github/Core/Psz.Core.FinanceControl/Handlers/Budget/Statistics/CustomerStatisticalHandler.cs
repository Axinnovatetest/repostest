...
{
	public class CustomerStatisticalHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.Budget.Project.TypeResponseModel>>>
	{
		private Identity.Models.UserModel _user { get; set; }
		public CustomerStatisticalHandler(Identity.Models.UserModel user)
		{
			this._user = user;
