...
namespace Psz.Core.FinanceControl.Handlers.Budget
{
	...
	public class GetAllDataProjectbyDeptHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.Budget.AllDataProjectModel>>>
	{
		public Identity.Models.UserModel _user { get; set; }
		private int _data { get; set; }
		public GetAllDataProjectbyDeptHandler(Identity.Models.UserModel user, int value)
		{
			this._user = user;
			this._data = value;
		}
		public ResponseModel<List<Models.Budget.AllDataProjectModel>> Handle()
		{
			try
			{
				...
				//var alldataprojects_tableEntities = Infrastructure.Data.Access.Tables.FNC.BudgetProjectAccess.GetPrjbyIdDept(this._data);
