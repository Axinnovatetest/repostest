...
namespace Psz.Core.FinanceControl.Handlers.Budget.Project
{
	...
	public class GetAllArchivedByUserHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.Budget.Project.ProjectModel>>>
	{
		private Identity.Models.UserModel _user { get; set; }

		public GetAllArchivedByUserHandler(Identity.Models.UserModel user)
		{
			this._user = user;
		}
		...
		public ResponseModel<List<Models.Budget.Project.ProjectModel>> Handle()
		{
			try
			{
				...
				/// 
				var projectsEntities = Infrastructure.Data.Access.Tables.FNC.BudgetProjectAccess.GetbyCurrent(this._user.Id, isArchived: true);
				...
				var userIds = projectsEntities.Select(x => x.ResponsableId)?.ToList();
