...
namespace Psz.Core.FinanceControl.Handlers.Budget.Project
{
	...
	public class VisibilityUserAddHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private Models.Budget.Validator.ValidatorModel _data { get; set; }

		public VisibilityUserAddHandler(Identity.Models.UserModel user, Models.Budget.Validator.ValidatorModel model)
		{
			this._user = user;
			this._data = model;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				// visibilty user
				var addId = Infrastructure.Data.Access.Tables.FNC.FinanceProjectsVisibiltyUsersAccess.Insert(new Infrastructure.Data.Entities.Tables.FNC.FinanceProjectsVisibiltyUsersEntity
				{
					DateTimeAdd = DateTime.Now,
					UserAddId = _user.Id,
					ProjectId = this._data.Id_Project,
					UserId = this._data.Id_Validator
				});
		...
		public ResponseModel<int> Validate()
		{
			...
			{
				return ResponseModel<int>.FailureResponse("User cannot add visibility user");
			}
