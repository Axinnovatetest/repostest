...
namespace Psz.Core.FinanceControl.Handlers.Administration.AccessProfile
{
	...
	public class EditForUserHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public EditForUserHandler(Identity.Models.UserModel user, Models.Administration.AccessProfile.AddToUserModel data)
		{
			this._user = user;
			this._data = data;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				{
					Infrastructure.Data.Access.Tables.FNC.UserAccessProfilesAccess.DeleteForUsers(new List<int> { this._data.UserId });
					insertedUsers = Infrastructure.Data.Access.Tables.FNC.UserAccessProfilesAccess.Insert(
						this._data.ProfileIds.Select(x => new Infrastructure.Data.Entities.Tables.FNC.UserAccessProfilesEntity
						{
