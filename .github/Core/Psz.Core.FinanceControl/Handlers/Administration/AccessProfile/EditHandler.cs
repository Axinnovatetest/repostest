...
namespace Psz.Core.FinanceControl.Handlers.Administration.AccessProfile
{
	...
	public class EditHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public EditHandler(Identity.Models.UserModel user, Models.Administration.AccessProfile.AccessProfileModel model)
		{
			this._user = user;
			this._data = model;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				Infrastructure.Data.Access.Tables.FNC.AccessProfileAccess.Update(accessProfileEntity);
