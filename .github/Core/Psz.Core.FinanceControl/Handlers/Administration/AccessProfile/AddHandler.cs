...
namespace Psz.Core.FinanceControl.Handlers.Administration.AccessProfile
{
	...
	public class AddHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public AddHandler(Identity.Models.UserModel user, Models.Administration.AccessProfile.AccessProfileModel model)
		{
			this._user = user;
			this._data = model;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				Infrastructure.Data.Access.Tables.FNC.AccessProfileAccess.Insert(accessProfileEntity);
		...
		public ResponseModel<int> Validate()
		{
			...
			if(Infrastructure.Data.Access.Tables.FNC.AccessProfileAccess.GetByName(this._data.AccessProfileName) != null)
