...
public class GetRechnungstransferExcelHandler: IHandle<UserModel, ResponseModel<byte[]>>
{

	private UserModel _user { get; set; }
	private RechnungstransferHistoryRequestModel _data { get; set; }
	public GetRechnungstransferExcelHandler(UserModel user, RechnungstransferHistoryRequestModel data)
	{
		this._user = user;
		_data = data;
	}
	...
	public byte[] GetData()
	{
		...
		fetchedData = Infrastructure.Data.Access.Joins.FNC.Accounting.AccountingAccess.GetRechnungstransferHistory(this._data.DateFrom ?? DateTime.Today, this._data.DateTill ?? DateTime.Today);
