...
public class GetRMDCZHandler: IHandle<RMDCZRequestModel, ResponseModel<IPaginatedResponseModel<RMDCZModel>>>
{
	...
	public GetRMDCZHandler(UserModel user, RMDCZRequestModel data)
	{
		this._user = user;
		this._data = data;
	}
	...
	private ResponseModel<IPaginatedResponseModel<RMDCZModel>> Perform(UserModel user, RMDCZRequestModel data)
	{
		try
		{

			var fetchedData = Infrastructure.Data.Access.Joins.FNC.Accounting.AccountingAccess.GetRMDCZ(data.fromdate, data.todate, null, null, 0);
