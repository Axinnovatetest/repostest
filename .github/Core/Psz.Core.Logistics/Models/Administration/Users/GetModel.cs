using MoreLinq;
using Psz.Core.Logistics.Models.Administration.AccessProfiles;
using System;
using System.Collections.Generic;
using System.Linq;

namespace Psz.Core.Logistics.Models.Administration.Users
{
	public class GetModel
	{
		...
		public GetModel(Infrastructure.Data.Entities.Tables.COR.UserEntity userEntity,
			...
			List<Infrastructure.Data.Entities.Tables.Logistics.AccessProfileEntity> accessProfileEntities)
		{
			if(userEntity == null)
				return;
			...
			if(accessProfileEntities != null && accessProfileEntities.Count > 0)
			{
				...
				accessProfileEntities?.DistinctBy(x => x.Id)?.ForEach(x =>
				{
