...
namespace Psz.Core.Logistics.Models.Administration.AccessProfiles
{
	public class AccessProfileModel
	{
		...
		public AccessProfileModel(Infrastructure.Data.Entities.Tables.Logistics.AccessProfileEntity accessProfileEntity)
		{
			...
			Inventory = accessProfileEntity.Inventory;
			InventoryStart = accessProfileEntity.InventoryStart;
			InventoryStop = accessProfileEntity.InventoryStop;
			InventoryHqValidate = accessProfileEntity.InventoryHqValidate;
			InventoryWarehouseValidate= accessProfileEntity.InventoryWarehouseValidate;
			InventoryDownloadExcel = accessProfileEntity.InventoryDownloadExcel;
			InventoryDownloadPdf = accessProfileEntity.InventoryDownloadPdf;
			InventoryDownloadAudit = accessProfileEntity.InventoryDownloadAudit;
			InventoryDownloadRelease = accessProfileEntity.InventoryDownloadRelease;
			InventoryUpdateWip = accessProfileEntity.InventoryUpdateWip;
			InventoryUpdateTaskLogistics = accessProfileEntity.InventoryUpdateTaskLogistics;
			InventoryUpdateTaskIT = accessProfileEntity.InventoryUpdateTaskIT;
		}
		public Infrastructure.Data.Entities.Tables.Logistics.AccessProfileEntity ToEntity()
		{
			return new Infrastructure.Data.Entities.Tables.Logistics.AccessProfileEntity
			{
				...
				InventoryStop = InventoryStop,
				InventoryHqValidate = InventoryHqValidate,
				InventoryWarehouseValidate = InventoryWarehouseValidate,
				InventoryDownloadExcel = InventoryDownloadExcel,
				InventoryDownloadPdf = InventoryDownloadPdf,
				InventoryDownloadAudit = InventoryDownloadAudit,
				InventoryDownloadRelease = InventoryDownloadRelease,
				InventoryUpdateWip = InventoryUpdateWip,
				InventoryUpdateTaskLogistics = InventoryUpdateTaskLogistics,
				InventoryUpdateTaskIT = InventoryUpdateTaskIT
			};
		}
	}
}
