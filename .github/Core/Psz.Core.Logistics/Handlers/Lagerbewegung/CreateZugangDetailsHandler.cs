...
{
	public class CreateZugangDetailsHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<int>>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private List<Models.Lagebewegung.LagerbewegungDetailsModel> _data { get; set; }


		public CreateZugangDetailsHandler(Identity.Models.UserModel user, List<Models.Lagebewegung.LagerbewegungDetailsModel> listPosition)
		{
			this._user = user;
		...
		public ResponseModel<List<int>> Handle()
		{
			try
			{
				...
				{
					var insertedNr = Infrastructure.Data.Access.Tables.Logistics.LagebewegungAccess.AddZugangPositionWithTransaction(new Infrastructure.Data.Entities.Tables.Logistics.LagerbewegungDetailsEntity
					{
