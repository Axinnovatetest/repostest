...
namespace Psz.Core.Logistics.Handlers.Administration.AccessProfiles
{
	public class AddHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public AddHandler(Identity.Models.UserModel user, Models.Administration.AccessProfiles.AccessProfileModel model)
		{
			this._user = user;
			this._data = model;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				Infrastructure.Data.Access.Tables.Logistics.AccessProfileAccess.Insert(accessProfileEntity);
		...
		public ResponseModel<int> Validate()
		{
			...
			if(Infrastructure.Data.Access.Tables.CTS.AccessProfileAccess.GetByName(this._data.AccessProfileName) != null)
