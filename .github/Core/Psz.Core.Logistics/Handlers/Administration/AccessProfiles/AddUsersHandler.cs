	...
	public class AddUsersHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				/// 
				var profileEntity = Infrastructure.Data.Access.Tables.Logistics.AccessProfileAccess.Get(this._data.ProfileId);
				var profileUsers = Infrastructure.Data.Access.Tables.Logistics.AccessProfileUsersAccess.GetByAccessProfileIds(new List<int> { this._data.ProfileId });
				...
				if(newUsers != null && newUsers.Count > 0)
				{
					...
					{
						insertedUsers = Infrastructure.Data.Access.Tables.Logistics.AccessProfileUsersAccess.Insert(
							userEntities.Select(x => new Infrastructure.Data.Entities.Tables.Logistics.AccessProfileUsersEntity
							{
		...
		public ResponseModel<int> Validate()
		{
			...
			if(Infrastructure.Data.Access.Tables.Logistics.AccessProfileAccess.Get(this._data.ProfileId) == null)
