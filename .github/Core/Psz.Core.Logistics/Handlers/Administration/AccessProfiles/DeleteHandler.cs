	...
	public class DeleteHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				/// 
				Infrastructure.Data.Access.Tables.Logistics.AccessProfileAccess.Delete(this._data);
				//Infrastructure.Data.Access.Tables.Logistics.AccessProfileUsersAccess.DeleteByAccessProfileID(this._data);
		...
		public ResponseModel<int> Validate()
		{
			...
			if(Infrastructure.Data.Access.Tables.Logistics.AccessProfileAccess.Get(this._data) == null)
