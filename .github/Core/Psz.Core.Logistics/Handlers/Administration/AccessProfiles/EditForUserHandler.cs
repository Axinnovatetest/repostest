	...
	public class EditForUserHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				{
					Infrastructure.Data.Access.Tables.Logistics.AccessProfileUsersAccess.DeleteForUsers(new List<int> { this._data.UserId });
					insertedUsers = Infrastructure.Data.Access.Tables.Logistics.AccessProfileUsersAccess.Insert(
						this._data.ProfileIds.Select(x => new Infrastructure.Data.Entities.Tables.Logistics.AccessProfileUsersEntity
						{
				...
				{
					if(this._data.UserId != null && this._data.UserId > 0)
						Infrastructure.Data.Access.Tables.Logistics.AccessProfileUsersAccess.DeleteForUsers(new List<int> { this._data.UserId });
				}
