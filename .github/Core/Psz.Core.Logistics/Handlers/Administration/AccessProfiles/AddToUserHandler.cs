	...
	public class AddToUserHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var existingUserProfiles = Infrastructure.Data.Access.Tables.Logistics.AccessProfileUsersAccess.GetByUserId(new List<int> { this._data.UserId });
				...
				if(newUsers != null && newUsers.Count > 0)
				{
					insertedUsers = Infrastructure.Data.Access.Tables.Logistics.AccessProfileUsersAccess.Insert(
						newUsers.Select(x => new Infrastructure.Data.Entities.Tables.Logistics.AccessProfileUsersEntity
						{
