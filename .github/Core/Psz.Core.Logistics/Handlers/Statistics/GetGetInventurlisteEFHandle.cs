...
{
	public class GetGetInventurlisteEFHandle: IHandle<Identity.Models.UserModel, ResponseModel<InventurlisteEFModelSearch>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private RohmaterialSearch _data { get; set; }
		public GetGetInventurlisteEFHandle(RohmaterialSearch _data, Identity.Models.UserModel user)
		{
			this._user = user;
			this._data = _data;
		}
		public ResponseModel<InventurlisteEFModelSearch> Handle()
		{
			try
			{
				...
				return ResponseModel<InventurlisteEFModelSearch>.SuccessResponse(
			new InventurlisteEFModelSearch()
			{
				InventurlisteEFModel = response,
		...
		public ResponseModel<InventurlisteEFModelSearch> Validate()
		{
			if(this._user == null/*|| this._user.Access.____*/)
			{
				return ResponseModel<InventurlisteEFModelSearch>.AccessDeniedResponse();
			}
