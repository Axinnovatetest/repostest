...
{
	public class InventurlistePetraHandle: IHandle<Identity.Models.UserModel, ResponseModel<InventurlistePetraModelSearch>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private RohmaterialSearch _data { get; set; }
		public InventurlistePetraHandle(RohmaterialSearch _data, Identity.Models.UserModel user)
		{
			this._user = user;
			this._data = _data;
		}
		public ResponseModel<InventurlistePetraModelSearch> Handle()
		{
			try
			{
				...
				return ResponseModel<InventurlistePetraModelSearch>.SuccessResponse(
				new InventurlistePetraModelSearch()
				{
					InventurlistePetraModel = response,
		...
		public ResponseModel<InventurlistePetraModelSearch> Validate()
		{
			if(this._user == null/*|| this._user.Access.____*/)
			{
				return ResponseModel<InventurlistePetraModelSearch>.AccessDeniedResponse();
			}
