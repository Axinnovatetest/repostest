...
public class StammdatenkontrolleWareneingangeHandler: IHandle<StammdatenkontrolleWareneingangeRequestModel, ResponseModel<IPaginatedResponseModel<StammdatenkontrolleWareneingangeModel>>>
{
	...
	public StammdatenkontrolleWareneingangeHandler(Identity.Models.UserModel user, StammdatenkontrolleWareneingangeRequestModel data)
	{
		this._user = user;
		this._data = data;
	}
	...
	private ResponseModel<IPaginatedResponseModel<StammdatenkontrolleWareneingangeModel>> Perform(Identity.Models.UserModel user, StammdatenkontrolleWareneingangeRequestModel data)
	{
		try
		{
			...
			var fetchedData = Infrastructure.Data.Access.Joins.Logistics.CustomsAccess.CustomsAccess.GetStammdatenkontrolleWareneingange(data.fromdate, data.todate, data.gruppe, dataPaging, dataSorting, 0);
