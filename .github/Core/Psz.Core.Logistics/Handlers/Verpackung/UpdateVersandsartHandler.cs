...
{
	public class UpdateVersandsartHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private long _idArtikelAngebote { get; set; }
		public string versandsart { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public UpdateVersandsartHandler(long idArtikelAngebote, string versandsart, Identity.Models.UserModel user)
		{
			this._user = user;
			this._idArtikelAngebote = idArtikelAngebote;
			this.versandsart = versandsart;
		}
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var response = Infrastructure.Data.Access.Joins.Logistics.PackingAccess.UpdateVersandsart(this._idArtikelAngebote, this.versandsart);
				//logging
