...
{
	public class UpdateGedrucktVerpackung: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private long _idArtikelAngebote { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public UpdateGedrucktVerpackung(long idArtikelAngebote, Identity.Models.UserModel user)
		{
			this._user = user;
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var response = Infrastructure.Data.Access.Joins.Logistics.PackingAccess.UpdateGedrucktVerpoachung(this._idArtikelAngebote);
				//logging
