...
{
	public class UpdateZeitPunktVerpackung: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private long _idArtikelAngebote { get; set; }
		public DateTime? _zeitPunkt { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public UpdateZeitPunktVerpackung(long idArtikelAngebote, DateTime? zeitPunkt, Identity.Models.UserModel user)
		{
			this._user = user;
			this._idArtikelAngebote = idArtikelAngebote;
			this._zeitPunkt = zeitPunkt;
		}
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var response = Infrastructure.Data.Access.Joins.Logistics.PackingAccess.UpdateZeitPunktGedrucktVerpackung(this._idArtikelAngebote, this._zeitPunkt);
				//logging
