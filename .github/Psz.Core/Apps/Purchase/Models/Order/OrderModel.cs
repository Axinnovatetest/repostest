...
namespace Psz.Core.Apps.Purchase.Models.Order
{
	public class OrderModel
	{
		...
		public string UnloadingPoint { get; set; } // UnloadingPoint
		public string StorageLocation { get; set; } // StorageLocation
		...
		//
		public string RahmenCustomer { get; set; }
		public string RahmenSupplier { get; set; }
		public int? RahmenType { get; set; }
		// - 2023-01-18 - 
		public string UstIdCustomer { get; set; }
		//souilmi 23/08/2022
		public string RechnungType { get; set; }
		//souilmi 03/11/2022
		public int? Nr_DlfHeader { get; set; }
		public int? Nr_DlfItem { get; set; }
		//souilmi 09/03/2023
		public bool? RechnungSent { get; set; }
		public DateTime? RechnungSentDate { get; set; }
