...
{
	public class UpdateDeliveryImportLogoHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private Models.CustomerService.OrderReport.LogoImageModel _data { get; set; }
		public UpdateDeliveryImportLogoHandler(Identity.Models.UserModel user, Models.CustomerService.OrderReport.LogoImageModel data)
		{
			_user = user;
			_data = data;
		}
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var newImageId = Core.Helpers.ImageFileHelper.updateImage(deliveryReportEntity.ImportLogoImageId, this._data.LogoImage, this._data.LogoImageExtension);
				if(Infrastructure.Data.Access.Tables.PRS.OrderReportAccess.UpdateImportLogo(deliveryReportEntity.Id, newImageId, this._user.Id, DateTime.Now) > 0)
				{
