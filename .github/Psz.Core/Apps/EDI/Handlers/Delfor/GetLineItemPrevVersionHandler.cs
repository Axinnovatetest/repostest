...
namespace Psz.Core.Apps.EDI.Handlers.Delfor
{
	...
	public class GetLineItemPrevVesionHandler: IHandle<Identity.Models.UserModel, ResponseModel<Models.Delfor.XMLLineItemModel>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private int _data { get; set; }

		public GetLineItemPrevVesionHandler(Identity.Models.UserModel user, int lineItemId)
		{
			this._user = user;
		...
		public ResponseModel<Models.Delfor.XMLLineItemModel> Handle()
		{
			try
			{
				...
				/// 
				return ResponseModel<Models.Delfor.XMLLineItemModel>.SuccessResponse(new Models.Delfor.XMLLineItemModel(Infrastructure.Data.Access.Tables.CTS.LineItemAccess.GetPrevVersion(this._data)));
			} catch(Exception e)
			{
