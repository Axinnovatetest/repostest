namespace Psz.Core.Apps.EDI.Handlers.Delfor.Production
{
	...
	//public class DeleteOrderHandler : IHandle<Identity.Models.UserModel, ResponseModel<int>>
	//{
	//    private Identity.Models.UserModel _user { get; set; }
	//    private Models.Delfor.Production.CancelCommandModel _data { get; set; }

	//    public DeleteOrderHandler(Identity.Models.UserModel user, Models.Delfor.Production.CancelCommandModel data)
	//    {
	//        this._user = user;
	//        this._data = data;
	//    }
	...
	//            try
	//            {
	//                Infrastructure.Data.Access.Tables.CTS.LineItemPlanAccess.DeleteOrder(this._data.Id);
