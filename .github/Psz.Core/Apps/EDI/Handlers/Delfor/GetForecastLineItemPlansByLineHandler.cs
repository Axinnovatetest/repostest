...
namespace Psz.Core.Apps.EDI.Handlers.Delfor
{
	...
	using System.Linq;
	public class GetForecastLineItemPlansByLineHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.Delfor.XMLLineItemPlanModel>>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private int _data { get; set; }

		public GetForecastLineItemPlansByLineHandler(Identity.Models.UserModel user, int headerId)
		{
			this._user = user;
			this._data = headerId;
		}
		...
		public ResponseModel<List<Models.Delfor.XMLLineItemPlanModel>> Handle()
		{
			try
			{
				...
				/// 
				var lineItemPlansEntities = Infrastructure.Data.Access.Tables.CTS.LineItemPlanAccess.GetByLineItems(new List<long> { this._data });
		...
		public ResponseModel<List<Models.Delfor.XMLLineItemPlanModel>> Validate()
		{
			...
			{
				return ResponseModel<List<Models.Delfor.XMLLineItemPlanModel>>.FailureResponse("Forecast Line Item not found");
			}
