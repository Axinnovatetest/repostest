				...
				lock(Locks.OrdersLock)
				{
					try
					{
						...
						var stdEdiConcernArticles = Infrastructure.Data.Access.Tables.PRS.ArtikelAccess.GetDefaultEdi(
							...
							?? new List<Infrastructure.Data.Entities.Tables.PRS.MinimalArtikelEntity>();
						var customersConcernItems = Infrastructure.Data.Access.Tables.CTS.EDI_CustomerConcernItemsAccess.GetListByConcernId(customerConcern.Id, botransaction.connection, botransaction.transaction);
