...
namespace Psz.Core.Apps.WorkPlan.Models.WorkArea
{
	public class WorkAreaViewModel
	{
		...
		public WorkAreaViewModel(Infrastructure.Data.Entities.Tables.WPL.WorkAreaEntity workAreaDb)
		{
			...
			this.HallName = Helpers.User.getHallNameById(workAreaDb.HallId);
			...
			this.CountryName = Helpers.User.getCountryNameById(workAreaDb.CountryId);
			...
			this.DepartmentName = Helpers.User.getDepartmentNameById(workAreaDb.DepartmentId);
		}
	}
}
