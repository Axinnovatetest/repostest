...
namespace Psz.Core.Apps.WorkPlan.Models.WorkStationMachine
{
	public class WorkStationMachineViewModel
	{
		...
		public WorkStationMachineViewModel(Infrastructure.Data.Entities.Tables.WPL.WorkStationMachineEntity workStationMachineDb)
		{
			...
			this.HallName = workStationMachineDb.HallName;//Helpers.User.getHallNameById(workStationMachineDb.HallId);
			...
			this.CountryName = workStationMachineDb.CountryName;//Helpers.User.getCountryNameById(workStationMachineDb.CountryId);
			//this.CanSafeDelete = Psz.Core.Apps.WorkPlan.Helpers.DeleteCheck.CanSafeDeleteWorkStationMachine(this.Id);
			this.WorkAreaName = workStationMachineDb.WorkAreaName;//Helpers.User.GetWorkAreaNameById(workStationMachineDb.WorkAreaId);
		}
	}
}
