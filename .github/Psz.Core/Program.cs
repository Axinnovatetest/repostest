...
namespace Psz.Core
{
	public class Program
	{
		...
		public static void Initiate(
			string databaseConnectionStringKWS,
			string databaseConnectionStringKCZ,
			string databaseConnectionStringKGZ,
			string databaseConnectionStringKAL,
			string databaseConnectionStringBudget,
			string databaseConnectionStringMTM,
			string databaseConnectionString,
			string databaseConnectionStringEDIPlatform,
			string databaseConnectionStringNlog,
			...
			)
		{
			...
			Infrastructure.Data.Access.Settings.SetConnectionStringK(databaseConnectionStringKWS, databaseConnectionStringKCZ, databaseConnectionStringKGZ, databaseConnectionStringKAL);
			setDatabaseConnectionStringEDI(databaseConnectionStringEDIPlatform);
			setDatabaseConnectionStringNlog(databaseConnectionStringNlog);
		...
		private static void setDatabaseConnectionStringNlog(string connectionStringNlog)
		{
			Infrastructure.Data.Access.Settings.SetConnectionStringNlog(connectionStringNlog);
		}
