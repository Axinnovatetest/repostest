...
namespace Psz.Core.Common.Helpers
{
	public class LogHelper
	{
		...
		public Models.UserCommonModel User { get; set; }

		public LogHelper(int nr, int angebotNr, int projektNr, string logObject, LogType log_Type, string origin, Models.UserCommonModel user)
		{
			Nr = nr;
			AngebotNr = angebotNr;
			ProjektNr = projektNr;
