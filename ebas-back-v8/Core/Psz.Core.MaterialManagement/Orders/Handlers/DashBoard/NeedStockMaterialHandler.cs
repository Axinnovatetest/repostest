...
{
	public class NeedStockMaterialHandler: IHandle<NeededQuantityOrderedQuantityAnalysisRequestModel, ResponseModel<NeedStockPerTypeResponseModel>>
	{
		private NeededQuantityOrderedQuantityAnalysisRequestModel data { get; set; }
		private UserModel user { get; set; }

		public NeedStockMaterialHandler(UserModel user, NeededQuantityOrderedQuantityAnalysisRequestModel data)
		{
			this.data = data;
			this.user = user;
		}
		...
		private ResponseModel<NeedStockPerTypeResponseModel> Perform()
		{
