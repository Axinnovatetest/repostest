...
{
	public class GetProjectNrsHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<KeyValuePair<int, int>>>>
	{

		private string _data { get; set; }
		private Identity.Models.UserModel _user { get; set; }
		public GetProjectNrsHandler(Identity.Models.UserModel user, string data)
		{
			this._user = user;
			this._data = data;
		}
		...
		public ResponseModel<List<KeyValuePair<int, int>>> Handle()
		{
			try
			{
				...
				var nrs = Infrastructure.Data.Access.Tables.PRS.AngeboteAccess.GetSearchNrs(_data, "Projekt-Nr");
