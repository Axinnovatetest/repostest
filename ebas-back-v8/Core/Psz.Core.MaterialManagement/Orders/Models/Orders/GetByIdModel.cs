...
namespace Psz.Core.MaterialManagement.Orders.Models.Orders
{
	...
	public class GetByIdResponseModel
	{
		...
		public List<DropDownMenu> ListBearbeiter { get; set; }
		public List<DropDownMenu> ListKondition { get; set; }
		public List<DropDownMenu> ListBezug { get; set; }


		public bool DeliveryDaysMonday { get; set; }
		public bool DeliveryDaysTuesday { get; set; }
		public bool DeliveryDaysWednesday { get; set; }
		public bool DeliveryDaysThursday { get; set; }
		public bool DeliveryDaysFriday { get; set; }
		public bool ProjectPurchase { get; set; }


		public GetByIdResponseModel()
		{

		}

		public GetByIdResponseModel(Infrastructure.Data.Entities.Joins.MTM.Order.BestellungenEntity bestellungenEntity,
		List<Infrastructure.Data.Entities.Tables.COR.UserEntity> bearbeiterEntities,
		List<Infrastructure.Data.Entities.Tables.MTM.KonditionszuordnungstabelleEntity> konditionszuordnungstabelleEntities,
		List<Infrastructure.Data.Entities.Tables.MTM.BetreffEntity> betreffEntities,
		int orderPlacements,
		...
		)
		{
			...
			Strasse_Postfach = bestellungenEntity.Strasse_Postfach;
			Typ = bestellungenEntity.Rahmenbestellung == true ? "Rahmenbestellung" : bestellungenEntity.Typ;
			...
			HavePlacements = orderPlacements > 0;
			BearbeiterName = bearbeiterEntities.FirstOrDefault(b => b.Nummer == Bearbeiter)?.Name;
			CanCreateWareneingang = bestellungenEntity.CanCreateWereingang;
			//Lists
			ListBearbeiter = DropDownMenu.GetDropDownMenu<Infrastructure.Data.Entities.Tables.COR.UserEntity>(bearbeiterEntities, "Nummer", "LegacyUsername");
			ListKondition = DropDownMenu.GetDropDownMenu<Infrastructure.Data.Entities.Tables.MTM.KonditionszuordnungstabelleEntity>(konditionszuordnungstabelleEntities, "Text", "Bemerkung");
			ListBezug = DropDownMenu.GetDropDownMenu<Infrastructure.Data.Entities.Tables.MTM.BetreffEntity>(betreffEntities, "ID", "Betreff");

			// -
			DeliveryDaysMonday = adressenEntity?.Montag_Anliefertag ?? false;
			DeliveryDaysTuesday = adressenEntity?.Dienstag_Anliefertag ?? false;
			DeliveryDaysWednesday = adressenEntity?.Mittwoch_Anliefertag ?? false;
			DeliveryDaysThursday = adressenEntity?.Donnerstag_Anliefertag ?? false;
			DeliveryDaysFriday = adressenEntity?.Freitag_Anliefertag ?? false;
			ProjectPurchase = bestellungenEntity?.ProjectPurchase ?? false;
		}
	}
}
