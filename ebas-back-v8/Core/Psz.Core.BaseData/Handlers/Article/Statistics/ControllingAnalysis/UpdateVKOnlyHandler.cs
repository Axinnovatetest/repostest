...
namespace Psz.Core.BaseData.Handlers.Article.Statistics.ControllingAnalysis
{
	...
	public class UpdateVKOnlyHandler: IHandle<UserModel, ResponseModel<List<Models.Article.Statistics.ControllingAnalysis.UpdateVKOnlyResponseModel>>>
	{
		private UserModel _user { get; set; }
		private List<Models.Article.Statistics.ControllingAnalysis.VKSimulationInResponseModel> _data { get; set; }
		public UpdateVKOnlyHandler(UserModel user, List<Models.Article.Statistics.ControllingAnalysis.VKSimulationInResponseModel> data)
		{
			this._user = user;
			this._data = data;
		}
		public ResponseModel<List<Models.Article.Statistics.ControllingAnalysis.UpdateVKOnlyResponseModel>> Handle()
		{
			try
			{
				...
				var results = Infrastructure.Data.Access.Joins.ArticleStatisticsAccess.ControllingAnalysis.UpdateVKOnly(this._user.Username,
