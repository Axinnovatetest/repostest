...
namespace Psz.Core.BaseData.Handlers.Article.Overview
{
	public class UpdateBlanketHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public UpdateBlanketHandler(Identity.Models.UserModel user, Models.Article.ArticleOverviewModel.Blanket data)
		{
			this._user = user;
			this._data = data;
		}
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var updatedId = Infrastructure.Data.Access.Tables.PRS.ArtikelAccess.EditBlanket(articleData, this._data.OrderId == 1);
