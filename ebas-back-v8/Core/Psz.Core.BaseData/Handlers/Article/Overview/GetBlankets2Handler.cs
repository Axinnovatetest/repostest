...
{
	public class GetBlankets2Handler: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.Article.ArticleOverviewModel.Blanket>>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private int _data { get; set; }


		public GetBlankets2Handler(Identity.Models.UserModel user, int id)
		{
			this._user = user;
			this._data = id;
		}
