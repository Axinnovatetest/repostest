...
namespace Psz.Core.BaseData.Handlers.Article.BillOfMaterial.Position
{
	...
	public class GetByArticleIdHandler: IHandle<UserModel, ResponseModel<List<Models.Article.BillOfMaterial.BomPosition>>>
	{
		private UserModel _user { get; set; }
		public int _data { get; set; }
		public GetByArticleIdHandler(UserModel user, int id)
		{
			this._user = user;
			this._data = id;
		}
