...
namespace Psz.Core.BaseData.Handlers.Article
{
	...
	public partial class SearchNummerHandler: IHandle<string, ResponseModel<List<KeyValuePair<string, string>>>>
	{
		private string _data { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public SearchNummerHandler(Identity.Models.UserModel user, string data)
		{
			this._data = data;
			this._user = user;
		}
		...
		public ResponseModel<List<KeyValuePair<string, string>>> Handle()
		{
			try
			{
				...
				var articleEntities = Infrastructure.Data.Access.Tables.PRS.ArtikelAccess.GetLikeNummer(this._data);
