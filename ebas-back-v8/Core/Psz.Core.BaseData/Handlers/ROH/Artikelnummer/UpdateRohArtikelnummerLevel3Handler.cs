...
namespace Psz.Core.BaseData.Handlers.ROH
{
	...
	{
		public ResponseModel<int> UpdateRohArtikelnummerLevel3(RohArtikelnummerLevel3Model data, UserModel user)
		{
			if(user == null)
			...
			var response = Infrastructure.Data.Access.Tables.BSD.Roh_Artikelnummer_Level3Access.Update(entity);
