...
namespace Psz.Core.BaseData.Handlers.Customer
{
	...
	public class GetCustomerNamesV2Handler: IHandle<Identity.Models.UserModel,
		ResponseModel<List<KeyValuePair<int, string>>>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private string _data { get; set; }
		public GetCustomerNamesV2Handler(Identity.Models.UserModel user, string data)
		{
			this._user = user;
			this._data = data;
		}
		...
		public ResponseModel<List<KeyValuePair<int, string>>> Handle()
		{
			try
			{
				...
				var adressenEntities = Infrastructure.Data.Access.Tables.PRS.AdressenAccess.GetLikeCustomerName(this._data.Trim().ToLower())
