...
{
	public class GetConditionAsiignementsgForSettingsHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.ConditionAssignment.ConditionAssignementModel>>>
	{
		private Identity.Models.UserModel _user { get; set; }

		public GetConditionAsiignementsgForSettingsHandler(Identity.Models.UserModel user)
		{
			this._user = user;
		}
