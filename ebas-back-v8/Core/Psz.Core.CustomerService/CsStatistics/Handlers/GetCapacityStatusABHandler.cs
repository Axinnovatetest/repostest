...
namespace Psz.Core.CustomerService.CsStatistics.Handlers
{
	...
	public class GetCapacityStatusABHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<CapacityAbFaResponseModel>>>
	{
		private Models.CapacityAbFaRequestModel _data { get; set; }
		private Identity.Models.UserModel _user { get; set; }
		public GetCapacityStatusABHandler(Identity.Models.UserModel user, Models.CapacityAbFaRequestModel data)
		{
			this._user = user;
			this._data = data;
		}
		public ResponseModel<List<CapacityAbFaResponseModel>> Handle()
		{
			...
			return ResponseModel<List<CapacityAbFaResponseModel>>.SuccessResponse(
				   Infrastructure.Data.Access.Joins.CTS.CSStatisticsAccess.GetCapacityStatus_AB(_data.ArticleId, dateFrom, dateTo)
