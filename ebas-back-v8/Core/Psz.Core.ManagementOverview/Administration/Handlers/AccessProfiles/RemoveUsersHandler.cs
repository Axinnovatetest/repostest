...
{
	using Psz.Core.ManagementOverview.Administration.Models.AccessProfiles;
	public class RemoveUsersHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private AddUsersRequestModel _data { get; set; }

		public RemoveUsersHandler(Identity.Models.UserModel user, AddUsersRequestModel data)
		{
			this._user = user;
			this._data = data;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				/// 
				return ResponseModel<int>.SuccessResponse(Infrastructure.Data.Access.Tables.MGO.AccessProfileUsersAccess.DeleteUsers(this._data.ProfileId, this._data.UserIds));
			} catch(Exception e)
			{
