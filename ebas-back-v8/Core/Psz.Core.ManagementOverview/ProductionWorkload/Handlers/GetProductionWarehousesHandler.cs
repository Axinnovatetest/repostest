	...
	public class GetProductionWarehousesHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<KeyValuePair<int, string>>>>
	{
		...
		public ResponseModel<List<KeyValuePair<int, string>>> Handle()
		{
			try
			{
				...
				if(!_user.IsGlobalDirector && !_user.IsAdministrator && !_user.IsCorporateDirector && !_user.Access.ManagementOverview.AllProductionWarehouses && !_user.Access.CRP.AllProductionWarehouses)
				{
