		...
		ResponseModel<List<KeyValuePair<int, string>>>>
	{
		...
		public ResponseModel<List<KeyValuePair<int, string>>> Handle()
		{
			try
			{
				...
				var adressenEntities = Infrastructure.Data.Access.Tables.FNC.AdressenAccess.GetLikeSupplierNumber(this._data.Trim().ToLower());
				// var adressenEntities = Infrastructure.Data.Access.Tables.FNC.LieferantenAccess.GetLikeNumber(this._data.Trim().ToLower());
