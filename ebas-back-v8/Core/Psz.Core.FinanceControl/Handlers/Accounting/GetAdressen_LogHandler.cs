...
public class GetAdressen_LogHandler: IHandle<PSZ_BH_Kontenrahmen_LogRequestModel, ResponseModel<IPaginatedResponseModel<PSZ_BH_Kontenrahmen_LogModel>>>
{

	private PSZ_BH_Kontenrahmen_LogRequestModel _data { get; set; }
	private UserModel _user { get; set; }
	public GetAdressen_LogHandler(UserModel user, PSZ_BH_Kontenrahmen_LogRequestModel data)
	{
		this._user = user;
		this._data = data;
	}
	...
	private ResponseModel<IPaginatedResponseModel<PSZ_BH_Kontenrahmen_LogModel>> Perform(UserModel user, PSZ_BH_Kontenrahmen_LogRequestModel data)
	{
		...
		try
		{
			...
			var fetchedData = Infrastructure.Data.Access.Tables.FNC.Adressen_FNC_LogAccess.GetWithPagination(dataPaging, dataSorting, 0);
