...
{
	public class StammdatenkontrolleWareneingangeExcelHandler: IHandle<UserModel, ResponseModel<byte[]>>
	{
		public DateTime fromdate { get; set; }
		public DateTime todate { get; set; }
		public string gruppe { get; set; }
		private UserModel _user { get; set; }
		public StammdatenkontrolleWareneingangeExcelHandler(UserModel user, System.DateTime fromdate, System.DateTime todate, string gruppe)
		{
			this._user = user;
		...
		public byte[] GetData()
		{
			...
			fetchedData = Infrastructure.Data.Access.Joins.FNC.Accounting.AccountingAccess.GetStammdatenkontrolleWareneingange(fromdate, todate, gruppe, null, null, 1);
			return SaveToExcelFile(fetchedData);
		}

		internal byte[] SaveToExcelFile(
			List<Infrastructure.Data.Entities.Joins.FNC.Accounting.StammdatenkontrolleWareneingangeEntity> entities
			)
		{
