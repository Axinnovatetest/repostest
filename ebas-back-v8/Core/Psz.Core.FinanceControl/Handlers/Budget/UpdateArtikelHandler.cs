...
{
	public class UpdateArtikelHandler: IHandle<Models.Budget.ArtikelBudgetModel, ResponseModel<int>>
	{
		private Models.Budget.ArtikelBudgetModel _data { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public UpdateArtikelHandler(Models.Budget.ArtikelBudgetModel data, Identity.Models.UserModel user)
		{
			this._data = data;
			this._user = user;
		}
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var updatedArtikels = Infrastructure.Data.Access.Tables.FNC.Artikel_BudgetAccess.UpdateArtikel(Artikelentity);
				...
				//{
				//	bestellnummerEntities[i].Artikel_Nr = Artikelentity.Artikel_Nr;
				//}
				//Infrastructure.Data.Access.Tables.FNC.BestellnummernAccess.Insert(bestellnummerEntities);

				return ResponseModel<int>.SuccessResponse(updatedArtikels);
			} catch(Exception e)
			{
