...
namespace Psz.Core.FinanceControl.Handlers.Budget
{
	public class UpdateOrderHandler
	{
		...
		public UpdateOrderHandler(Models.Budget.InsertedDataOrderModel data, Identity.Models.UserModel user)
		{
			this._data = data;
			this._user = user;
		}
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				//var InsertedOrder = Infrastructure.Data.Access.Tables.FNC.Budget_OrderAccess.UpdateOrder(OrderEntity);
