...
namespace Psz.Core.FinanceControl.Handlers.Budget
{
	...
	using System.Linq;
	public class GetAllDataProjectbyTypeHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<Models.Budget.Project.ProjectModel>>>
	{
		public Identity.Models.UserModel _user { get; set; }
		private int _data { get; set; }
		public GetAllDataProjectbyTypeHandler(Identity.Models.UserModel user, int value)
		{
			this._user = user;
			this._data = value;
		}
		public ResponseModel<List<Models.Budget.Project.ProjectModel>> Handle()
		{
			try
			{
				...
				var projectsEntities = Infrastructure.Data.Access.Tables.FNC.BudgetProjectAccess.GetByType(this._data)
