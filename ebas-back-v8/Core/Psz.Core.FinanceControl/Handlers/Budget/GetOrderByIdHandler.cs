...
namespace Psz.Core.FinanceControl.Handlers.Budget
{
	...
	public class GetOrderByIdHandler: IHandle<Identity.Models.UserModel, ResponseModel<Models.Budget.GetLandAssignementModel>>

	{

		private int _data { get; set; }

		public GetOrderByIdHandler(int id)
		{
