...
{
	public class GetGetTop10ProjectsByAmountHandler: IHandle<UserModel, ResponseModel<IEnumerable<AllocationsVsOrdersAmountModel>>>
	{
		private readonly UserModel _user;
		private readonly StatsRequestModelMonth _data;
		public GetGetTop10ProjectsByAmountHandler(UserModel user, StatsRequestModelMonth data)
		{
			_user = user;
			_data = data;
		}
		public ResponseModel<IEnumerable<AllocationsVsOrdersAmountModel>> Handle()
		{
			...
			var entities = Infrastructure.Data.Access.Joins.FNC.Statistics.StatsticsAccess.GetTop10ProjectsByAmountOrBudget(_data.Year, _data.CompanyId, _data.DepartmentId, _data.EmployeeId, true, _data.Month);
