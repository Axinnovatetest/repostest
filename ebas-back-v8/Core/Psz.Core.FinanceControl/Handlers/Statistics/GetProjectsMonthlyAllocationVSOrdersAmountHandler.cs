...
{
	public class GetProjectsMonthlyAllocationVSOrdersAmountHandler: IHandle<UserModel, ResponseModel<IEnumerable<AllocationsVsOrdersAmountModel>>>
	{
		private readonly UserModel _user;
		private readonly int _data;
		public GetProjectsMonthlyAllocationVSOrdersAmountHandler(UserModel user, int data)
		{
			_user = user;
			_data = data;
		}
		public ResponseModel<IEnumerable<AllocationsVsOrdersAmountModel>> Handle()
		{
			...
			var entities = Infrastructure.Data.Access.Joins.FNC.Statistics.StatsticsAccess.GetProjectsVsOrdersAmount(_data);
