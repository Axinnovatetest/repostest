...
{
	public partial class DelforService: IDelforService
	{
		public ResponseModel<byte[]> ValidateDelforDraft(UserModel user)
		{
		...
		public ResponseModel<byte[]> DelforDraft(UserModel user)
		{
			try
			{
				var validationRespnse = ValidateDelforDraft(user);
