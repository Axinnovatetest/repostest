...
namespace Psz.Core.Logistics.Handlers.Administration.AccessProfiles
{
	public class RemoveUsersHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public RemoveUsersHandler(Identity.Models.UserModel user, Models.Administration.AccessProfiles.AddUsersModel data)
		{
			this._user = user;
			this._data = data;
		}
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				/// 
				return ResponseModel<int>.SuccessResponse(Infrastructure.Data.Access.Tables.Logistics.AccessProfileUsersAccess.DeleteUsers(this._data.ProfileId, this._data.UserIds));
			} catch(Exception e)
			{
