...
{
	public class UpdateGedruktPackstatusHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private ListeUpdatePacking _listeUpdatePacking { get; set; }
		private Identity.Models.UserModel _user { get; set; }

		public UpdateGedruktPackstatusHandler(ListeUpdatePacking listeUpdatePacking, Identity.Models.UserModel user)
		{
			this._user = user;
		...
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var response = Infrastructure.Data.Access.Joins.Logistics.PackingAccess.UpdateGedrucktPackstatus(nrAngeboteArtikel);
				//logging
				string ch = "";
				int indice = 1;
				...
				var _log = new LogHelper(0,
					 0, "Versand", LogHelper.LogType.MODIFICATIONPRINTVERSAND, "LGT", _user)
