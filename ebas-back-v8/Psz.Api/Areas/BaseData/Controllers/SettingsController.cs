...
namespace Psz.Api.Areas.BaseData.Controllers
{
	...
	public class SettingsController: ControllerBase
	{
		...
		public IActionResult GetPaymentMeansCodes()
		{
			try
			{
				var response = new Core.BaseData.Handlers.Settings.ConditionAssignment.GetPaymentMeansCodesHandler(this.GetCurrentUser())
				   .Handle();
