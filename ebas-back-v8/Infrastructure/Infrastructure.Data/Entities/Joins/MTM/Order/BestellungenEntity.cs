...
namespace Infrastructure.Data.Entities.Joins.MTM.Order
{
	public class BestellungenEntity
	{
		...
		public BestellungenEntity(DataRow dataRow)
		{
			...
			Bestellbestatigung_erbeten_bis = (dataRow["Bestellbestätigung erbeten bis"] == System.DBNull.Value) ? (DateTime?)null : Convert.ToDateTime(dataRow["Bestellbestätigung erbeten bis"]);
			...
			CanCreateWereingang = (dataRow["CanCreateWereingang"] == System.DBNull.Value) ? false : Convert.ToBoolean(dataRow["CanCreateWereingang"]);
			ProjectPurchase = (dataRow["ProjectPurchase"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["ProjectPurchase"]);
		}

		public BestellungenEntity ShallowClone()
		{
			return new BestellungenEntity
			{
				...
				CanCreateWereingang = CanCreateWereingang,
