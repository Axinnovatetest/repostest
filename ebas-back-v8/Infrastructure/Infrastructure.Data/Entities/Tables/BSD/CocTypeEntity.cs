...
namespace Infrastructure.Data.Entities.Tables.BSD
{
	public class CocTypeEntity
	{
		...
		public CocTypeEntity() { }

		public CocTypeEntity(DataRow dataRow)
		{
			Confirmation = (dataRow["Confirmation"] == System.DBNull.Value) ? "" : Convert.ToString(dataRow["Confirmation"]);
			Content = (dataRow["Content"] == System.DBNull.Value) ? "" : Convert.ToString(dataRow["Content"]);
			...
			Version = (dataRow["Version"] == System.DBNull.Value) ? "" : Convert.ToString(dataRow["Version"]);
		}

		public CocTypeEntity ShallowClone()
		{
			return new CocTypeEntity
			{
