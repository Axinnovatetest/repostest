...
namespace Infrastructure.Data.Entities.Tables.Logistics
{
	public class AccessProfileEntity
	{
		...
		public AccessProfileEntity(DataRow dataRow)
		{
			...
			Inventory = (dataRow["Inventory"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["Inventory"]);
			InventoryDownloadAudit = (dataRow["InventoryDownloadAudit"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryDownloadAudit"]);
			InventoryDownloadExcel = (dataRow["InventoryDownloadExcel"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryDownloadExcel"]);
			InventoryDownloadPdf = (dataRow["InventoryDownloadPdf"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryDownloadPdf"]);
			InventoryDownloadRelease = (dataRow["InventoryDownloadRelease"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryDownloadRelease"]);
			InventoryStart = (dataRow["InventoryStart"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryStart"]);
			InventoryStop = (dataRow["InventoryStop"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryStop"]);
			InventoryUpdateTaskIT = (dataRow["InventoryUpdateTaskIT"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryUpdateTaskIT"]);
			InventoryUpdateTaskLogistics = (dataRow["InventoryUpdateTaskLogistics"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryUpdateTaskLogistics"]);
			InventoryUpdateWip = (dataRow["InventoryUpdateWip"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryUpdateWip"]);
			InventoryHqValidate = (dataRow["InventoryHqValidate"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryHqValidate"]);
			InventoryWarehouseValidate = (dataRow["InventoryWarehouseValidate"] == System.DBNull.Value) ? (bool?)null : Convert.ToBoolean(dataRow["InventoryWarehouseValidate"]);
		}
	}
}
