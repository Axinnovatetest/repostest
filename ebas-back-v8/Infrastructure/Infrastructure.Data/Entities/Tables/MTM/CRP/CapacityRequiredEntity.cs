...
{
	public class CapacityRequiredEntity
	{
		...
		public CapacityRequiredEntity() { }

		public CapacityRequiredEntity(DataRow dataRow)
		{
			...
			SourceId = Convert.ToInt32(dataRow["SourceId"]);
