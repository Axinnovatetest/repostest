...
{
	public class Adressen_FNC_LogEntity
	{
		...
		public Adressen_FNC_LogEntity() { }

		public Adressen_FNC_LogEntity(DataRow dataRow)
		{
		...
		public Adressen_FNC_LogEntity ShallowClone()
		{
			return new Adressen_FNC_LogEntity
			{
				DateTime = DateTime,
				Id = Id,
				LogObject = LogObject,
