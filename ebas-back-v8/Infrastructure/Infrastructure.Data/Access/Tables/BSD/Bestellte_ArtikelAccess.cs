...
namespace Infrastructure.Data.Access.Tables.BSD
{
	public class Bestellte_ArtikelAccess
	{
		...
		public static Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity Get(int nr)
		{
			...
			{
				return new Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
			...
			if(dataTable.Rows.Count > 0)
			{
				return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity(x)).ToList();
			}
			else
			{
				return new List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity>();
			}
		}
		public static List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> Get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> results = null;
				...
				else
				{
					...
					results = new List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity>();
		...
		private static List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity item)
		{
		...
		public static int Insert(List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> items)
		{
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static int Update(Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity item)
		{
			int results = -1;
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
		...
		public static int Update(List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 46; // Nb params per query
		...
		private static int update(List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> GetByBlanket(string blanketNr)
		{
		...
		public static List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> GetByArticles(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
		...
		private static List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> getByArticles(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
				{
					...
					sqlCommand.CommandText = $"SELECT * FROM [Bestellte Artikel] WHERE [Artikel-Nr] IN ({queryIds})";
					DbExecution.Fill(sqlCommand, dataTable);
				}
		...
		public static List<Infrastructure.Data.Entities.Tables.BSD.Bestellte_ArtikelEntity> GetByArticleAndBestellung(int artikelNr, List<int> bestellungNrs, bool onlyOpen)
		{
			if(bestellungNrs?.Count <= 0 || artikelNr <= 0)
				return null;
			...
			{
				sqlConnection.Open();
				string query = $"SELECT * FROM [Bestellte Artikel] WHERE [Artikel-Nr]=@artikelNr AND [Bestellung-Nr] IN ({string.Join(",", bestellungNrs)}) {(onlyOpen? " AND ISNULL([erledigt_pos],0)=0" : "")}";
				var sqlCommand = new SqlCommand(query, sqlConnection);
