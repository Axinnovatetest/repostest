...
namespace Infrastructure.Data.Access.Tables.BSD
{
	public class CAO_DecoupageAccess
	{
		...
		public static Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity Get(int id_nr)
		{
			...
			{
				return new Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
			...
			if(dataTable.Rows.Count > 0)
			{
				return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity(x)).ToList();
			}
			else
			{
				return new List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity>();
			}
		}
		public static List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity> Get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity> results = null;
				...
				else
				{
					...
					results = new List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity>();
		...
		private static List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity> get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity item)
		{
		...
		public static int Insert(List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity> items)
		{
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static int Update(Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity item)
		{
			int results = -1;
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
		...
		public static int Update(List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 18; // Nb params per query
		...
		private static int update(List<Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static int ResetValidation(int articleId, int bomVersion, int cpVersion, SqlConnection connection, SqlTransaction transaction)
		{
			int response = int.MinValue;
			string query = $"UPDATE [CAO_Decoupage] SET [BOM_version]=@bomVersion, [Validee]=null, [CP_version]=@cpVersion WHERE [Artikel_Nr]=@Artikel_Nr /* AND [BOM_version]=@bomVersion AND [Validee]=1*/;";
			using(var sqlCommand = new SqlCommand(query, connection, transaction))
			{
				...
				sqlCommand.Parameters.AddWithValue("cpVersion", cpVersion);
		...
		public static Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity GetLastByArticle(int articleId)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [CAO_Decoupage] WHERE [Artikel_Nr]=@articleId";
				var sqlCommand = new SqlCommand(query, sqlConnection);
		...
		public static Infrastructure.Data.Entities.Tables.BSD.CAO_DecoupageEntity GetLastByArticleAndBom(int articleId, int bomVersion)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [CAO_Decoupage] WHERE [Artikel_Nr]=@articleId AND [BOM_version]=@bomVersion";
				var sqlCommand = new SqlCommand(query, sqlConnection);
				sqlCommand.Parameters.AddWithValue("articleId", articleId);
				sqlCommand.Parameters.AddWithValue("bomVersion", bomVersion);
