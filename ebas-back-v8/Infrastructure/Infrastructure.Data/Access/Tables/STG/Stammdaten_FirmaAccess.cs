...
namespace Infrastructure.Data.Access.Tables.STG
{
	...
	public class Stammdaten_FirmaAccess
	{
		...
		public static Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity Get(int nr)
		{
			...
			{
				return new Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
			...
			if(dataTable.Rows.Count > 0)
			{
				return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity(x)).ToList();
			}
			else
			{
				return new List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity>();
			}
		}
		public static List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity> Get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity> results = null;
				...
				else
				{
					...
					results = new List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity>();
		...
		private static List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity> get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity item)
		{
		...
		public static int Insert(List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity> items)
		{
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static int Update(Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity item)
		{
			int results = -1;
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
		...
		public static int Update(List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 9; // Nb params per query
		...
		private static int update(List<Infrastructure.Data.Entities.Tables.STG.Stammdaten_FirmaEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
