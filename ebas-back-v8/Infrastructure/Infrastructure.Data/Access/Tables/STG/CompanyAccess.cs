...
namespace Infrastructure.Data.Access.Tables.STG
{
	...
	public class CompanyAccess
	{
		...
		public static List<Infrastructure.Data.Entities.Tables.STG.CompanyEntity> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [__STG_Company]";
				var sqlCommand = new SqlCommand(query, sqlConnection);
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.STG.CompanyEntity item)
		{
			...
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
				...
				string query = "INSERT INTO [__STG_Company] ([Address],[Address2],[City],[Closed],[Country],[CountryId],[CreateTime],[CreateUserId],[Description],[DirectorEmail],[DirectorId],[DirectorName],[Email],[Fax],[IsActive],[LagalName],[LastUpdateTime],[LastUpdateUserId],[Logo],[LogoExtension],[Name],[PostalCode],[Telephone],[Telephone2],[Type],[VatID]) OUTPUT INSERTED.[Id] VALUES (@Address,@Address2,@City,@Closed,@Country,@CountryId,@CreateTime,@CreateUserId,@Description,@DirectorEmail,@DirectorId,@DirectorName,@Email,@Fax,@IsActive,@LagalName,@LastUpdateTime,@LastUpdateUserId,@Logo,@LogoExtension,@Name,@PostalCode,@Telephone,@Telephone2,@Type,@VatID); ";
				...
				using(var sqlCommand = new SqlCommand(query, sqlConnection, sqlTransaction))
				{
					...
					sqlCommand.Parameters.AddWithValue("VatID", item.VatID == null ? (object)DBNull.Value : item.VatID);
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.STG.CompanyEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				...
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
				{
					...
					{
						i++;
						query += " INSERT INTO [__STG_Company] ([Address],[Address2],[City],[Closed],[Country],[CountryId],[CreateTime],[CreateUserId],[Description],[DirectorEmail],[DirectorId],[DirectorName],[Email],[Fax],[IsActive],[LagalName],[LastUpdateTime],[LastUpdateUserId],[Logo],[LogoExtension],[Name],[PostalCode],[Telephone],[Telephone2],[Type],[VatID]) VALUES ( "
						...
						sqlCommand.Parameters.AddWithValue("VatID" + i, item.VatID == null ? (object)DBNull.Value : item.VatID);
					}
		...
		public static int Update(Infrastructure.Data.Entities.Tables.STG.CompanyEntity item)
		{
			...
			{
				sqlConnection.Open();
				string query = "UPDATE [__STG_Company] SET [Address]=@Address, [Address2]=@Address2, [City]=@City, [Closed]=@Closed, [Country]=@Country, [CountryId]=@CountryId, [CreateTime]=@CreateTime, [CreateUserId]=@CreateUserId, [Description]=@Description, [DirectorEmail]=@DirectorEmail, [DirectorId]=@DirectorId, [DirectorName]=@DirectorName, [Email]=@Email, [Fax]=@Fax, [IsActive]=@IsActive, [LagalName]=@LagalName, [LastUpdateTime]=@LastUpdateTime, [LastUpdateUserId]=@LastUpdateUserId, [Logo]=@Logo, [LogoExtension]=@LogoExtension, [Name]=@Name, [PostalCode]=@PostalCode, [Telephone]=@Telephone, [Telephone2]=@Telephone2, [Type]=@Type, [VatID]=@VatID WHERE [Id]=@Id";
				var sqlCommand = new SqlCommand(query, sqlConnection);
		...
		public static Infrastructure.Data.Entities.Tables.STG.CompanyEntity GetWithTransaction(int id, SqlConnection connection, SqlTransaction transaction)
		{
			var dataTable = new DataTable();
		...
		public static List<Infrastructure.Data.Entities.Tables.STG.CompanyEntity> GetWithTransaction(SqlConnection connection, SqlTransaction transaction)
		{
			var dataTable = new DataTable();
		...
		public static List<Infrastructure.Data.Entities.Tables.STG.CompanyEntity> GetWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
		...
		private static List<Infrastructure.Data.Entities.Tables.STG.CompanyEntity> getWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
		...
		public static int InsertWithTransaction(Infrastructure.Data.Entities.Tables.STG.CompanyEntity item, SqlConnection connection, SqlTransaction transaction)
		{
			int response = int.MinValue;
		...
		public static int InsertWithTransaction(List<Infrastructure.Data.Entities.Tables.STG.CompanyEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 27; // Nb params per query
		...
		private static int insertWithTransaction(List<Infrastructure.Data.Entities.Tables.STG.CompanyEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				string query = "";
		...
		public static int UpdateWithTransaction(Infrastructure.Data.Entities.Tables.STG.CompanyEntity item, SqlConnection connection, SqlTransaction transaction)
		{
			int results = -1;
		...
		public static int UpdateWithTransaction(List<Infrastructure.Data.Entities.Tables.STG.CompanyEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 27; // Nb params per query
		...
		private static int updateWithTransaction(List<Infrastructure.Data.Entities.Tables.STG.CompanyEntity> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
