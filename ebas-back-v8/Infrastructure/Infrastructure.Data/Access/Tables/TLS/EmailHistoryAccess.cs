...
{
	public class EmailHistoryAccess
	{
		#region Default Methods
		public static Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity Get(int id)
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString_FNC))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [__FNC_EmailHistory] WHERE [Id]=@Id";
			...
			{
				return new Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString_FNC))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [__FNC_EmailHistory]";
				var sqlCommand = new SqlCommand(query, sqlConnection);
			...
			if(dataTable.Rows.Count > 0)
			{
				return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity(x)).ToList();
			}
			else
			{
				return new List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity>();
			}
		}
		public static List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity> Get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity> results = null;
				...
				else
				{
					...
					results = new List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity>();
		...
		private static List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity> get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString_FNC))
				{
					...
					sqlCommand.CommandText = $"SELECT * FROM [__FNC_EmailHistory] WHERE [Id] IN ({queryIds})";
					DbExecution.Fill(sqlCommand, dataTable);
				}
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity item)
		{
			...
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString_FNC))
			{
				...
				string query = "INSERT INTO [__FNC_EmailHistory] ([AttachmentIds],[CCEmails],[EmailMessage],[EmailTitle],[SenderCC],[SenderUserEmail],[SenderUserId],[SenderUserName],[SendingTime],[ToEmail])  VALUES (@AttachmentIds,@CCEmails,@EmailMessage,@EmailTitle,@SenderCC,@SenderUserEmail,@SenderUserId,@SenderUserName,@SendingTime,@ToEmail); ";
		...
		public static int Insert(List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity> items)
		{
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString_FNC))
				{
					...
					{
						i++;
						query += " INSERT INTO [__FNC_EmailHistory] ([AttachmentIds],[CCEmails],[EmailMessage],[EmailTitle],[SenderCC],[SenderUserEmail],[SenderUserId],[SenderUserName],[SendingTime],[ToEmail]) VALUES ( "
		...
		public static int Update(Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity item)
		{
			int results = -1;
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString_FNC))
			{
				sqlConnection.Open();
				string query = "UPDATE [__FNC_EmailHistory] SET [AttachmentIds]=@AttachmentIds, [CCEmails]=@CCEmails, [EmailMessage]=@EmailMessage, [EmailTitle]=@EmailTitle, [SenderCC]=@SenderCC, [SenderUserEmail]=@SenderUserEmail, [SenderUserId]=@SenderUserId, [SenderUserName]=@SenderUserName, [SendingTime]=@SendingTime, [ToEmail]=@ToEmail WHERE [Id]=@Id";
				var sqlCommand = new SqlCommand(query, sqlConnection);
		...
		public static int Update(List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 11; // Nb params per query
		...
		private static int update(List<Infrastructure.Data.Entities.Tables.TLS.EmailHistoryEntity> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString_FNC))
				{
					...
					{
						i++;
						query += " UPDATE [__FNC_EmailHistory] SET "
		...
		public static int Delete(int id)
		{
			...
			{
				sqlConnection.Open();
				string query = "DELETE FROM [__FNC_EmailHistory] WHERE [Id]=@Id";
				var sqlCommand = new SqlCommand(query, sqlConnection);
				sqlCommand.Parameters.AddWithValue("Id", id);
		...
		private static int delete(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				...
				using(var sqlConnection = new SqlConnection(Settings.ConnectionString_FNC))
				{
					...
					string query = "DELETE FROM [__FNC_EmailHistory] WHERE [Id] IN (" + queryIds + ")";
					sqlCommand.CommandText = query;
