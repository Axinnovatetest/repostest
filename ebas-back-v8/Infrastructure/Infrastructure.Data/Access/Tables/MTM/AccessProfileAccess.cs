...
WHERE [Id]=@Id";
				...
				//
				sqlCommand.Parameters.AddWithValue("WP_Country", item.WP_Country ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_CountryCreate", item.WP_CountryCreate ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_CountryDelete", item.WP_CountryDelete ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_CountryUpdate", item.WP_CountryUpdate ?? (object)DBNull.Value);

				sqlCommand.Parameters.AddWithValue("WP_Departement", item.WP_Departement ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_DepartementCreate", item.WP_DepartementCreate ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_DepartementDelete", item.WP_DepartementDelete ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_DepartementUpdate", item.WP_DepartementUpdate ?? (object)DBNull.Value);

				sqlCommand.Parameters.AddWithValue("WP_Hall", item.WP_Hall ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_HallCreate", item.WP_HallCreate ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_HallDelete", item.WP_HallDelete ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_HallUpdate", item.WP_HallUpdate ?? (object)DBNull.Value);

				sqlCommand.Parameters.AddWithValue("WP_StandardOperation", item.WP_StandardOperation ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_StandardOperationCreate", item.WP_StandardOperationCreate ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_StandardOperationDelete", item.WP_StandardOperationDelete ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_StandardOperationUpdate", item.WP_StandardOperationUpdate ?? (object)DBNull.Value);

				sqlCommand.Parameters.AddWithValue("WP_WorkArea", item.WP_WorkArea ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkAreaCreate", item.WP_WorkAreaCreate ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkAreaDelete", item.WP_WorkAreaDelete ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkAreaUpdate", item.WP_WorkAreaUpdate ?? (object)DBNull.Value);

				sqlCommand.Parameters.AddWithValue("WP_WorkPlan", item.WP_WorkPlan ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkPlanCreate", item.WP_WorkPlanCreate ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkPlanDelete", item.WP_WorkPlanDelete ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkPlanUpdate", item.WP_WorkPlanUpdate ?? (object)DBNull.Value);

				sqlCommand.Parameters.AddWithValue("WP_WorkPlanReporting", item.WP_WorkPlanReporting ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkPlanReportingCreate", item.WP_WorkPlanReportingCreate ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkPlanReportingDelete", item.WP_WorkPlanReportingDelete ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkPlanReportingUpdate", item.WP_WorkPlanReportingUpdate ?? (object)DBNull.Value);

				sqlCommand.Parameters.AddWithValue("WP_WorkStation", item.WP_WorkStation ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkStationCreate", item.WP_WorkStationCreate ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkStationDelete", item.WP_WorkStationDelete ?? (object)DBNull.Value);
				sqlCommand.Parameters.AddWithValue("WP_WorkStationUpdate", item.WP_WorkStationUpdate ?? (object)DBNull.Value);
