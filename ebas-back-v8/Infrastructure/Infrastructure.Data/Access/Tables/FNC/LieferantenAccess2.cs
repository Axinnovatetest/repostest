...
namespace Infrastructure.Data.Access.Tables.FNC
{
	...
	public class LieferantenAccess2
	{
		#region Default Methods
		public static Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2 Get(int nr)
		{
			...
			{
				return new Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2(dataTable.Rows[0]);
			}
			else
			{
				return null;
		...
		public static List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> Get()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
			...
			if(dataTable.Rows.Count > 0)
			{
				return dataTable.Rows.Cast<DataRow>().Select(x => new Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2(x)).ToList();
			}
			else
			{
				return new List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2>();
			}
		}
		public static List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> Get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
				List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> results = null;
				...
				else
				{
					...
					results = new List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2>();
		...
		private static List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> get(List<int> ids)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
		...
		public static int Insert(Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2 item)
		{
		...
		public static int Insert(List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> items)
		{
		...
		private static int insert(List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static int Update(Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2 item)
		{
			int results = -1;
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString))
			{
		...
		public static int Update(List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> items)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 37; // Nb params per query
		...
		private static int update(List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> items)
		{
			if(items != null && items.Count > 0)
			{
				int results = -1;
		...
		public static Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2 GetWithTransaction(int nr, SqlConnection connection, SqlTransaction transaction)
		{
			var dataTable = new DataTable();
		...
		public static List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> GetWithTransaction(SqlConnection connection, SqlTransaction transaction)
		{
			var dataTable = new DataTable();
		...
		public static List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> GetWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
		{
			if(ids != null && ids.Count > 0)
			{
				int maxQueryNumber = Settings.MAX_BATCH_SIZE;
		...
		private static List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> getWithTransaction(List<int> ids, SqlConnection connection, SqlTransaction transaction)
		{
			if(ids != null && ids.Count > 0)
			{
				var dataTable = new DataTable();
		...
		public static int InsertWithTransaction(Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2 item, SqlConnection connection, SqlTransaction transaction)
		{
			//int response = int.MinValue;
		...
		public static int InsertWithTransaction(List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 37; // Nb params per query
		...
		private static int insertWithTransaction(List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				string query = "";
		...
		public static int UpdateWithTransaction(Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2 item, SqlConnection connection, SqlTransaction transaction)
		{
			int results = -1;
		...
		public static int UpdateWithTransaction(List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				int maxParamsNumber = Settings.MAX_BATCH_SIZE / 37; // Nb params per query
		...
		private static int updateWithTransaction(List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> items, SqlConnection connection, SqlTransaction transaction)
		{
			if(items != null && items.Count > 0)
			{
				//int results = -1;
		...
		#region Helpers
		private static List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2> toList(DataTable dataTable)
		{
			var result = new List<Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2>(dataTable.Rows.Count);
			foreach(DataRow dataRow in dataTable.Rows)
			{
				result.Add(new Infrastructure.Data.Entities.Tables.FNC.LieferantenEntity2(dataRow));
			}
			return result;
		}
		#endregion Helpers
		#region Custom Methods
		public static List<Entities.Tables.FNC.LieferantenEntity2> GetLikeNumber(string nummer)
		{
			var dataTable = new DataTable();
