...
namespace Infrastructure.Data.Access.Tables.FNC
{
	...
	public class OrderPlacementAccess
	{
		...
		public static List<Infrastructure.Data.Entities.Tables.FNC.OrderPlacementEntity> GetSentWithoutAttachment_temp()
		{
			var dataTable = new DataTable();
			using(var sqlConnection = new SqlConnection(Settings.ConnectionString_FNC))
			{
				sqlConnection.Open();
				string query = "SELECT * FROM [__FNC_OrderPlacement] where CONVERT(date,OrderPlacedTime)='05-11-2025' and CONVERT(time,OrderPlacedTime)>='15:00:00'";
				var sqlCommand = new SqlCommand(query, sqlConnection);
