...
namespace Infrastructure.Services
{
	public class Module
	{
		...
		public static bool SaveLogsToSqlite { get; set; } = false;
		...
		public static void Initiate(string filesPhysicalPath, string tempFilesPhysicalPath, Email.EmailParamtersModel emailParamters, int h1LengthInDays, bool saveLogsToSqlite,
			string ImpersonateUserName = null, string ImpresonatePassword = null, string ImpersonateDomain = null)
		{
			...
			SaveLogsToSqlite = saveLogsToSqlite;
		}
