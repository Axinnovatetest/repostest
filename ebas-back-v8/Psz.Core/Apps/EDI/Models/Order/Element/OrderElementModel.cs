...
namespace Psz.Core.Apps.EDI.Models.Order.Element
{
	public class OrderElementModel
	{
		...
		// - 2022-08-05 // - 2022-08-05 - Do not allow updateRahmen from AB Pos
		public int RahmenNumber { get; set; }
		public int RahmenPositionNumber { get; set; }

		//public int? RahmenPosId { get; set; }
		//public int? RahmenId { get; set; }
		// - 2025-03-04
		public CustomerService.Models.OrderProcessing.StoragesAndIndexesModel StoragesAndIndexes { get; set; }
		public List<CustomerService.Models.Blanket.LinkToABPositionModel> LinkToABPosition { get; set; }
		// - 2025-09-10 - Reil, Schremmer & Zipproth
		...
		public OrderElementModel(bool UpdateChoice, string _StorageLocationName, DateTime _DesiredDate)
		{
			if(UpdateChoice)
			{
