...
namespace Psz.Core.Apps.EDI.Models.Order
{
	...
	{
		public string AdressCustomerNumber { get; set; }
		...
		// 2022-07-14 - per Position Delivery Address
		public bool MissingConsignee { get; set; } = false;
		// - 2023-01-18 - EDI send notes instead of UST ID
		public string UstIdCustomer { get; set; }
		...
		public class BuyerModel
		{
			...
			public BuyerModel(Infrastructure.Data.Entities.Tables.PRS.OrderExtensionBuyerEntity buyer)
			{
				if(buyer != null)
				{
					BuyerDuns = int.TryParse(buyer.DUNS, out var _duns) ? _duns : -1;
				...
				// else{
				// BuyerDuns = -1;
				// BuyerPartyIdentification = string.Empty;
				// BuyerPartyIdentificationCodeListQualifier = string.Empty;
				// BuyerName = string.Empty;
				// BuyerName2 = string.Empty;
				// BuyerName3 = string.Empty;
				// BuyerStreet = string.Empty;
				// BuyerPostalCode = string.Empty;
				// BuyerCity = string.Empty;
				// BuyerCountryName = string.Empty;
				// BuyerPurchasingDepartment = string.Empty;
				// // > Buyer >> Contact
				// BuyerContactName = string.Empty;
				// BuyerContactTelephone = string.Empty;
				// BuyerContactFax = string.Empty;
				// }
			}
		}
