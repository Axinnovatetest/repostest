...
namespace Psz.Core.Apps.Settings.Handlers.Department
{
	...
	public class GetAllowedLeasingHandler: IHandle<Identity.Models.UserModel, ResponseModel<List<Settings.Models.Department.GetModel>>>
	{
		private Identity.Models.UserModel _user { get; set; }

		public GetAllowedLeasingHandler(Identity.Models.UserModel user)
		{
			this._user = user;
		}
		...
		public ResponseModel<List<Settings.Models.Department.GetModel>> Handle()
		{
			try
			{
				...
				/// 
				var departmentEntities = Infrastructure.Data.Access.Tables.STG.DepartmentAccess.GetAllowedLeasing() ?? new List<Infrastructure.Data.Entities.Tables.STG.DepartmentEntity>();
