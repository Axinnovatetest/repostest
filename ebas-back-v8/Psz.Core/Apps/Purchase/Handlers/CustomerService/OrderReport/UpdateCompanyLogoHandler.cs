...
namespace Psz.Core.Apps.Purchase.Handlers.CustomerService
{
	...
	public class UpdateComapnyLogoHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		private Identity.Models.UserModel _user { get; set; }
		private Models.CustomerService.OrderReport.LogoImageModel _data { get; set; }
		public UpdateComapnyLogoHandler(Identity.Models.UserModel user, Models.CustomerService.OrderReport.LogoImageModel data)
		{
			_user = user;
			_data = data;
		}
		public ResponseModel<int> Handle()
		{
			try
			{
				...
				var newImageId = Core.Helpers.ImageFileHelper.updateImage(orderReportEntity.CompanyLogoImageId, this._data.LogoImage, this._data.LogoImageExtension);
				if(Infrastructure.Data.Access.Tables.PRS.OrderReportAccess.UpdateComapnyLogo(orderReportEntity.Id, newImageId, this._user.Id, DateTime.Now) > 0)
				{
