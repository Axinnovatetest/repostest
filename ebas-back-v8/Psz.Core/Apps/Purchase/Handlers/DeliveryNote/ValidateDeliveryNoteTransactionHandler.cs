...
namespace Psz.Core.Apps.Purchase.Handlers.DeliveryNote
{
	public class ValidateDeliveryNoteTransactionHandler: IHandle<Identity.Models.UserModel, ResponseModel<int>>
	{
		...
		public ResponseModel<int> Validate()
		{
			...
			if(kundeEntity.gesperrt_für_weitere_Lieferungen == true)
			{
				return ResponseModel<int>.FailureResponse($"Cannot create delivery note, because customer is blocked for deliveries. Reason: [{kundeEntity.Grund_für_Sperre}]");
			}
